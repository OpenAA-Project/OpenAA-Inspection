...
bool    LoadedTimingFile::Write(TFileStream *wfile ,SeqTimingParameter &param)
{
    ...
    Header.Clocks=0;         // �ύX���ꂽ�Ƃ���CPU�N���b�N�l
    Header.TickCount=0;		// �ύX���ꂽ�Ƃ��̃~���Z�J���h
    Header.SeqCode=0;
    Header.MLine=0;			// �ύX���ꂽ�Ƃ��̃V�[�P���X�s
    Header.OType=0;
    Header.ONumber=0;
    Header.Flag=0;
    Header.Cause=0;
    Header.DType=4;        //�f�[�^�̎��� 1:int , 2:AnsiString , 3:BYTE block
...
bool    LoadedTimingFile::Write(TFileStream *wfile ,AddedVectorBase *v)
{
    ...
    Header.Flag=0;
    Header.Cause=0;
    Header.DType=5;        //�f�[�^�̎��� 1:int , 2:AnsiString , 3:BYTE block
