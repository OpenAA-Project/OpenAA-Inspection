...
BYTE	ColorSphere::Calc8(BYTE *r ,BYTE *g ,BYTE *b,int Mergin)
{
	...
	__asm{
		...
		PCMPGTD		xmm4,xmm2				//���S��(r,g,b)�Ԃ̋����̕���(Radius+Mergin)�����傫���Ƃ��A�O
...
// HSV(HSB)�F���Ԃ���RGB�F���Ԃ֕ϊ����� 
//  h(hue)       : �F��/�F����   0-360�x�̒l
//  s(saturation): �ʓx/�N�₩�� 0-255�̒l
//  v(Value)     : ���x/���邳   0-255�̒l 
//  ��v �� b(Brightness)�Ɠ��l 
{
   while(h>= 360.0){
     h-=360.0;
