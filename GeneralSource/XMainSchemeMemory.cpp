...
double	ImageBuffer::GetInterpolatedBrightness(double X,double Y)	//���Ԃ��ꂽ�P�x�𓾂�
{
	int	x=floor(X);
	int	y=floor(Y);
	double	fx=X-x;
...
void	ImageBuffer::Swap(ImageBuffer &src)
{
	if(Depended==NULL && src.Depended==NULL){
		...
		bool    TmpNoRelease=NoRelease;      //�f�X�g���N�^�Ń������[���������Ȃ�
		bool	TmpChanged	=Changed;		//�摜���ύX���ꂽ�B���̃f�[�^�͕ۑ������Ȃ�
		bool	TmpLoaded	=Loaded;		//�摜�����[�h���ꂽ�B���̃f�[�^�͕ۑ������Ȃ�
								//	�����́A�X�g���[�������̃��[�h�̌��A�ʐM�ł̓]������True�ɃZ�b�g�������K�v������
		bool	TmpOriginal	=Original;
		bool	TmpIndexed	=Indexed;

        int     TmpMaxX		=GetWidth();	//�ő��̂w
        int     TmpMaxY		=GetHeight();   //�ő��̂x
