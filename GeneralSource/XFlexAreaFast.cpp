...
int     FlexAreaFast::SearchFirst(int y) const     //���͐��Βl
{
	struct FlexLine m;
...
void    FlexAreaFast::GetWeightCenter(double &cx, double &cy)  //�d�S�̌v�Z
{
	cx=0;
	cy=0;
	int N=0;
...
void    FlexAreaFast::ThinArea1(void)	//1���f���k���Đ؂����ꍇ�A�c��
{
	int	Mx=GetMinX()-8;
	int	My=GetMinY()-8;
	int	Width=GetWidth()+16;
