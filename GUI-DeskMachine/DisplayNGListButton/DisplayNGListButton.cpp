...
// ,NGListWindow(Base,parent)
{
	...
	QString ImageBmpFile[5]={
		/**/":Resources/DisplayNGListImage.bmp",	//���{��
		/**/":Resources/DisplayNGListImage-en.bmp",	//English
		/**/":Resources/DisplayNGListImage-en.bmp",	//�ȑ̒���
		/**/":Resources/DisplayNGListImage-en.bmp",	//�ɑ̒���
...
///////////
	...
	*/
	...
	NGListWindow->ConnectItemSelectionChanged(false);	//itemSelectionChanged���؂�
	NGListWindow->GetNGList()->setRowCount(LNumb);
	//NGListWindow->GetNGList()->setCurrentCell(0,0);
	NGListWindow->GetNGList()->clearSelection();
	NGListWindow->ConnectItemSelectionChanged(true);	//itemSelectionChanged�𕜊�
	//WidthLineNumber;
	int	N=0;
...
void DisplayNGListButton::ExecGeneralInfo2()
{
	...
	int Ret=-1;
	if(Param->GeneralInfo2==0){			//�ԕ\��������
		Ret=ExecCmdPixelNGDrawMode(false,false);
	}
	else if(Param->GeneralInfo2==1){	//�Ԋە\���̂�
		Ret=ExecCmdPixelNGDrawMode(false,true);
	}
	else if(Param->GeneralInfo2==2){	//�ڍו\���̂�
		Ret=ExecCmdPixelNGDrawMode(true,false);
	}
	else if(Param->GeneralInfo2==3){	//�����\��
...
void DisplayNGListButton::ExecGeneralInfo2Reverse()
{
	...
	int Ret=-1;
	if(Param->GeneralInfo2==0){			//�ڍו\���̂�
		Ret=ExecCmdPixelNGDrawMode(true,false);
	}
	else if(Param->GeneralInfo2==3){	//�Ԋە\���̂�
		Ret=ExecCmdPixelNGDrawMode(false,true);
	}
	else if(Param->GeneralInfo2==2){	//�ԕ\��������
		Ret=ExecCmdPixelNGDrawMode(false,false);
	}
	else if(Param->GeneralInfo2==1){	//�����\��
		Ret=ExecCmdPixelNGDrawMode(true,true);
	}
	if(Ret!=-1){
		Param->GeneralInfo2=Ret;
