...
public:
	...
	GUICmdPushedStartCapture(LayersBase *Base ,QString EmitterRoot,QString EmitterName ,int globalPage=-1);
...
{
public:
	GUICmdRepliedPushStartCapture(LayersBase *Base ,QString EmitterRoot,QString EmitterName ,int globalPage=-1);
