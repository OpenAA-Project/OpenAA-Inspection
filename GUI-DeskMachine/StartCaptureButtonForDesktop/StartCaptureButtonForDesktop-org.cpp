...
char	*sRoot=/**/"Action";
char	*sName=/**/"StartCaptureButtonForDesktop";
...
///			}
			...
			if(CurrentMasterCounter==1){
				GetLayersBase()->ShowProcessingForm("Generating mask");
				GetLayersBase()->AddMaxProcessing(0);
...
*/
			...
			if(CurrentMasterCounter==1){
				...
				if(DUp.exec()==QDialog::Rejected){
					...
					GetLayersBase()->ShowProcessingForm ("Finish edit");
...
//		if(GetLayersBase()->GetEntryPoint()->GetExecuteInspect()->GetMode()!=ExecuteInspectBase::_CaptureOnlyMaster){	//D-20091119
//			GetLayersBase()->GetEntryPoint()->GetExecuteInspect()->GoMasterCaptureOnly();								//D-20091119
//		}																												//D-20091119
//	}						//D-20090910
//	else{					//D-20090910
