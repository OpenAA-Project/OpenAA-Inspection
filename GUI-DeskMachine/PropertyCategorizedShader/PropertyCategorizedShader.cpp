...
**
** This file is C:\Regulus64v5\GUI-Desktop\PropertyCategorizedShader\PropertyCategorizedShader.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/

#include "PropertyCategorizedShader.h"
#include "PropertyCategorizedShaderForm.h"
...
char	*sRoot=/**/"Button";
char	*sName=/**/"PropertyCategorizedShader";
...
{
	return(/**/"Show Property for CategorizedShader");
}
...
{
	AlgorithmBase	*BBase=Base->GetAlgorithmBase(/**/"Basic",/**/"CategorizedShader");
	/*
	if(BBase!=NULL){
	...
	*/
	...
	return(new PropertyCategorizedShaderForm(Base,parent));
}
...
{
	return(new QIcon(QPixmap(/**/":Resources/PropertyCategorizedShader.png")));
}
