...
ThresholdSettingForm::ThresholdSettingForm(QWidget *parent,GUIFormBase *Base,PixelInspectionBase *PBase)
	: QDialog(parent)
{
	ui.setupUi(this);
	...
	QImage DetailSettingImage(DetailSettingImageBmpFile[((ButtonThreshold2 *)GUIBase)->LanguageCode]);
	...
	QImage CancelImage(CancelImageBmpFile[((ButtonThreshold2 *)GUIBase)->LanguageCode]);
