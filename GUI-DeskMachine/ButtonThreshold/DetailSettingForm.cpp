...
/*
	//�p���b�g���ݒ肵autoFillBackground�𗘗p���ē����F�œh���Ԃ�
	QPalette palette;
...
//				MsgBox.setFont	(font1[LanguageCode]);
				...
				MsgBox.setWindowFlags(Qt::WindowStaysOnTopHint);	//���ɑO�ʂɕ\��
				MsgBox.exec();
			}
...
//			MsgBox.setFont	(font1[LanguageCode]);
		...
		if((CheckBit&0x100)!=0){
			...
			//�f�t�H���g�����ύX�����Ă����ꍇ�������̂ŁA�f�t�H���g�ɋ����I�ɐݒ肷��
			if((CheckBit&0x80000)==0 || (CheckBit&0x1000000)==0){
				...
				if(((ButtonThreshold *)ParentWidget->GUIBase)->wInspectionLevel>10){
					ParentWidget->SetInspectionLevel(((ButtonThreshold *)ParentWidget->GUIBase)->wInspectionLevel);	//�������x���̐ݒ�
				}
				else{
					ParentWidget->SetImageSlider(((ButtonThreshold *)ParentWidget->GUIBase)->wInspectionLevel);		//�������x���̐ݒ�
				}
			}
			else{
				ParentWidget->SetImageSlider(((ButtonThreshold *)ParentWidget->GUIBase)->wInspectionLevel);			//�������x���̐ݒ�
