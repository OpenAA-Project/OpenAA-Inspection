...
public:
		...
		void ALLDelete();//LibFolder�̑S�폜
		void Delete(QString &FolderID);//LibFolder�̍폜
		void ChildDelete(QString &FolderID);//�q���K�w�̍폜
		void RetFolderID(QString Mid, QStringList &idList);//RELATEDMASTERCODE�̒ǉ��ɔ���
};
...
public:
		...
		void Load(QIODevice &Device, QStringList &Backup, QStringList &Now, QString &InsertData);	
		void ALLDelete();//InspectLib�̑S�폜
		void FolderDelete(QString &FolderID);//InspectLib��FolderID�폜
		void Delete(QString &TypeName, QString &LibID);//InspectLib��1���폜
};
