...
ResultDataManagerParam::ResultDataManagerParam(void)
{
	...
	SetParam(&ImageDrive				, /**/"Setting" ,/**/"ImageDrive"		,LangSolver.GetString(XResultDataManager_LS,LID_48)/*"NG�摜�̃t�H���_�p�X(Z:)"*/											,0);
	SetParam(&XML_IPAddress				, /**/"Setting" ,/**/"XML_IPAddress"	,LangSolver.GetString(XResultDataManager_LS,LID_49)/*"XML�T�[�o�[���N�����Ă���PC��IP�A�h���X(192.168.0.200)"*/			,0);
	SetParam(&XML_Port					, /**/"Setting" ,/**/"XML_Port"			,LangSolver.GetString(XResultDataManager_LS,LID_50)/*"XML�T�[�o�[�ւ̐ڑ��|�[�g�ԍ�(12345)"*/								,0);
	SetParam(&DatabaseHost				, /**/"Setting" ,/**/"DatabaseHost"		,LangSolver.GetString(XResultDataManager_LS,LID_51)/*"�f�[�^�x�[�X�̃z�X�g��(IP�A�h���X�܂���PC��)"*/						,0);
	SetParam(&DatabasePort				, /**/"Setting" ,/**/"DatabasePort"		,LangSolver.GetString(XResultDataManager_LS,LID_52)/*"FireBird�̐ڑ��|�[�g�ԍ�(3051)"*/									,0);
	SetParamFileName(&DatabaseFileName	, /**/"Setting" ,/**/"DatabaseFileName"	,LangSolver.GetString(XResultDataManager_LS,LID_53)/*"�f�[�^�x�[�X�t�@�C���ւ̃t���p�X(C:/Data/Regulus64.fdb)"*/			,0);
...

{
	...
	//QString		ResultStr;
	//int			LotAutoCount=0;
	//bool	SelectRet1=OpeHandle->SelectFirst(OutputStr,SearchStr,"",ResultStr);// �������b�g�̃��j�[�N�ԍ��擾
	//if(SelectRet1==true){
	...
	//	}
	//}
	int LotAutoCount = ReadLotAutoCount(TableStr, XMLServer);// �}�X�^�[�R�[�h��������

	if(SelectRet2==false){
		OutputStr	=QString(/**/"<IST><MASTERINFO MASTER/></IST>");
		SearchStr	=QString(/**/"<IST><MASTERINFO */></IST>");
		QString ResultStr;
		SelectRet2=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[�R�[�h�擾1
		if(SelectRet2==true){
	...
	if(SelectRet2==false){
		...
		QString ResultStr;
		bool SelectRet2=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[�R�[�h�擾2
		if(SelectRet2==true){
			QString	MasterCodeStr;
	...
	if(SelectRet2==false){
		...
		QString ResultStr;
		SelectRet2=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[���̎擾 -> �f�[�^�x�[�X�����}�X�^�[�R�[�h�����E�擾
		if(SelectRet2==true){
			QString	MasterName;
...
int ReadLotMasterCode(const QString &TableStr, XMLServerHandle *XMLServer)
{
	...
	int MasterCode=0;
	bool SelectRet1=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[�R�[�h�擾1
	if(SelectRet1==true){
		QString	MasterCodeStr;
		GetXMLAttrStr (ResultStr,/**/"MASTER",MasterCodeStr);
		bool ok;
	...
	SelectRet1=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[�R�[�h�擾2
	if(SelectRet1==true){
		QString	MasterCodeStr;
		GetXMLAttrStr (ResultStr,/**/"MID",MasterCodeStr);
		bool ok;
...
{
	int ret = ReadLotMasterCode(TableStr, XMLServer);// ���b�g�݂̂ŕ������Ηǂ�
	if(ret!=-1){
		return ret;
	}
	...
	bool SelectRet1=OpeHandle->SelectFirst(OutputStr,SearchStr,/**/"",ResultStr);// �}�X�^�[���̎擾 -> �f�[�^�x�[�X�����}�X�^�[�R�[�h�����E�擾
	if(SelectRet1==true){
		QString	MasterName;
		GetXMLAttrStr(ResultStr, /**/"MID", MasterName);
		bool ok;
