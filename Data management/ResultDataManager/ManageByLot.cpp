    ...
    ,ui(new Ui::ManageByLot)
{
	...
	if(XMLServer->Open()==false){
		QMessageBox::warning(this, /**/"Check:XMLServer"
								, LangSolver.GetString(ManageByLot_LS,LID_8)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
	}
	...
	if(GetLayersBase()->GetDatabase().tables().isEmpty()){
		QMessageBox::warning(this, /**/"Check:Database"
						, LangSolver.GetString(ManageByLot_LS,LID_9)/*"�f�[�^�x�[�X�ُ�"*/
						+ QString(/**/"\n") 
						+ LangSolver.GetString(ManageByLot_LS,LID_10)/*"�e�[�u�����J���Ȃ�"*/);
	}
	...
	hhLotHeaderList << LangSolver.GetString(ManageByLot_LS,LID_11)/*"���b�g�t�@�C����"*/
					<< LangSolver.GetString(ManageByLot_LS,LID_12)/*"���b�g��"*/ 
					<< LangSolver.GetString(ManageByLot_LS,LID_13)/*"�J�n��������"*/ 
					<< LangSolver.GetString(ManageByLot_LS,LID_14)/*"�I����������"*/
					<< LangSolver.GetString(ManageByLot_LS,LID_15)/*"������"*/;
	...
	hhInsHeaderList << LangSolver.GetString(ManageByLot_LS,LID_16)/*"�����ԍ�"*/
					<< LangSolver.GetString(ManageByLot_LS,LID_17)/*"����"*/
					<< LangSolver.GetString(ManageByLot_LS,LID_18)/*"��������"*/;
	...
	if(deleteTableList.isEmpty()==false){
		if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
			QMessageBox::warning(this, /**/"XMLServerError"
										,LangSolver.GetString(ManageByLot_LS,LID_19)/*"���b�g�f�[�^���폜�ł��Ȃ�"*/);
			return;
		}else{
...
void ManageByLot::on_pushButtonDeleteAll_clicked()
{
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_20)/*"�\�����̑S���b�g���폜��"*/);
	...
	if(deleteTableList.isEmpty()==false){
		if(XMLServer->GetState()==false && XMLServer->Open()==false){
			QMessageBox::warning(this, /**/"XMLServerError"
										, LangSolver.GetString(ManageByLot_LS,LID_21)/*"���b�g�f�[�^���폜�ł��Ȃ�"*/);
			return;
		}else{
			for(int i=0; i<deleteTableList.count(); i++){
				XMLServer->DeleteTable(deleteTableList[i]);
...
void ManageByLot::ShowAllInspect(LotInfo *w)
{
	if(XMLServer->GetState()==false && XMLServer->Open()==false){
		QMessageBox::warning(this, /**/"XMLServerError"
								, LangSolver.GetString(ManageByLot_LS,LID_22)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
		return;
	}
...
void ManageByLot::on_pushButtonDeleteLines_clicked()
{
	...
	if(Row>=0){
		if(XMLServer->GetState()==false && XMLServer->Open()==false){
			QMessageBox::warning(this, /**/"XMLServerError"
									, LangSolver.GetString(ManageByLot_LS,LID_23)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
			return;
		}
		...
		if(w!=NULL){
			...
			if(OpeHandle!=NULL){
				QProgressDialog progress;
				progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_24)/*"�I�����b�g�̍폜��"*/);
			...
			if(isEmptyDXML==true){
				if(XMLServer->GetState()==false && XMLServer->Open()==false){
					QMessageBox::warning(this, /**/"XMLServerError"
												, LangSolver.GetString(ManageByLot_LS,LID_25)/*"���b�g�f�[�^���폜�ł��Ȃ�"*/);
					clearInspectionTable();
					return;
				}else{
...
void ManageByLot::on_pushButtonBackup_clicked()
{
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_26)/*"�I�����b�g����NG�摜�t�@�C���̌�����"*/);
	progress.setRange(0, SelectedLines.GetCount());
	...
	for(IntClass *d=SelectedLines.GetFirst();d!=NULL;d=d->GetNext(), count++){
		...
		if(w!=NULL){
			if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
				QMessageBox::warning(this, /**/"XMLServerError"
										, LangSolver.GetString(ManageByLot_LS,LID_27)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
				return;
			}
	...
	progress.setCancelButton(0);// �E�L�E��E��E��E��E�Z�E��E��E�{�E�^�E��E��E�Ȃ�
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_28)/*"���b�g�t�@�C�����o�b�N�A�b�v��"*/);
	progress.setRange(0, SelectedLines.GetCount());
	count=0;
	for(IntClass *d=SelectedLines.GetFirst();d!=NULL;d=d->GetNext(),count++){
		progress.setValue(count);
		...
		if(w!=NULL){
			if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
				QMessageBox::warning(this, /**/"XMLServerError"
											, LangSolver.GetString(ManageByLot_LS,LID_29)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
				return;
			}
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_30)/*"NG�摜�t�@�C�����o�b�N�A�b�v��"*/);
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_31)/*"���b�g�t�@�C����NG�摜�t�@�C�����폜��"*/);
	progress.setRange(0, SelectedLines.GetCount());
	...
	if(deleteTableList.isEmpty()==false){
		if(XMLServer->GetState()==false && XMLServer->Open()==false){
			QMessageBox::warning(this, /**/"XMLServerError"
										, LangSolver.GetString(ManageByLot_LS,LID_32)/*"���b�g�f�[�^���폜�ł��Ȃ�"*/);
			return;
		}else{
			for(int i=0; i<deleteTableList.count(); i++){
				XMLServer->DeleteTable(deleteTableList[i]);
	...
	QMessageBox::information(NULL, /**/"Finish"
				, LangSolver.GetString(ManageByLot_LS,LID_33)/*"�o�b�N�A�b�v�����I��"*/
...
void ManageByLot::on_pushButtonRestore_clicked()
{
	...
	QString	FileName=QFileDialog::getOpenFileName ( 0
													, LangSolver.GetString(ManageByLot_LS,LID_34)/*"�o�b�N�A�b�v�t�@�C���̑I��"*/
													, QString()
													,/**/"BackupFile (*.bkp);;all files (*.*)");
	if(FileName.isEmpty()==true){
		return;
	...
	QProgressDialog progress(this);
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_35)/*"���X�g�A�����̎擾��"*/);
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_36)/*"���b�g�t�@�C���̃��X�g�A��"*/);
	for(int i=0;i<LineCount;i++){
		...
		if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
			QMessageBox::warning(this, /**/"XMLServerError"
										, LangSolver.GetString(ManageByLot_LS,LID_37)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
			return;
		}

		if(XMLServer->ReplaceTableAllData(TableName,AllData)==false){
			QMessageBox Q( /**/"Error in Restore"
						, LangSolver.GetString(ManageByLot_LS,LID_38)/*"���X�g�A���ɃG���[���������܂���"*/
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_39)/*"NG�摜�t�@�C���̃��X�g�A��"*/);
	QStringList JDTFileNames;
	for(int i=0; i<JDTCount; i++){
		QString filename;
	...
	QMessageBox::information(NULL, /**/"Finish"
				, LangSolver.GetString(ManageByLot_LS,LID_40)/*"���X�g�A�����I��"*/
				, QMessageBox::Ok , QMessageBox::NoButton, QMessageBox::NoButton);
...
void ManageByLot::ShowLotAll(int MachineID ,int MasterCode)
{
	...
	if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
		QMessageBox::warning(this, /**/"XMLServerError"
									, LangSolver.GetString(ManageByLot_LS,LID_41)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
		return;
	}
	...
	if(Ret==true){
		...
		for(int i=0;i<EnumResultList.count();i++){
			...
			if(OpeHandle!=NULL){
					...
					if(ui->cbShowInspectFirstEndTime->isChecked()==true){
						...
						if(OpeHandle->SelectFirst(/**/"<IST><TIM *>*</TIM></IST>", /**/"<IST */>", /**/"EID<INSPECT/>",ResultStr)==false || ResultStr.isEmpty()==true || ResultStr==/**/"<EOF/>" || ResultStr==/**/"<BOF/>"){
							...
							if(GetXMLValueStr(ResultStr, /**/"TIM", timeValue)==true){
								...
								first_tim.addYears(100);// 20xx�E�N�E�ɂ��E��E�
							...
							//	timeTIM.addYears(100);// 20xx�E�N�E�ɂ��E��E�
						...
						if(OpeHandle->SelectLast(/**/"<IST><TIM *>*</TIM></IST>", /**/"<IST */>", /**/"EID<INSPECT/>",ResultStr)==false || ResultStr.isEmpty()==true || ResultStr==/**/"<EOF/>" || ResultStr==/**/"<BOF/>"){
							...
							if(GetXMLValueStr(ResultStr, /**/"TIM", timeValue)==true){
								...
								last_tim.addYears(100);// 20xx�E�N�E�ɂ��E��E�
								EndTimeValue = last_tim.toString(/**/"yy/MM/dd hh:mm:ss");
							}
						}
					}
				...
				//	continue;
				//}
				//// �E��E��E�b�E�g�E��E��E�A�E��E��E�b�E�gID�E��E��E�擾
				...
				//	;
				//}
				//// �E��E��E��E��E�E�E�ŏI�E��E��E��E��E��E��E��E�
...
void ManageByLot::on_pushButtonBackupOnly_clicked()
{
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_42)/*"�I�����b�g����NG�摜�t�@�C���̌�����"*/);
	progress.setRange(0, SelectedLines.GetCount());
	...
	for(IntClass *d=SelectedLines.GetFirst();d!=NULL;d=d->GetNext(), count++){
		...
		if(w!=NULL){
			if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
				QMessageBox::warning(this, /**/"XMLServerError"
											, LangSolver.GetString(ManageByLot_LS,LID_43)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
				return;
			}
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_44)/*"���b�g�t�@�C�����o�b�N�A�b�v��"*/);
	progress.setRange(0, SelectedLines.GetCount());
	count=0;
	for(IntClass *d=SelectedLines.GetFirst();d!=NULL;d=d->GetNext(),count++){
		progress.setValue(count);
		...
		if(w!=NULL){
			if(XMLServer->IsConnected(0)==false && XMLServer->Open()==false){
				QMessageBox::warning(this, /**/"XMLServerError"
											, LangSolver.GetString(ManageByLot_LS,LID_45)/*"XMLServer�ɐڑ��ł��Ȃ�"*/);
				return;
			}
	...
	progress.setLabelText(LangSolver.GetString(ManageByLot_LS,LID_46)/*"NG�摜�t�@�C�����o�b�N�A�b�v��"*/);
	progress.setRange(0, JDTCount);
	...
	QMessageBox::information(NULL, /**/"Finish"
				, LangSolver.GetString(ManageByLot_LS,LID_47)/*"�o�b�N�A�b�v�����I��"*/
				, QMessageBox::Ok , QMessageBox::NoButton, QMessageBox::NoButton);
