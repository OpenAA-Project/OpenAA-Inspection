/****************************************************************************
** Meta object code from reading C++ file 'XCameraInterfaceDLL.h'
**
...
#include <memory>
#include "../../../../GeneralSource/XCameraInterfaceDLL.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'XCameraInterfaceDLL.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 14), // "SignalCaptured"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 12) // "SlotCaptured"

    },
    "CameraInterface\0SignalCaptured\0\0"
    "SlotCaptured"
};
...
void CameraInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraInterface::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraInterface::SignalCaptured)) {
                *result = 0;
                return;
            }
        }
...
void *CameraInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "DLLManager"))
        return static_cast< DLLManager*>(this);
...
// SIGNAL 0
void CameraInterface::SignalCaptured()
{
