...
void SelectItemsDialog::resizeEvent ( QResizeEvent * event )
{
	...
	int	W=width()-32;
	ui->tableWidget->setColumnWidth(0,W*0.10);
	ui->tableWidget->setColumnWidth(1,W*0.10);
	ui->tableWidget->setColumnWidth(2,W*0.10);
	ui->tableWidget->setColumnWidth(3,W*0.10);
	ui->tableWidget->setColumnWidth(4,W*0.20);
	ui->tableWidget->setColumnWidth(4,W*0.37);

	ui->tableWidgetBinded->setColumnWidth(0,W*0.85);
	ui->tableWidgetBinded->setColumnWidth(1,W*0.13);
