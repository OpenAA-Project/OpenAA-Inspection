    ...
    ,ui(new Ui::LargeFlatInspectionForm)
{
	...
	if(Parent->RepresentativePoint!=NULL){
		...
		//
		//			QString	s1	=QString("�ԈÑ�:")+QString::number(RL->Data.toInt())+QString(" ����:")+QString::number(RH->Data.toInt())
		//						+QString(/**/"\n")
		//						+QString("�ΈÑ�:")+QString::number(GL->Data.toInt())+QString(" ����:")+QString::number(GH->Data.toInt())
		//						+QString(/**/"\n")
		//						+QString("�Ñ�:")+QString::number(BL->Data.toInt())+QString(" ����:")+QString::number(BH->Data.toInt());
		//			QString	s2	=QString("�̈��T��:")+QString::number(AreaSearch->Data.toInt())
		//						+QString(/**/"\n")
		//						+QString("�s�N�Z���T��:")+QString::number(SelfSearch->Data.toInt());
		//			QString	s3	=QString("OK�h�b�g:")+QString::number(OKDot->Data.toInt())
		//						+QString(/**/"\n")
