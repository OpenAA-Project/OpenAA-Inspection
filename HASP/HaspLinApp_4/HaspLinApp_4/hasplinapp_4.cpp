...
HaspLinApp_4::HaspLinApp_4(QWidget *parent, Qt::WindowFlags flags)
    : QMainWindow(parent, flags)
{
	ui.setupUi(this);
}

HaspLinApp_4::~HaspLinApp_4()
{

}


void HaspLinApp_4::on_pushButton_clicked()
{
...
bool HaspLinApp_4::ReadHasp(hasp_handle_t handle, QByteArray &readData)
{
	char ReadHaspData[48];
	for(int i=0; i<=48; i++){
		ReadHaspData[i]=NULL;
	}
	readData.clear();
...
void HaspLinApp_4::Return(QByteArray InData,QStringList &RetData)
{
	QString sHYOUJI1;
	QString sHYOUJI4;
	QString sHYOUJI7;
