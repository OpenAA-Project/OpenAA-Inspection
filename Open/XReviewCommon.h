...
// Review::FKey��int�^�ɕϊ������BF1==0, F2==1, ... , F12==11, F�L�[�Ȃ�==12, ���̑�==-1���Ԃ�
int FKeyToInt(Review::FKey key);

// int�^��Review::FKey�֕ϊ������B���l0�`12��F1�`F12,NoFKey�̓����ƂȂ��B�͈͂����O�ꂽ�ꍇ��NoFKey���Ԃ�
Review::FKey IntToFKey(int ref);

// �}�X�^�[�R�[�h�A�}�V��ID�AXML�̃t�@�C��������XML�T�[�o�[�̌����f�B���N�g�������̃t�@�C���p�X���쐬����
QString makeLotFileName(int MasterCode, int MachineID, QString FileName);

// XML�t�@�C���ɋL�q�����Ă��������t�H�[�}�b�g��QString����XDateTime�I�u�W�F�N�g���č\������
