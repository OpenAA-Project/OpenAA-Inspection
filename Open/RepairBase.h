...
//	NPListPack<NGPointBaseList> NoImageNGPList[2];
	...
	int			PieceInfoDataCount[2];			//�Џ�����
	PieceInfoData *PieceInfoDataList[2];		//�Џ����f�[�^
	int			ClientNo[2];
	QByteArray	strQNO;
	QByteArray	strQNO1;
	QByteArray	strQNO2;
	...
	bool			wErrNextBS;			//�G���[�����{�^����On�^Off�ێ����[�N
	bool			wNGBS;				//NG�{�^����On�^Off�ێ����[�N
	bool			wBackBS;			//�߂��{�^����On�^Off�ێ����[�N
	bool			wUnloadDone;		//�r�o�R�����g�\���v���M�����[�N
	bool			wMacEmergency;		//�ُ픭���M�����[�N
	bool			wMacEmgRestart;		//�ُ픭���M���i�����j���[�N
	bool			wReviewEnableFlag;	//���r���[�ĊJ�t���O���[�N
	bool			FirstUpdateFlag;	//����Update���Ƀ{�^���������L���ɂ�����
	QList<int>		PrevNGRow;			//���O��NG���X�g�̍s�ێ����[�N
...
//	void			SetRetXMLDataList	(SideType Type,QList<QByteArray> *RetXMLData);
	...
	QString			GetString			(const QString		*value,QString FirstStr,QString EndStr,int Index=0);	//�����񂩂��ړI�̃f�[�^���؂�����
	QByteArray		GetString			(const QByteArray	*value,QString FirstStr,QString EndStr,int Index=0);	//�����񂩂��ړI�̃f�[�^���؂�����
	QByteArray		GetString			(const QByteArray	*value,QString FirstStr,int Count=0);					//�����񂩂��ړI�̃f�[�^���w�蕶�������؂�����
	int				GetStringCount		(const QString *value,QString strData);								//�����񂩂��ړI�̃f�[�^���������邩������
...
private:
	...
	InspectionDataForm InsDataDialog;	//�����f�[�^��Select���ʂ��\�������_�C�A���O
