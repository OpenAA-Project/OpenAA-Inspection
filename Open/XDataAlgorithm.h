...
protected:
  ...
  #pragma	pack(pop)
    SubtractItemContainer	SubBlock;	//���O�u���b�N�ԍ�
...
public:
	...
	//�A���C�������g�����擾���i
	//	�EExecuteInitialAfterEdit����GetAlignmentPointer���Ă��ŁA�A���C�������g�f???�C��?���擾����
	//	�EExecuteAlignment��?�ŁAGetAlignmentForProcessing���Ă�
