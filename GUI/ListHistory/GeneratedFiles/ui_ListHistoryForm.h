/********************************************************************************
** Form generated from reading UI file 'ListHistoryForm.ui'
**
...
#ifndef UI_LISTHISTORYFORM_H
#define UI_LISTHISTORYFORM_H
...
public:
    ...
    void setupUi(GUIFormBase *ListHistoryFormClass)
    {
        if (ListHistoryFormClass->objectName().isEmpty())
            ListHistoryFormClass->setObjectName("ListHistoryFormClass");
        ListHistoryFormClass->resize(251, 350);
        frame = new QFrame(ListHistoryFormClass);
        ...
        tableWidgetHistory = new QTableWidget(ListHistoryFormClass);
        ...
        tableWidgetHistory->setHorizontalHeaderItem(4, __qtablewidgetitem4);
        tableWidgetHistory->setObjectName("tableWidgetHistory");
        tableWidgetHistory->setGeometry(QRect(0, 0, 251, 311));

        retranslateUi(ListHistoryFormClass);

        QMetaObject::connectSlotsByName(ListHistoryFormClass);
    } // setupUi

    void retranslateUi(GUIFormBase *ListHistoryFormClass)
    {
        ListHistoryFormClass->setWindowTitle(QCoreApplication::translate("ListHistoryFormClass", "ListHistoryForm", nullptr));
        label->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400; color:#008000;\">OK</span></p></body></html>", nullptr));
        labelOK->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'MS UI Gothic'; font-size:12pt; font-weight:600; font-style:normal; text-decoration:none;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400;\">100</span></p></body></html>", nullptr));
        label_6->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'MS UI Gothic'; font-size:12pt; font-weight:600; font-style:normal; text-decoration:none;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400; color:#ff0000;\">NG</span></p></body></html>", nullptr));
        labelNG->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'MS UI Gothic'; font-size:12pt; font-weight:600; font-style:normal; text-decoration:none;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400;\">100</span></p></body></html>", nullptr));
        label_3->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'MS UI Gothic'; font-size:12pt; font-weight:600; font-style:normal; text-decoration:none;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400;\">SUM</span></p></body></html>", nullptr));
        labelSUM->setText(QCoreApplication::translate("ListHistoryFormClass", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'MS UI Gothic'; font-size:12pt; font-weight:600; font-style:normal; text-decoration:none;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:400;\">200</span></p></body></html>", nullptr));
        ButtonReset->setText(QCoreApplication::translate("ListHistoryFormClass", "Reset", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetHistory->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("ListHistoryFormClass", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetHistory->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("ListHistoryFormClass", "Date/Time", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetHistory->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("ListHistoryFormClass", "NG", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetHistory->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("ListHistoryFormClass", "SV", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidgetHistory->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("ListHistoryFormClass", "ms", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ListHistoryFormClass: public Ui_ListHistoryFormClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LISTHISTORYFORM_H
