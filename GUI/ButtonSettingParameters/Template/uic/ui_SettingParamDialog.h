...
public:
    ...
    void setupUi(QDialog *SettingParamDialogClass)
    {
        ...
        tabWidgetResult->setObjectName(QString::fromUtf8("tabWidgetResult"));
        ...
        tabWidgetAlgorithm->setObjectName(QString::fromUtf8("tabWidgetAlgorithm"));
        ...
        tabOutlineOffset->setObjectName(QString::fromUtf8("tabOutlineOffset"));
        ButtonOutlineOffset = new QPushButton(tabOutlineOffset);
        ButtonOutlineOffset->setObjectName(QString::fromUtf8("ButtonOutlineOffset"));
        ButtonOutlineOffset->setGeometry(QRect(480, 340, 131, 41));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Qtres/Save.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        frameScanPhase->setObjectName(QString::fromUtf8("frameScanPhase"));
        ...
        pushButtonRowImageTable->setObjectName(QString::fromUtf8("pushButtonRowImageTable"));
        pushButtonRowImageTable->setGeometry(QRect(40, 20, 201, 34));
        pushButtonLoadImageTable = new QPushButton(tab_3);
        pushButtonLoadImageTable->setObjectName(QString::fromUtf8("pushButtonLoadImageTable"));
        ...
        pushButtonEachPage->setObjectName(QString::fromUtf8("pushButtonEachPage"));
