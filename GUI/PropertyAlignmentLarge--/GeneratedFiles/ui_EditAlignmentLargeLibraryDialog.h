...
public:
    ...
    void setupUi(QDialog *EditAlignmentLargeLibraryDialog)
    {
        if (EditAlignmentLargeLibraryDialog->objectName().isEmpty())
            EditAlignmentLargeLibraryDialog->setObjectName(QString::fromUtf8("EditAlignmentLargeLibraryDialog"));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Qtres/Update.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Qtres/Close.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Qtres/ClearNew.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Qtres/SaveNew.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        checkBoxGenerateBitBuff->setObjectName(QString::fromUtf8("checkBoxGenerateBitBuff"));
        checkBoxGenerateBitBuff->setGeometry(QRect(10, 54, 291, 21));
        checkBoxGenerateArea = new QCheckBox(tab);
        checkBoxGenerateArea->setObjectName(QString::fromUtf8("checkBoxGenerateArea"));
        checkBoxGenerateArea->setGeometry(QRect(10, 10, 291, 21));
        checkBoxGenerateMark = new QCheckBox(tab);
        checkBoxGenerateMark->setObjectName(QString::fromUtf8("checkBoxGenerateMark"));
        ...
        spinBoxMinGenerationAreaDots->setObjectName(QString::fromUtf8("spinBoxMinGenerationAreaDots"));
        ...
        spinBoxMinGenerationMarkDots->setObjectName(QString::fromUtf8("spinBoxMinGenerationMarkDots"));
        ...
        spinBoxMaxCountHLine->setObjectName(QString::fromUtf8("spinBoxMaxCountHLine"));
        ...
        checkBoxUsageGlobal->setGeometry(QRect(10, 160, 121, 21));
        ...
        spinBoxMaxCountVLine->setObjectName(QString::fromUtf8("spinBoxMaxCountVLine"));
