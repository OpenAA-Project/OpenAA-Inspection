...
public:
    ...
    void setupUi(QDialog *SelectAlignmentLargeDialog)
    {
        if (SelectAlignmentLargeDialog->objectName().isEmpty())
            SelectAlignmentLargeDialog->setObjectName(QString::fromUtf8("SelectAlignmentLargeDialog"));
        ...
        EditItemName->setObjectName(QString::fromUtf8("EditItemName"));
        ...
        checkBoxUsageGlobal->setGeometry(QRect(40, 440, 121, 21));
        labelCautionForOrigin = new QLabel(SelectAlignmentLargeDialog);
        labelCautionForOrigin->setObjectName(QString::fromUtf8("labelCautionForOrigin"));
