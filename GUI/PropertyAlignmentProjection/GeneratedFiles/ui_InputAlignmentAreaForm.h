...
public:
    ...
    {
        InputAlignmentAreaFormClass->setWindowTitle(QApplication::translate("InputAlignmentAreaFormClass", "InputAlignmentAreaForm", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("InputAlignmentAreaFormClass", "\343\202\250\343\203\252\343\202\242\345\220\215\347\247\260", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("InputAlignmentAreaFormClass", "\343\203\251\343\202\244\343\203\226\343\203\251\343\203\252\343\201\224\343\201\250\343\201\256\343\202\242\343\203\251\343\202\244\343\203\263\343\203\241\343\203\263\343\203\210", 0, QApplication::UnicodeUTF8));
        ButtonOK->setText(QApplication::translate("InputAlignmentAreaFormClass", "OK", 0, QApplication::UnicodeUTF8));
        ButtonCancel->setText(QApplication::translate("InputAlignmentAreaFormClass", "Cancel", 0, QApplication::UnicodeUTF8));
        ButtonDelete->setText(QApplication::translate("InputAlignmentAreaFormClass", "Delete", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("InputAlignmentAreaFormClass", "Priority", 0, QApplication::UnicodeUTF8));
        radioButtonPriorityHigh->setText(QApplication::translate("InputAlignmentAreaFormClass", "High( Exp. BGA, special part)", 0, QApplication::UnicodeUTF8));
        radioButtonPriorityMiddle->setText(QApplication::translate("InputAlignmentAreaFormClass", "Middle (General)", 0, QApplication::UnicodeUTF8));
        radioButtonPriorityLow->setText(QApplication::translate("InputAlignmentAreaFormClass", "Low (Only parts fitting)", 0, QApplication::UnicodeUTF8));
        radioButtonPriorityLGlobal->setText(QApplication::translate("InputAlignmentAreaFormClass", "Global alignment (Only for other alignment)", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
