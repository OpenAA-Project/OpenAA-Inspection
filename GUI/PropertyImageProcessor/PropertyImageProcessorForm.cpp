...
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_1)/*"���m�N��"*/;
}

void PropertyImageProcessorForm::on_ButtonOpposite_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_2)/*"���Ô��]"*/;
}

void PropertyImageProcessorForm::on_FilterAddButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_3)/*"���Z"*/;
}

void PropertyImageProcessorForm::on_FilterSubButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_4)/*"���Z"*/;
}

void PropertyImageProcessorForm::on_FilterMulButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_5)/*"�����{"*/;
}

void PropertyImageProcessorForm::on_FilterCoefButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_6)/*"����"*/;
}

void PropertyImageProcessorForm::on_ButtonFilterLineEmphasis_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_7)/*"������"*/;
}

void PropertyImageProcessorForm::on_ButtonLaplace_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_8)/*"���׼��"*/;
}

void PropertyImageProcessorForm::on_ButtonGradiant_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_9)/*"���z"*/;
}

void PropertyImageProcessorForm::on_ButtonTransLog_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_10)/*"�ΐ��ϊ�"*/;
}

void PropertyImageProcessorForm::on_ButtonDiverse_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_11)/*"����"*/;
}
...
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_14)/*"���k"*/;
}

void PropertyImageProcessorForm::on_FilterRelativeBinarizeButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_15)/*"���΂Q�l"*/;
}
...
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_20)/*"�������l"*/;
}

void PropertyImageProcessorForm::on_FilterAllocButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_21)/*"���ʊ���"*/;
}
...
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_28)/*"����������"*/;
}

void PropertyImageProcessorForm::on_FractalDimButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_29)/*"�t���N�^������"*/;
}

void PropertyImageProcessorForm::on_StatisticButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_30)/*"�������v"*/;
}

void PropertyImageProcessorForm::on_LinearizeButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_31)/*"�א���"*/;
}

void PropertyImageProcessorForm::on_ButtonRemoveNoise_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_32)/*"�m�C�Y����"*/;	
}

void PropertyImageProcessorForm::on_MatchLearnButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_33)/*"�w�K�}�b�`"*/;
}

void PropertyImageProcessorForm::on_ButtonRemoveStandalone_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_34)/*"�Ǘ��_����"*/;	
}

void PropertyImageProcessorForm::on_ButtonDisorderRegular_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_35)/*"���K���z����"*/;
}

void PropertyImageProcessorForm::on_ButtonErgod_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_36)/*"�G���S�[�h��"*/;
}

void PropertyImageProcessorForm::on_ButtonRemoveSpot_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_37)/*"�P�_����"*/;	
}

void PropertyImageProcessorForm::on_ButtonConnectNearBy_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_38)/*"�ߖT�ڑ�"*/;
}

void PropertyImageProcessorForm::on_ButtonMakeMaxPath_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_39)/*"�Œ��p�X"*/;
}
...
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_41)/*"���ςQ�l��"*/;
}

void PropertyImageProcessorForm::on_FilterMedianButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_42)/*"�������ω�"*/;
}

void PropertyImageProcessorForm::on_FilterMosaicButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_43)/*"���U�C�N��"*/;
}

void PropertyImageProcessorForm::on_FilterLineEmphasizerButton_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_44)/*"������"*/;
}

void PropertyImageProcessorForm::on_ButtonPickupWeb_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_45)/*"�Ԗڌ��o"*/;
}

void PropertyImageProcessorForm::on_ButtonConnectPartial_clicked()
{
	CurrentTitle=LangSolver.GetString(PropertyImageProcessorForm_LS,LID_46)/*"�r�ؐڑ�"*/;
}