	...
	: GUIFormBase(Base,parent)
{
	...
	HeaderLabel.append(LangSolver.GetString(PropertyEulerRingForm_LS,LID_11)/*"���C�u������"*/);
	HeaderLabel.append(LangSolver.GetString(PropertyEulerRingForm_LS,LID_12)/*"�u���b�N����"*/);
