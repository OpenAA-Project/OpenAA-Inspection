#include "ManualPixelImagePanelResource.h"
/*******************************************************************************
...
**
** This file is C:\Regulus64v5\GUI\ManualPixelImagePanel\ManualPixelImagePanel.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
...
static	const	char	*sName=/**/"ManualPixelInspectionImagePanel";
...
{
	return(/**/"ManualPixelInspectionImagePanel");
}
...
{
	return(new QIcon(QPixmap(/**/":Resources/ManualPixelImagePanel.png")));
}
...
void	PixelInspectionImagePanel::MouseMoveEvent(int globalX ,int globalY)
{
	...
	GUIFormBase	*GProp=GetLayersBase()->FindByName(/**/"Button" ,/**/"ManualPropertyPixelInspectionForm" ,/**/"");
