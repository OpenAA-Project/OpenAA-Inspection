	...
	: GUIFormBase(Base,parent)
{
	...
	HeaderLabel.append(LangSolver.GetString(PropertyStatisticBlockForm_LS, LID_7)/*"���C�u������"*/);
	HeaderLabel.append(LangSolver.GetString(PropertyStatisticBlockForm_LS,LID_8)/*"�u���b�N����"*/);
