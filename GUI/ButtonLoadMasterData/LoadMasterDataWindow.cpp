	...
	: QWidget(parent),ServiceForLayers(Base)
{
	...
	ParentGUI=dynamic_cast<ButtonLoadMasterData *>(parent);
...
void	LoadMasterDataWindow::ShowListHeader(void)
{
	...
	QString	MasterCodeStr	=LangSolver.GetString(LoadMasterDataWindow_LS,LID_3)/*"MasterCode"*/;
	QString	MachineNameStr	=LangSolver.GetString(LoadMasterDataWindow_LS,LID_28)/*"Machine"*/;
	QString	RegTimeStr		=LangSolver.GetString(LoadMasterDataWindow_LS,LID_4)/*"RegTime"*/;
	QString	LastEditStr		=LangSolver.GetString(LoadMasterDataWindow_LS,LID_0)/*"Last Edit"*/;
	QString	NameStr			=LangSolver.GetString(LoadMasterDataWindow_LS,LID_5)/*"Name"*/;
	QString	RemarkStr		=LangSolver.GetString(LoadMasterDataWindow_LS,LID_6)/*"Remark"*/;
	switch(ListMode){
		case  _IDNormal:
			MasterCodeStr=MasterCodeStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_12)/*"Up"*/;
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_13)/*"MasterCode ->"*/);
			break;
		case  _IDReverse:
			MasterCodeStr=MasterCodeStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_14)/*"Down"*/;
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_15)/*"MasterCode <-"*/);
			break;
		case  _TimeNormal:
			RegTimeStr	=RegTimeStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_16)/*"Up"*/;
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_17)/*"RegTime ->"*/);
			break;
		case  _TimeReverse:
			RegTimeStr	=RegTimeStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_18)/*"Down"*/;
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_19)/*"RegTime <-"*/);
			break;
		case  _NameNormal:
			NameStr		=NameStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_20)/*"Up"*/;
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_21)/*"MasterName ->"*/);
			break;
		case  _NameReverse:
			NameStr		=NameStr+LangSolver.GetString(LoadMasterDataWindow_LS,LID_22)/*"Down"*/;
		...
		case  _LastEditNormal:
			...
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_1)/*"LastEdit ->"*/);
			break;
		case  _LastEditReverse:
			LastEditStr	=LastEditStr+QString(/**/"Down");
			ui.lineEditState->setText(LangSolver.GetString(LoadMasterDataWindow_LS,LID_2)/*"LastEdit <-"*/);
			break;
	}
...
void LoadMasterDataWindow::on_ButtonLoad_clicked()
{
	...
	if(SyncCount==true){
		if(QMessageBox::question(NULL,LangSolver.GetString(LoadMasterDataWindow_LS,LID_26)/*"Synchronized"*/
									,LangSolver.GetString(LoadMasterDataWindow_LS,LID_27)/*"???u?a?C?Y???Y?U??E?c?H"*/
	...
	if(ok==true){
		...
		GetLayersBase()->ShowProcessingForm (LangSolver.GetString(LoadMasterDataWindow_LS,LID_11)/*"Loading master data"*/);
		...
		if(GetLayersBase()->SQLLoadMasterData(MasterCode,SelectedMachineID,ModeLoadMasterImage
			...
			if(CriticalErrorOccured==true){
				...
				QMessageBox::critical ( NULL, LangSolver.GetString(LoadMasterDataWindow_LS,LID_7)/*"Reboot"*/, LangSolver.GetString(LoadMasterDataWindow_LS,LID_8)/*"Reboot software to change critical items"*/, QMessageBox::Ok);
	...
	if(GetLayersBase()->GetParamComm()->ConnectedPCNumb!=0){
		...
		|| PageNumb		!=GetLayersBase()->GetPageNumb()){
			...
			QMessageBox::critical ( NULL
							, LangSolver.GetString(LoadMasterDataWindow_LS,LID_7)/*"Reboot"*/
