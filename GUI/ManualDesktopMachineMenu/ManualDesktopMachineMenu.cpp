...
**
** This file is C:\Regulus64v5\GUI\ManualDesktopMachineMenu\ManualDesktopMachineMenu.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
...
const	char	*sName=/**/"ManualDesktopMachineMenuProperty";
...
{
	return(/**/"Show menu for DesktopMachine");
}
...
DEFFUNCEX	bool	DLL_Initial(LayersBase *Base)
{
	...
	(*Base)=new GUICmdStartStatisticScan(Base,QString(sRoot),QString(sName));
	(*Base)=new GUICmdReplyStatisticScan(Base,QString(sRoot),QString(sName));
...
{
	return(new DesktopMachineMenuProperty(Base,parent));
}
...
DEFFUNCEX	int32	DLL_GetPropertyString(void	*Instance ,struct	PropertyClass Data[] ,WORD	maxDataDim)
{
	...
	Data[0].Pointer				 =&((DesktopMachineMenuProperty *)Instance)->CFont;
...
{
	return(new QIcon(QPixmap(/**/":Resources/ManualDesktopMachineMenu.png")));
}
