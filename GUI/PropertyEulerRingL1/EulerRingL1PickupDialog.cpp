...
#include "ui_EulerRingL1PickupDialog.h"
...
EulerRingL1PickupDialog::EulerRingL1PickupDialog(FlexArea &area ,EulerRingL1ImagePanel *parentPanel ,int pickupL,int pickupH,QWidget *parent) :
    QDialog(parent),
    ui(new Ui::EulerRingL1PickupDialog)
{
    ui->setupUi(this);
...
EulerRingL1PickupDialog::~EulerRingL1PickupDialog()
{
    delete ui;
}


void	EulerRingL1PickupDialog::Reflect(int pickupL ,int pickupH)
{
	PickupL=pickupL;
	PickupH=pickupH;
...
void EulerRingL1PickupDialog::GetHistogramData(void)
{
	IntList PageList;
...
void	EulerRingL1PickupDialog::SlotLineGraphDClick(int X,int Y)
{
...
void EulerRingL1PickupDialog::ShowThreshold(void)
{
...
void EulerRingL1PickupDialog::on_ButtonReflect_clicked()
{
...
void EulerRingL1PickupDialog::on_ButtonClose_clicked()
{
	done(false);
}

void EulerRingL1PickupDialog::on_EditPickupL_valueChanged(int arg1)
{
...
void EulerRingL1PickupDialog::on_EditPickupH_valueChanged(int arg1)
{
