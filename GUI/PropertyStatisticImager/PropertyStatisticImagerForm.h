...
**
** This file is C:\Regulus64v5\GUI\PropertyStatisticImager\PropertyStatisticImagerForm.h
** Author : YYYYYYYYYY
****************************************************************************-**/
...
public:
	...
	GUICmdReqMakeAverageImage(LayersBase *Base ,const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
