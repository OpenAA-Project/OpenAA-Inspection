...
**
** This file is C:\Regulus64v5\GUI\PropertyAlignmentFlexArea\BrightHistogramForm.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
#include <QPalette>
...
BrightHistogramForm::BrightHistogramForm(FlexArea &area ,AlignmentFlexAreaImagePanel *parentPanel ,int pickupL,int pickupH,LayersBase *base ,QWidget *parent)
...
void BrightHistogramForm::on_EditPickupL_valueChanged(int)
{
...
void BrightHistogramForm::on_EditPickupH_valueChanged(int)
{
