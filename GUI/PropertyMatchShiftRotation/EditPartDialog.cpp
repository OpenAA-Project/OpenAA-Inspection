...
EditPartDialog::EditPartDialog(LayersBase *base ,QWidget *parent) :
    QDialog(parent)
...
void	EditPartDialog::Reflect(bool EditMode)
{
...
void	EditPartDialog::SlotSelectLibFolder(int libFolderID ,QString FolderName)
{
...
void EditPartDialog::on_ButtonOK_clicked()
{
	AreaName	=ui->lineEditAreaName	->text();
	done(true);
}

void EditPartDialog::on_ButtonCancel_clicked()
{
	done(false);
}

void EditPartDialog::on_tableWidgetLibList_clicked(const QModelIndex &Index)
{
...
void EditPartDialog::on_ButtonDelete_clicked()
{
	done(10);
}
