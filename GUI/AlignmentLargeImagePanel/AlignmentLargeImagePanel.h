...
class	GUICmdReqAreaOnLocalPoint : public GUICmdPacketBase
{
public:
	int32		LocalX;
	int32		LocalY;
	...
	GUICmdReqAreaOnLocalPoint(LayersBase *Base,const QString &emitterRoot ,const QString &emitterName,int globalPage=-1);
...
class	GUICmdSendAreaOnLocalPoint : public GUICmdPacketBase
{
public:
	ListAreaIDInfoContainer	AreaList;

	GUICmdSendAreaOnLocalPoint(LayersBase *Base,const QString &emitterRoot ,const QString &emitterName,int globalPage=-1);
...
class	GUICmdSelectAreaByIDs : public GUICmdPacketBase	//アイテム選択要求コマンド
{
public:
	ListAreaIDInfoContainer	AreaList;

	GUICmdSelectAreaByIDs(LayersBase *Base ,const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
...
class	GUICmdSelectAreaByArea : public GUICmdPacketBase	//アイテム選択要求コマンド
{
public:
	FlexArea	Area;
	IntList		LayerList;
	...
	GUICmdSelectAreaByArea(LayersBase *base ,const QString &emitterRoot ,const QString &emitterName,int globalPage=-1);
