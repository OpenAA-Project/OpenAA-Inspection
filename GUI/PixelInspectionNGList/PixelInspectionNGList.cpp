#include "PixelInspectionNGListResource.h"
/*******************************************************************************
...
**
** This file is C:\Regulus64v5\GUI\PixelInspectionNGList\PixelInspectionNGList.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
...
static	const	char	*sName=/**/"PixelInsNGList";
...
{
	return(new QIcon(QPixmap(/**/":Resources/PixelInspectionNGList.png")));
}
...
void	PixelInspectionNGList::Prepare(void)
{
	...
	NGList.setHorizontalHeaderItem ( 0, new QTableWidgetItem(/**/"Pg"));
	NGList.setHorizontalHeaderItem ( 1, new QTableWidgetItem(/**/"Position"));
