...
void SelectLibraryDialog::on_tableWidgetLibList_itemDoubleClicked(QTableWidgetItem *item)
{
	AlgorithmLibraryList	*a=LibList.GetItem(ui->tableWidgetLibList->currentRow());
	if(a!=NULL){
