...
**
** This file is C:\Regulus64v5\GUI\PropertyLineEnhancer\PropertyLineEnhancer.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
#include "PropertyLineEnhancerResource.h"
#include "XGUIDLL.h"
#include "PropertyLineEnhancer.h"
#include "PropertyLineEnhancerForm.h"

const	char	*sRoot=/**/"Button";
const	char	*sName=/**/"PropertyLineEnhancer";
...
{
	return(/**/"Show Property for LineEnhancer");
}
...
{
	return(new PropertyLineEnhancerForm(Base,parent));
}
...
{
	return(new QIcon(QPixmap(/**/":Resources/PropertyLineEnhancer.png")));
}
