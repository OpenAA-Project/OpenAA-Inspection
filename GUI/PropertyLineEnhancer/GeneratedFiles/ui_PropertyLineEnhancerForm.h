/********************************************************************************
** Form generated from reading UI file 'PropertyLineEnhancerForm.ui'
**
...
#ifndef UI_PROPERTYLINEENHANCERFORM_H
#define UI_PROPERTYLINEENHANCERFORM_H
...
class Ui_PropertyLineEnhancerFormClass
{
public:
    ...
    void setupUi(GUIFormBase *PropertyLineEnhancerFormClass)
    {
        if (PropertyLineEnhancerFormClass->objectName().isEmpty())
            PropertyLineEnhancerFormClass->setObjectName("PropertyLineEnhancerFormClass");
        PropertyLineEnhancerFormClass->resize(400, 700);
        pushButtonEditLibFolder = new QPushButton(PropertyLineEnhancerFormClass);
        ...
        labelLibFolderName = new QLabel(PropertyLineEnhancerFormClass);
        ...
        label_30 = new QLabel(PropertyLineEnhancerFormClass);
        ...
        pushButtonGetBack = new QPushButton(PropertyLineEnhancerFormClass);
        pushButtonGetBack->setObjectName("pushButtonGetBack");
        pushButtonGetBack->setGeometry(QRect(180, 120, 39, 23));
        ButtonPickupTest = new QPushButton(PropertyLineEnhancerFormClass);
        ...
        ButtonPickupClearTest = new QPushButton(PropertyLineEnhancerFormClass);
        ...
        ButtonGenerateLibs = new QPushButton(PropertyLineEnhancerFormClass);
        ButtonGenerateLibs->setObjectName("ButtonGenerateLibs");
        ButtonGenerateLibs->setGeometry(QRect(200, 250, 191, 61));
        ...
        pushButtonEditLibrary = new QPushButton(PropertyLineEnhancerFormClass);
        ...
        tableWidgetLibList = new QTableWidget(PropertyLineEnhancerFormClass);
        ...
        label_31 = new QLabel(PropertyLineEnhancerFormClass);
        ...
        tableWidgetGeneratedLibList = new QTableWidget(PropertyLineEnhancerFormClass);
        ...
        frame_2 = new QFrame(PropertyLineEnhancerFormClass);
        ...
        retranslateUi(PropertyLineEnhancerFormClass);

        QMetaObject::connectSlotsByName(PropertyLineEnhancerFormClass);
    } // setupUi

    void retranslateUi(GUIFormBase *PropertyLineEnhancerFormClass)
    {
        PropertyLineEnhancerFormClass->setWindowTitle(QCoreApplication::translate("PropertyLineEnhancerFormClass", "PropertyLineEnhancerForm", nullptr));
        pushButtonEditLibFolder->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "\345\210\206\351\241\236\351\201\270\346\212\236", nullptr));
        labelLibFolderName->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "\357\274\270\357\274\270\357\274\270", nullptr));
        label_30->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "\347\231\273\351\214\262\343\201\225\343\202\214\343\201\246\343\201\204\343\202\213\343\203\251\343\202\244\343\203\226\343\203\251\343\203\252\343\203\252\343\202\271\343\203\210", nullptr));
        pushButtonGetBack->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "<=", nullptr));
        ButtonPickupTest->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "\345\215\230\344\270\200\343\203\251\343\202\244\343\203\226\343\203\251\343\203\252\343\201\247\343\201\256\346\212\275\345\207\272", nullptr));
        ButtonPickupClearTest->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "\346\212\275\345\207\272\343\201\256\343\202\257\343\203\252\343\202\242", nullptr));
        ButtonGenerateLibs->setText(QCoreApplication::translate("PropertyLineEnhancerFormClass", "