...
**
** This file is C:\Regulus64v5\GUI\PanelXYSize\PanelXYSize.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/

#include "PanelXYSize.h"
...
static	const	char	*sName=/**/"XYSize";
...
{
	return(/**/"Panel for setting X-Y size");
}
...
{
	return(new PanelXYSizeForm(Base,parent));
}
...
DEFFUNCEX	int32	DLL_GetPropertyString(void	*Instance ,struct	PropertyClass Data[] ,WORD	maxDataDim)
{
	...
	Data[0].Pointer				 =&((PanelXYSizeForm *)Instance)->LimitMaxX;
	Data[1].Type				 =/**/"int32";
	Data[1].VariableNameWithRoute=/**/"LimitMaxY";
	Data[1].Pointer				 =&((PanelXYSizeForm *)Instance)->LimitMaxY;
	return(2);
}

DEFFUNCEX	QIcon	*DLL_GetIcon(void)
{
	return(new QIcon(QPixmap(/**/":Resources/PanelXYSize.png")));
}
