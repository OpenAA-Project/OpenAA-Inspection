	...
	: QObject(parent)
{
	...
	recNgp = new clsTagAttrRec("NGP");
	recNgi = new clsTagAttrRec("NGI");

	recNgp->arrItm << "X" << "Y" << "MX" << "MY" << "HX" << "HY" << "RS1" << "RS2" << "RAL" << "PG" << "LY";
	recNgp->arrTblCol << "X" << "Y" << "MX" << "MY" << "HX" << "HY" << "RS1" << "RS2" << "RAL" << "PG" << "LY";
	recNgi->arrItm << "X" << "Y" << "W" << "H" << "HX" << "HY" << "IDX" << "Index";
	recNgi->arrTblCol << "X" << "Y" << "W" << "H" << "HX" << "HY" << "IDX" << "IDX2";
}
...
void clsDb::setPrm() {
	...
	setPrm("QIBASE","localhost","D:\\Data\\xmldb2.fdb","sysdba","masterkey");
	//setPrm("QIBASE","localhost","/home/firebird/xmldb.fdb","sysdba","masterkey");
}
