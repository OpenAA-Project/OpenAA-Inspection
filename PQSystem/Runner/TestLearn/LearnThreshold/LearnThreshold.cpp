#include "LearnThreshold.h"
#include "XDLLType.h"
#include "XPQSystemRunnerDLL.h"
#include "LearnThresholdForm.h"

const	char	*sRoot=/**/"TestLearn";
const	char	*sName=/**/"LearnThreshold";
...
{
	return /**/"TestLearn - LearnThreshold";
}
...
{
	return new LearnThresholdForm(Base,sRoot,sName);
}
