...
AlgorithmForReport::AlgorithmForReport(int masterCode ,int machineID,LayersBase *base)
...
AlgorithmForReport::~AlgorithmForReport(void)
{
...
void	AlgorithmForReport::LoadMaster(void)
{
	LoadDataFromMaster(MasterCode);
}

void AlgorithmForReport::run ()
{
	//msleep(3000);
...
static	bool		LoadedImage=true;

bool AlgorithmForReport::LoadDataFromMaster(int masterCode)
{
...
bool AlgorithmForReport::LoadAlgorithmData(void)
{
...
bool AlgorithmForReport::MakeAlgoData(void)
{
	//for(LogicDLL *p=GetLayersBase()->GetLogicDLLBase()->GetFirst();p!=NULL;p=p->GetNext()){
...
void	AlgorithmForReport::GetLibraryOutOfThread(void)
{
	sRet=sALibC->GetLibrary(sLibID ,*RetLib);
	Flag=true;
}

//bool	AlgorithmForReport::SaveEXCEL(const QString &filename)
//{
//	return ReportData.SaveEXCEL(GetLayersBase(),filename);
//}
//
//void	AlgorithmForReport::WriteCell(int Row, int Col ,const QString &Str)
//{
//	wchar_t	Buff[1000];
...
bool	ReportDataStructure::SaveEXCEL(LayersBase *base ,const QString &XLSXFileName)
{
	...
	case 0:	FontName = "�l�r �o�S�V�b�N";	break;
	...
	WriteCell(Row, 1,ReportedTime.toString(Qt::SystemLocaleLongDate));
	...
	WriteCell(Row, 1,RegTime.toString(Qt::SystemLocaleLongDate));
	Row++;
	WriteCell(Row, 0,"LastEdited");
	WriteCell(Row, 1,LastEditedTime.toString(Qt::SystemLocaleLongDate));
	Row++;
	Row++;
