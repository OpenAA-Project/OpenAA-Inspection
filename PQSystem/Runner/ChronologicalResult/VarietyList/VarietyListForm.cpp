#include "VarietyListForm.h"
#include "ui_VarietyListForm.h"
#include "SelectRelationalMasterDataDialog.h"
#include "XGeneralFunc.h"
#include "XDatabaseLoader.h"
#include "SelectAreaForm.h"

VarietyListForm::VarietyListForm(LayersBase *base ,const QString &root ,const QString &name
						 ,QWidget *parent) :
    PQSystemRunner(base ,root ,name,parent)
	,LotForm(base)
    ,ui(new Ui::VarietyListForm)
{
    ui->setupUi(this);
...
VarietyListForm::~VarietyListForm()
{
    delete ui;
}
bool	VarietyListForm::Initial(void)
{
	return true;
}
const QString	VarietyListForm::GetPath(void)
{
	return "検査結果時系列表示/しきい値判定値のばらつき時系列表示";
}
void VarietyListForm::showEvent(QShowEvent *event)
{
	ResultRelationCode	=-1;
	CurrentAlgorithm	=NULL;
	CurrentLibrary		=NULL;
...
void VarietyListForm::on_pushButtonSelectMaster_clicked()
{
...
void VarietyListForm::on_pushButtonSelectArea_clicked()
{
...
void VarietyListForm::on_listWidgetAlgorithm_clicked(const QModelIndex &index)
{
...
void VarietyListForm::on_tableWidgetLibrary_clicked(const QModelIndex &index)
{

}

void VarietyListForm::on_pushButtonStartSearch_clicked()
{

}

void VarietyListForm::on_pushButtonView_clicked()
{

}

void VarietyListForm::on_pushButtonExcel_clicked()
{
