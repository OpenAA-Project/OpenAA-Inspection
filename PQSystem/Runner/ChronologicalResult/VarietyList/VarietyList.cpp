#include "VarietyList.h"
#include "XDLLType.h"
#include "XPQSystemRunnerDLL.h"
#include "VarietyListForm.h"

const	char	*sRoot=/**/"ChronologicalResult";
const	char	*sName=/**/"VarietyList";
...
{
	return /**/"Chronological Result - VarietyList";
}
...
{
	return new VarietyListForm(Base,sRoot,sName);
}
