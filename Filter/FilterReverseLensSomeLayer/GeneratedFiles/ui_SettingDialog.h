...
public:
    ...
    void setupUi(QDialog *SettingDialog)
    {
        ...
        pushButtonOK->setGeometry(QRect(40, 280, 101, 41));
        QIcon icon;
    ...
    {
        SettingDialog->setWindowTitle(QCoreApplication::translate("SettingDialog", "Setting ReverseLens SomeLayer", nullptr));
