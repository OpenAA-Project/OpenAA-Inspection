...
public:
    ...
    void setupUi(QDialog *SettingBandDialog)
    {
        ...
        SettingBandDialog->resize(259, 262);
        pushButtonOK = new QPushButton(SettingBandDialog);
        pushButtonOK->setObjectName("pushButtonOK");
        pushButtonOK->setGeometry(QRect(30, 210, 91, 31));
        ...
        spinBoxX1->setGeometry(QRect(30, 70, 91, 22));
        ...
        spinBoxX2->setGeometry(QRect(140, 70, 91, 22));
        ...
        doubleSpinBoxGain->setGeometry(QRect(30, 120, 91, 22));
        ...
        label_4->setGeometry(QRect(30, 150, 91, 20));
        label_4->setFrameShape(QFrame::Panel);
        label_4->setFrameShadow(QFrame::Sunken);
        label_4->setAlignment(Qt::AlignCenter);
        label_5 = new QLabel(SettingBandDialog);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(30, 10, 50, 20));
        comboBoxLayer = new QComboBox(SettingBandDialog);
        comboBoxLayer->setObjectName("comboBoxLayer");
        comboBoxLayer->setGeometry(QRect(100, 10, 91, 22));
    ...
    void retranslateUi(QDialog *SettingBandDialog)
    {
        ...
        label_5->setText(QCoreApplication::translate("SettingBandDialog", "Layer", nullptr));
    } // retranslateUi
