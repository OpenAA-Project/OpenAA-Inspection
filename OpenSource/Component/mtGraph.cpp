...
void*	mtGraph::SortXY()
{
	...
	uMinX=XValue.at(0);							//X���l�̍ŏ��l���擾
	uMaxX=XValue.at(XValue.count()-1);			//X���l�̍ő��l���擾
	...
	//QList<int>		wXValue;		//�\�[�g�C���f�b�N�X�̑ޔ�
	//QList<double>	wYValue;		//Y���l�̑ޔ�
	//wXValue.clear();
	...
	//wYValue=YValue;
	//for(int i=0;i<YValue.count();i++){
	//	YValue.replace(i,wYValue.at(wXValue.at(i)));		//Y���l�̃\�[�g
	//}
	//
	...
	//uMinX=XValue.at(0);							//X���l�̍ŏ��l���擾
	//uMaxX=XValue.at(XValue.count()-1);			//X���l�̍ő��l���擾
	//uMinY=wYValue.at(0);						//Y���l�̍ŏ��l���擾
	//uMaxY=wYValue.at(wYValue.count()-1);		//Y���l�̍ő��l���擾
	//
	//wYValue.clear();
	Sorted=true;
	return &XValue;
