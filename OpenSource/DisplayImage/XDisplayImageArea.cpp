...
void    DisplayImage::ToFlexArea( struct _ShapeData &SData
                                ,FlexArea &resultarea)
{
    int cx;
    int cy;
...
{
	XYClassArea	*A;
	struct  _ShapeData	&P=*GetRawSDataPoint();
	int	cx,cy,rx,ry;
	int	x1,y1,x,y;
	double	sins,coss;
	double	ds,d,m;
...
VectorLineBase	*DisplayImage::ToVectorLine( struct _ShapeData &SData)
{
