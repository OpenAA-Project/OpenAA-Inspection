...
void    DisplayImage::ToFlexArea( struct mtFrameDraw::_ShapeData &SData
                                ,FlexArea &resultarea)
{
    int cx;
    int cy;
...
void    DisplayImage::ColPointToArea(NPListPack<ShapePoint> &cdata
                                ,FlexArea &resultarea)
{
    XYClassArea area;
    ShapePoint *c;
...
void    DisplayImage::GetPoints(XYClassCluster &XYArea)	const
{
	XYClassArea	*A;
...
void	DisplayImage::GetPointList(DotListContainer &Dots ,double d)	const
{
...
VectorLineBase	*DisplayImage::ToVectorLine( struct mtFrameDraw::_ShapeData &SData)
{
