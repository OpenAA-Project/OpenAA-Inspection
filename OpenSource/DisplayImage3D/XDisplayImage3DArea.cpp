...
void    DisplayImage3DAlgo::ToFlexArea( struct mtFrameDraw::_ShapeData &SData
                                ,FlexArea &resultarea)
{
    int cx;
    int cy;
    ...
    switch(SData.dtype){
		...
		case mtFrameDraw::fdRingArc4:
			//ChangeGxy2Dxy(SData.UData.ERingData.cx-SData.UData.ERingData.rx1,SData.UData.ERingData.cy-SData.UData.ERingData.ry1 ,rx1,ry1);
			//ChangeGxy2Dxy(SData.UData.ERingData.cx+SData.UData.ERingData.rx1,SData.UData.ERingData.cy+SData.UData.ERingData.ry1 ,rx2,ry2);
			rx1=SData.UData.RingArcData.cx-SData.UData.RingArcData.rx1;
			ry1=SData.UData.RingArcData.cy-SData.UData.RingArcData.ry1;
			rx2=SData.UData.RingArcData.cx+SData.UData.RingArcData.rx1;
			ry2=SData.UData.RingArcData.cy+SData.UData.RingArcData.ry1;
			cx=(rx1+rx2)/2;
			cy=(ry1+ry2)/2;
			erx1=(rx2-rx1)/2;
			ery1=(ry2-ry1)/2;
			//ChangeGxy2Dxy(SData.UData.ERingData.cx-SData.UData.ERingData.rx2,SData.UData.ERingData.cy-SData.UData.ERingData.ry2 ,rx1,ry1);
			//ChangeGxy2Dxy(SData.UData.ERingData.cx+SData.UData.ERingData.rx2,SData.UData.ERingData.cy+SData.UData.ERingData.ry2 ,rx2,ry2);
			rx1=SData.UData.RingArcData.cx-SData.UData.RingArcData.rx2;
			ry1=SData.UData.RingArcData.cy-SData.UData.RingArcData.ry2;
			rx2=SData.UData.RingArcData.cx+SData.UData.RingArcData.rx2;
			ry2=SData.UData.RingArcData.cy+SData.UData.RingArcData.ry2;
			erx2=(rx2-rx1)/2;
			ery2=(ry2-ry1)/2;
            BShape.Shape.bsRingArc.Cx=cx;
            BShape.Shape.bsRingArc.Cy=cy;
            BShape.Shape.bsRingArc.Rx1=erx1;
            BShape.Shape.bsRingArc.Ry1=ery1;
            BShape.Shape.bsRingArc.Rx2=erx2;
            BShape.Shape.bsRingArc.Ry2=ery2;
			BShape.Shape.bsRingArc.StartAngle=SData.UData.RingArcData.s1;
			BShape.Shape.bsRingArc.EndAngle	 =SData.UData.RingArcData.s2;
            BShape.Kind=BlockShape::_sRingArc;
			resultarea.SetRingArc(cx,cy,erx1,ery1,erx2,ery2,SData.UData.RingArcData.s1,SData.UData.RingArcData.s2);
            break;
		default:
			break;
		}
...
void    DisplayImage3DAlgo::ColPointToArea(NPListPack<ShapePoint> &cdata
                                ,FlexArea &resultarea)
{
    XYClassArea area;
    ShapePoint *c;
...
void    DisplayImage3DAlgo::GetPoints(XYClassCluster &XYArea)	const
{
	XYClassArea	*A;
	struct  mtFrameDraw::_ShapeData	&P=*GetRawSDataPoint();
	int	cx,cy,rx,ry;
	int	x1,y1,x,y;
	double	sins,coss;
	double	ds,d,m;
...
void	DisplayImage3DAlgo::GetPointList(DotListContainer &Dots ,double d)	const
{
...
VectorLineBase	*DisplayImage3DAlgo::ToVectorLine( struct mtFrameDraw::_ShapeData &SData)
{
