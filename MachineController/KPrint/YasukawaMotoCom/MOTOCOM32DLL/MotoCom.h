...
// For EtherNet Server Connection
...
//2003.08.11
DECSPCEX short APIENTRY BscReadIO2(short nCid,DWORD startadd,WORD ionum,WORD *stat);
...
DECSPCEX short APIENTRY BscHostPutVarDataM(short nCid,short type,short varno,short num,double *dat);	// T.Ariyoshi 

//2008.10.10 Kakisaka 7軸ロボット対応、形態拡張対応 フルセット
...
//2008.10.10 Kakisaka 制御グループ数拡張対応 DX100 and lator 
...
//2008.10.10 Kakisaka 7軸ロボット対応、形態拡張対応 DX100 or later
...
//2008.10.10 Kakisaka 7軸ロボット対応 DX100 or later
...
//2012.09.20 Kakisaka コントローラ種別指定対応
...
//2014.06.10 Onoyama 新コマンド対応
DECSPCEX short APIENTRY BscGetTorque(short nCid,double *p);
DECSPCEX short APIENTRY BscGetMaxTorque(short nCid,double *p);
DECSPCEX short APIENTRY BscGetEncTmp(short nCid,double *p);
DECSPCEX short APIENTRY BscGetSysTime(short nCid,char *contpwr, char *svpwr, char *playback, char *mov, char *ope);
...
DECSPCEX short APIENTRY FcSetDeviceType(short nCid, short Type);//<-----Add S.Ueda<KP2009-008>
