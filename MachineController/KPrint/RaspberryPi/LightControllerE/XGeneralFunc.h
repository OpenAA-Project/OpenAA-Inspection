...
bool	Load(QIODevice *f,char *d,int32 &len ,int32 maxbuffsize);		//Save(QIODevice *file,char *d)�ɑ΂���Load
...
/*	�}�b�`���O���Ȃ����f�[�^�̒l�𓾂�
	...
	form �̌`��
		...
		%hx	%x	%lx	%le
				...
				%U
				%X
		�X�y�[�X �E�E�E �P�ȏ��̃X�y�[�X���^�u�ƃ}�b�`���O����
		�^�u�E�E�E�E�E	�O�ȏ��̃X�y�[�X���^�u�ƃ}�b�`���O����
		�����ȊO�̕���	�啶���������̋��ʂ����ĂP�������}�b�`���O���čs��
