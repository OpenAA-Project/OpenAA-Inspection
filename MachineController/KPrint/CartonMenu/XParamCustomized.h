...
public:
	...
	int		SystemBeltLength;	//�����J���������烊�W�F�N�g�܂ł̋���
...
public:
	...
	int32	TriggerTiming1;	//�g�p���Ȃ�
	int32	TriggerTiming2;	//�g�p���Ȃ�
	int32	DropTiming	  ;	//�g�p���Ȃ�
	int32	TriggerTiming3;	//�g�p���Ȃ�
	int32	TriggerTiming4;	//�g�p���Ȃ�
