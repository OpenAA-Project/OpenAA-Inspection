	...
	: QMainWindow(parent, flags),PipeServer(this)
{
	...
	if(Ret==0){
		for(int Cnt=1;Cnt<=4;Cnt++){
			//��E����E��E��E����E����E�͡�E����E����E����E�̡���￡�5 ��E��CW/CCW:High)2��E����E��E��E����E��E��E��E����E����E��E��E����E��E��
			Ret=SmcWSetPulseType(Id,Cnt,5,0);
			if(Ret!=0)
				return ;

			//��E��E��E��E��E��E��E�͡�M��E��E��E����E��E��E����E�ġ�p��E��E��E��E��ALM,INP,SD,LTC,PCS,CLR��E����E�̡���￡�IN1/ALM)
			Ret=SmcWSetCtrlTypeIn(Id,Cnt,1);
			if(Ret!=0)
				return ;

			//��E��E��E��E��E��E��E����E�͡�M��E��E��E����E��E��E�̡���￡�LIM,IN1)[0|0|0|0|0|OUT3|OUT2|OUT1|LIM|IN7|IN6|IN5|IN4|IN3|IN2|IN1]��E����E�ݡ�￡�E�͡���F0��E��7FF(Hex)
			short inoutlog = 0x81;
			Ret=SmcWSetCtrlInOutLog(Id,Cnt,inoutlog);
			if(Ret!=0)
				return ;

			//��E��E��E����E��E��E����E��E��E��E��E����E����E����E��E��E�̡���￡�
			Ret=SmcWSetOrgMode(Id,Cnt,1,0,2,0);
			if(Ret!=0)
				return ;

			//��E��E��E��E��E�ݡ�￡�E�֡�￡�E�̡�￡�E����E��E��E����E����E����E����E����E����E�ɡ�￡�E��
...
void ContecNC2D::on_pushButtonGoStartPos_clicked()
{
	...
	try{
		...
		if(CurrentPulseX!=-Data.StartPosX){
			Ret=SmcWSetStopPosition(Id,AxisXNum,0,-Data.StartPosX);	//0:��E��E��E�Ρ�￡�
			if(Ret!=0){
				ReEntrant=false;
				return;
			}
		...
		if(CurrentPulseY!=-(Data.MaxPulseY-Data.StartPosY)){
			Ret=SmcWSetStopPosition(Id,AxisYNum,0,-(Data.MaxPulseY-Data.StartPosY));	//0:��E��E��E�Ρ�￡�
			if(Ret!=0){
				ReEntrant=false;
				return;
			}
		...
		//��E����E����E��E��E��E��E����E��E��E��E��E����E����E�̡���￡�
		if(AttrToMoveX==true){
			Ret=SmcWSetReady(Id,AxisXNum,1,0);	//��E��E��E�ԡ�￡�E�� 1:PTP��E��E��E��E��0:��E��E��E��E��E��E��
			if(Ret!=0){
				ReEntrant=false;
				return ;
			}
		...
		if(AttrToMoveY==true){
			Ret=SmcWSetReady(Id,AxisYNum,1,0);	//��E��E��E�ԡ�￡�E�� 1:PTP��E��E��E��E��0:��E��E��E��E��E��E��
			if(Ret!=0){
				ReEntrant=false;
				return ;
			}
...
void ContecNC2D::on_pushButtonStartScan_clicked()
{
	...
	try{
		...
		if((CurrentScan&1)==0){
			...
			if(CurrentPulseX!=AbsPos){
				Ret=SmcWSetStopPosition(Id,AxisXNum,0,AbsPos);	//0:��E��E��E�Ρ�￡�
				if(Ret!=0){
					ReEntrant=false;
					return;
				}
	...
	if(Ret==0 && CurrentPulseX==AbsPos && CurrentScan<Data.ScanCount){
		...
		if(CurrentPulseY!=-(Data.MaxPulseY-(Data.StartPosY+Data.StepPulse*CurrentScan))){
			Ret=SmcWSetStopPosition(Id,AxisYNum,0,-(Data.MaxPulseY-(Data.StartPosY+Data.StepPulse*CurrentScan)));	//0:��E��E��E�Ρ�￡�
			if(Ret!=0){
				ReEntrant=false;
				return;
			}
...
void ContecNC2D::on_pushButtonGoOrigin_clicked()
{
	...
	Ret1=SmcWSetReady(Id,1,3,0);	// ��E��E��E�ԡ�￡�E�� 3:��E��E��E����E��E��E����E��E��E��E��0:��E��E��E��E��E��E��
	Ret2=SmcWSetReady(Id,2,3,0);	// ��E��E��E�ԡ�￡�E�� 3:��E��E��E����E��E��E����E��E��E��E��0:��E��E��E��E��E��E��
	Ret3=SmcWSetReady(Id,3,3,0);	// ��E��E��E�ԡ�￡�E�� 3:��E��E��E����E��E��E����E��E��E��E��0:��E��E��E��E��E��E��
	Ret4=SmcWSetReady(Id,4,3,0);	// ��E��E��E�ԡ�￡�E�� 3:��E��E��E����E��E��E����E��E��E��E��0:��E��E��E��E��E��E��
