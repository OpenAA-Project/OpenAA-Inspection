================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Sample プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Sample には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Sample アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Sample.h
   ...
   CSampleApp アプリケーション クラスを宣言します。

Sample.cpp
   これは、アプリケーション クラス CSampleApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Sample.ico
   ...
   アイコンはメイン リソース ファイル Sample.rc に含まれていま
   す。
...
SampleDlg.h, SampleDlg.cpp - ダイアログ
   これらのファイルは CSampleDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Sample.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Sample.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
