...
Module DASK
    ...
    Declare Function DI_ContMultiBufferSetup Lib "PCI-Dask.dll" (ByVal CardNumber As Short, ByVal Buffer As IntPtr, ByVal ReadCount As Integer, ByRef BufferId As Short) As Short
    ...
    Declare Function DI_ContReadPort Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Short, ByVal Buffer As IntPtr, ByVal ReadCount As Integer, ByVal SampleRate As Double, ByVal SyncMode As Short) As Short
    ...
    Declare Function DO_ContWritePort Lib "PCI-Dask.dll" (ByVal CardNumber As Short, ByVal Port As Integer, ByVal Buffer As IntPtr, ByVal WriteCount As Integer, ByVal Iterations As Integer, ByVal SampleRate As Double, ByVal SyncMode As Short) As Short
    ...
    Declare Function DO_ContMultiBufferSetup Lib "PCI-Dask.dll" (ByVal CardNumber As Short, ByVal Buffer As IntPtr, ByVal WriteCount As Integer, ByRef BufferId As Short) As Short
    ...
    Declare Function GPTC_9524_SetCombineEcdData Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal Enable As Byte) As Short
	...
	'Common Function
	Declare Function PCI_Buffer_Alloc Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal BufferSize As Integer) As IntPtr
	Declare Function PCI_Buffer_Free Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByRef BufferAddr As IntPtr) As Short
