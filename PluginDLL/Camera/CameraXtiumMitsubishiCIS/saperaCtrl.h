...
public:
	/* ----------------------------------------------------------------------------
	 PUIBLIC FUNCTIONS
	---------------------------------------------------------------------------- */
	saperaCtrl(int CamNo ,LayersBase *base ,CameraXtiumMitsubishiCIS *parent ,CameraXtiumBoard *board);
	~saperaCtrl(void);
	...
	bool getImageInside(ImageBuffer *Buff[]);
