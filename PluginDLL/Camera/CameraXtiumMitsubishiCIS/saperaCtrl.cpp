...
/* //////////////////////////////////////////////////////////////////////////////////////////////////////////
 function : saperaCtrl(void)
  ...
  subject : constructor
////////////////////////////////////////////////////////////////////////////////////////////////////////// */
saperaCtrl::saperaCtrl(int CamNo ,LayersBase *base,CameraXtiumMitsubishiCIS *parent,CameraXtiumBoard *board)
	:QThread(base->GetMainWidget()), CameraHandle(CamNo,base) ,Parent(parent),Board(board)
{
	_Acq		= NULL;
	_AcqDevice	= NULL;
	_Buffers	= NULL;
...
QString	saperaCtrl::GetSerialPortName(void)
{
	char	PortName[1024];
	_Acq->GetSerialPortName(PortName);
	return PortName;
}
...
void	saperaCtrl::run()
{
	...
	while(Terminated==false){
		...
		int	MaxYShift=0;	//max(max(Parent->Setting.OffsetYRed,Parent->Setting.OffsetYGreen),Parent->Setting.OffsetYBlue);
		int	MinYShift=0;	//min(min(Parent->Setting.OffsetYRed,Parent->Setting.OffsetYGreen),Parent->Setting.OffsetYBlue);
