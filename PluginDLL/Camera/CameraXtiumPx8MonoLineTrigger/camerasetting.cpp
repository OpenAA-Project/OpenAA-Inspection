...
void CameraSetting::on_pbProof_clicked()
{
	wProofDataFile=QFileDialog::getOpenFileName(
							this,LangSolver.GetString(camerasetting_LS,LID_2)/*"Please choose a '.dat' file."*/
								,LangSolver.GetString(camerasetting_LS,LID_3)/*""*/,LangSolver.GetString(camerasetting_LS,LID_4)/*"ProofDataFile (*.dat)"*/);
	if(wProofDataFile==LangSolver.GetString(camerasetting_LS,LID_5)/*""*/)
		return;
...
{
	wProofDataFile=LangSolver.GetString(camerasetting_LS,LID_6)/*""*/;
	ui.leProofFile->setText(wProofDataFile);
