...
class CameraXtiumPx8MonoLineTrigger;
...
public:
	ImageBuffer		ImageStack[CamStackNumb];
	ImageBuffer		TRImageStack[CamStackNumb];
...
public:
	/* ----------------------------------------------------------------------------
	 PUIBLIC FUNCTIONS
	---------------------------------------------------------------------------- */
	saperaCtrl(int CamNo ,LayersBase *base ,CameraXtiumPx8MonoLineTrigger *parent);
	~saperaCtrl(void);
...
private:
	...
	CameraXtiumPx8MonoLineTrigger	*Parent;
