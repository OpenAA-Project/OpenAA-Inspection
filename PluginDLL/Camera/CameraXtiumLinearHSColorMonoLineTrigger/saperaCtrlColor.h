...
class CameraXtiumLinearHSColor;
class SapAcqCallbackInfo;

class featureCtrl;

const int	CamStackNumb=2;

class saperaCtrlColor : public QThread ,public CameraHandle
{
	/* ----------------------------------------------------------------------------
	 CONST
	---------------------------------------------------------------------------- */
...
public:
	/* ----------------------------------------------------------------------------
	 PUIBLIC FUNCTIONS
	---------------------------------------------------------------------------- */
	saperaCtrlColor(int CamNo ,LayersBase *base ,CameraXtiumLinearHSColor *parent);
	~saperaCtrlColor(void);
...
public:
	...
	CameraXtiumLinearHSColor	*Parent;
