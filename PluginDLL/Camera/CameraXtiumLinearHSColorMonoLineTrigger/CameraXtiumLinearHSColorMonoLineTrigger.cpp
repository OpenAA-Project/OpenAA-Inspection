...
/* --------------------------------------------------------------------------
   static function
   -------------------------------------------------------------------------- */
#define	DEF_CONFIG_DEFAULT_PATH		/**/"T_LinearHS_LineFrameTrigger.ccf"
...
CameraXtiumLinearHSColorMonoLineTrigger::CameraXtiumLinearHSColorMonoLineTrigger(LayersBase *base)
...
CameraXtiumLinearHSColorMonoLineTrigger::~CameraXtiumLinearHSColorMonoLineTrigger()
{
}

void	CameraXtiumLinearHSColorMonoLineTrigger::InitialXTable(void)
{
}
void	CameraXtiumLinearHSColorMonoLineTrigger::AfterPrepare(void)
{
...
void	CameraXtiumLinearHSColorMonoLineTrigger::AfterStartSequence(void)
{
...
void	CameraXtiumLinearHSColorMonoLineTrigger::Calibrate(void)
{
	if(ioLightControlEnable!=NULL){
...
//----------------------------------------------------------
CameraXtiumLinearHS::CameraXtiumLinearHS(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent)
:CameraHandle(CamNo,base),Parent(_Parent)
{
	initialized=false;
}

void CameraXtiumLinearHS::debugOutput(const QString &txt, int deviceID)
{
	static QMutex mutex;
...
bool CameraXtiumLinearHS::debugInit(const QString &DebugFileName ,const QString &ConfigFileName)
{
	static QMutex mutex;
	bool ok = false;
...
CameraXtiumLinearHSColor::CameraXtiumLinearHSColor(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent)
	:CameraXtiumLinearHS(CamNo,base,_Parent),Setting(true)
{
...
CameraXtiumLinearHSColor::~CameraXtiumLinearHSColor()
{
	if (_sapera) {
		delete _sapera;
		_sapera = NULL;
...
void	CameraXtiumLinearHSColor::InitialXTable(void)
{
	if(MatrixRX!=NULL){
		delete	[]MatrixRX;
	}
...
void	CameraXtiumLinearHSColor::CalibrateStart(void)
{
}
void	CameraXtiumLinearHSColor::Calibrate(void)
{

}

bool	CameraXtiumLinearHSColor::Initial(void)
{
...
bool	CameraXtiumLinearHSColor::Load(QIODevice *f)
{
	bool	Ret=false;
...
bool	CameraXtiumLinearHSColor::Save(QIODevice *f)
{
	return Setting.Save(f);
}

void	CameraXtiumLinearHSColor::SetLineCount(int YLen)
{
...
bool	CameraXtiumLinearHSColor::ShowSetting(void)
{
...
bool	CameraXtiumLinearHSColor::SetQuickProperty(CameraQuickProperty Attr, double RelativeValue)
{
	return Setting.SetQuickProperty(_sapera->fc,Attr, RelativeValue);
}

bool	CameraXtiumLinearHSColor::PrepareCapture(void)
{
	return _sapera->prepareCapture();
}
bool	CameraXtiumLinearHSColor::StartCapture(void)
{
	return _sapera->startCapture();
}
bool	CameraXtiumLinearHSColor::SetAutoRepeat(bool RepeatON)
{
	_sapera->RepeatON=RepeatON;
	return true;
}
bool	CameraXtiumLinearHSColor::HaltCapture(void)
{
	return _sapera->stopCapture();
}
int		CameraXtiumLinearHSColor::GetStatus(CameraScanInfo *Info)
{
	int	Ret=_sapera->getStatus();
	return Ret;
}
bool	CameraXtiumLinearHSColor::GetImageTR(	 ImageBuffer *Buff[]
...
void	CameraXtiumLinearHSColor::TransmitDirectly(GUIDirectMessage *packet)
{
...
void	CameraXtiumLinearHSColor::SpecifiedDirectly(SpecifiedBroadcaster *v)
{
...
void	CameraXtiumLinearHSColor::ExecuteInitialAfterEdit	(int ExeID ,LayersBase *base)
{
	InitialXTable();
}
...
CameraXtiumLinearHSMono::CameraXtiumLinearHSMono(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent)
	:CameraXtiumLinearHS(CamNo,base,_Parent),Setting(false)
{
...
CameraXtiumLinearHSMono::~CameraXtiumLinearHSMono()
{
	if (_sapera) {
		delete _sapera;
		_sapera = NULL;
...
void	CameraXtiumLinearHSMono::InitialXTable(void)
{
	if(MatrixRX!=NULL){
		delete	[]MatrixRX;
	}
...
bool	CameraXtiumLinearHSMono::Initial(void)
{
...
void	CameraXtiumLinearHSMono::CalibrateStart(void)
{
}
void	CameraXtiumLinearHSMono::Calibrate(void)
{
	//if(ioLightControlEnable!=NULL){
	//	_sapera->Calibrated=false;
	//	_sapera->SetCalibration();
...
bool	CameraXtiumLinearHSMono::Load(QIODevice *f)
{
	//Setting.LoadFromCam(_sapera->fc);
	//
...
bool	CameraXtiumLinearHSMono::Save(QIODevice *f)
{
	return Setting.Save(f);
}

void	CameraXtiumLinearHSMono::SetLineCount(int YLen)
{
	bool	Ret=_sapera->ChangeLineCount(YLen);
...
bool	CameraXtiumLinearHSMono::ShowSetting(void)
{
...
bool	CameraXtiumLinearHSMono::SetQuickProperty(CameraQuickProperty Attr, double RelativeValue)
{
	return Setting.SetQuickProperty(_sapera->fc,Attr, RelativeValue);
}

bool	CameraXtiumLinearHSMono::PrepareCapture(void)
{
	return _sapera->prepareCapture();
}
bool	CameraXtiumLinearHSMono::StartCapture(void)
{
	return _sapera->startCapture();
}
bool	CameraXtiumLinearHSMono::SetAutoRepeat(bool RepeatON)
{
	//_sapera->RepeatON=RepeatON;
	return true;
}
bool	CameraXtiumLinearHSMono::HaltCapture(void)
{
	return _sapera->stopCapture();
}
int		CameraXtiumLinearHSMono::GetStatus(CameraScanInfo *Info)
{
	int	Ret=_sapera->getStatus();
	return Ret;
}
bool	CameraXtiumLinearHSMono::GetImageTR(	 ImageBuffer *Buff[]
					,ImageBuffer *TRBuff[],int BufferDimCounts
					,CameraScanInfo *Info)
{
...
void	CameraXtiumLinearHSMono::TransmitDirectly(GUIDirectMessage *packet)
{
	CmdGetStockedCount	*CmdGetStockedCountVar=dynamic_cast<CmdGetStockedCount *>(packet);
	if(CmdGetStockedCountVar!=NULL){
		CmdGetStockedCountVar->Count=_sapera->CurrentWTop;
...
void	CameraXtiumLinearHSMono::SpecifiedDirectly(SpecifiedBroadcaster *v)
{
	SpecifiedBroadcasterCalibrateCamera	*CC=dynamic_cast<SpecifiedBroadcasterCalibrateCamera *>(v);
	if(CC!=NULL){
		Calibrate();
...
void	CameraXtiumLinearHSMono::ExecuteInitialAfterEdit	(int ExeID ,LayersBase *base)
{
	InitialXTable();
}
...
//				if proocess fails, return 0
{
	...
	if(first==true){
		GlobalPx=new CameraXtiumLinearHSColorMonoLineTrigger(base);
		first=false;
	}
	if(CameraParameter=="Color"){
