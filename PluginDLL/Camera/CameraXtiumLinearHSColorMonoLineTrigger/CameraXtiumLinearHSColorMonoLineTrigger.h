...
#include "cameraxtiumlinearhscolormonolinetrigger_global.h"
#include <QList>
#include <QRgb>
#include <QDialog>
...
class	CameraXtiumLinearHSColorMonoLineTrigger ;
class	featureCtrl;
...
class CameraXtiumLinearHS :public CameraHandle
{
	bool	initialized;
public:
	CameraXtiumLinearHSColorMonoLineTrigger	*Parent;

	CameraXtiumLinearHS(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent);
...
class CameraXtiumLinearHSColor :public CameraXtiumLinearHS
{
public:
	CameraXtiumLinearHSColor(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent);
	~CameraXtiumLinearHSColor();
...
class CameraXtiumLinearHSMono:public CameraXtiumLinearHS
{
public:
	CameraXtiumLinearHSMono(int CamNo ,LayersBase *base,CameraXtiumLinearHSColorMonoLineTrigger *_Parent);
	~CameraXtiumLinearHSMono();
...
class CameraXtiumLinearHSColorMonoLineTrigger :  public AbstructOriginateClass
...
public:
	...
	CameraXtiumLinearHSColor	CamColor;
	CameraXtiumLinearHSMono		CamMono;

	CameraXtiumLinearHSColorMonoLineTrigger(LayersBase *base);
	~CameraXtiumLinearHSColorMonoLineTrigger();
