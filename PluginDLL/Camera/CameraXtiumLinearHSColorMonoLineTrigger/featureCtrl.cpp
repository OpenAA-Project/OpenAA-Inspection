...
featureCtrl::featureCtrl(char* acqServerName ,int acqDeviceNumber)
	: _acqServerName(NULL)
{
...
bool featureCtrl::setFeatureValue(int featureIndex, INT32 featureValue)
{
	...
	//	r = acqDevice.SetFeatureValue(_pFeatureName[featureIndex], featureValue);
...
bool featureCtrl::setFeatureValue(int featureIndex, bool featureValue)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.SetFeatureValue(_pFeatureName[featureIndex], (BOOL)featureValue);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->SetFeatureValue(_pFeatureName[featureIndex], featureValue);
...
bool featureCtrl::setFeatureValue(int featureIndex, const char *featureString)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.SetFeatureValue(_pFeatureName[featureIndex], featureString);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->SetFeatureValue(_pFeatureName[featureIndex], featureString);
...
bool featureCtrl::setFeatureValue(int featureIndex, SapBuffer* featureBuffer)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.SetFeatureValue(_pFeatureName[featureIndex], featureBuffer);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->SetFeatureValue(_pFeatureName[featureIndex], featureBuffer);
...
bool featureCtrl::setFeatureValue(int featureIndex, SapLut* featureLut)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.SetFeatureValue(_pFeatureName[featureIndex], featureLut);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->SetFeatureValue(_pFeatureName[featureIndex], featureLut);
...
bool featureCtrl::setFeatureValue(const char *featureName, INT32 featureValue)
{
	...
	return acqDevice->SetFeatureValue(featureName, featureValue);
}
...
bool featureCtrl::getFeatureValue(int featureIndex, INT32* featureValue)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.GetFeatureValue(_pFeatureName[featureIndex], featureValue);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->GetFeatureValue(_pFeatureName[featureIndex], featureValue);
...
bool featureCtrl::getFeatureValue(int featureIndex, bool* featureValue)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.GetFeatureValue(_pFeatureName[featureIndex], (BOOL*)featureValue);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->GetFeatureValue(_pFeatureName[featureIndex], (BOOL*)featureValue);
...
bool featureCtrl::getFeatureValue(int featureIndex, char* featureString, int featureStringSize)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.GetFeatureValue(_pFeatureName[featureIndex], featureString, featureStringSize);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->GetFeatureValue(_pFeatureName[featureIndex], featureString, featureStringSize);
...
bool featureCtrl::getFeatureValue(int featureIndex, SapBuffer* featureBuffer)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.GetFeatureValue(_pFeatureName[featureIndex], featureBuffer);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->GetFeatureValue(_pFeatureName[featureIndex], featureBuffer);
...
bool featureCtrl::getFeatureValue(int featureIndex, SapLut* featureLut)
{
	...
	//SapAcqDevice acqDevice(_acqServerName);
	//if ((r = acqDevice.Create())) {
	//	r = acqDevice.GetFeatureValue(_pFeatureName[featureIndex], featureLut);
	//	r2= acqDevice.Destroy();
	//}
	//return (r & r2);
	r = acqDevice->GetFeatureValue(_pFeatureName[featureIndex], featureLut);
...
{
	if (!acqDevice) return false;
	return acqDevice->GetFeatureValue(featureName, featureValue);
}
