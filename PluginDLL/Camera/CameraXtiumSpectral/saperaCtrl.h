...
public:
	ImageBufferListContainer		ImageStack[CamStackNumb];
	ImageBufferListContainer		TRImageStack[CamStackNumb];
...
public:
	/* ----------------------------------------------------------------------------
	 PUIBLIC FUNCTIONS
	---------------------------------------------------------------------------- */
	saperaCtrl(int CamNo ,LayersBase *base ,CameraXtiumSpectral *parent);
	~saperaCtrl(void);
	...
	bool getPartialImageInside(int Index ,ImageBufferListContainer *Buff,ImageBufferListContainer *TRBuff
