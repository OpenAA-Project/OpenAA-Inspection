...
bool    CameraMVSGigE::ReqSystemChange(CameraReqSystemChangeInfo &caminfo)
{
    int     Width ,Height;
...
bool    CameraMVSGigE::GetLine0(void)
{
    return Cam.GetLine0Input();
}


bool	CameraMVSGigE::SetLine1(bool b)
{
...
bool CameraMVSGigE::GetTriggerMode(void)
{
...
bool CameraMVSGigE::SetTriggerMode(bool b)
{
...
bool	CameraMVSGigE::GetIntValue	 (const char* strKey ,int &CurrentValue ,int   &MaxValue ,int   &MinValue)
{
...
bool	CameraMVSGigE::GetEnumValue (const char* strKey ,int &CurrentValue ,int EnumData[64],int &EnumCount)
{
...
bool	CameraMVSGigE::GetEnumSymblic (const char* strKey ,int EnumValue ,QString &Str)
{
...
bool    CameraMVSGigE::SetReverse(void)
{
    int nRet;
