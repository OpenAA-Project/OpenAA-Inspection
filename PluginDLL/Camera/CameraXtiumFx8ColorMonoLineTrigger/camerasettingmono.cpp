...
CameraSettingMono::CameraSettingMono(CameraXtiumFx8Mono *s ,featureCtrl *f ,QWidget *parent)
    : QDialog(parent)
{
	Cam		=s;
	Feature		=f;
	...
	ui.comboBoxTDIMode->setCurrentIndex(Cam->Setting.TDIMode);
...
void CameraSettingMono::on_pbOK_clicked()
{
	...
	Cam->Setting.TDIMode			=ui.comboBoxTDIMode->currentIndex();
