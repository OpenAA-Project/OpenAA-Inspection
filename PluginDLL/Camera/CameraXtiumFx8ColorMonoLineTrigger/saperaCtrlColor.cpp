...
/* //////////////////////////////////////////////////////////////////////////////////////////////////////////
 function : saperaCtrl(void)
  ...
  subject : constructor
////////////////////////////////////////////////////////////////////////////////////////////////////////// */
saperaCtrlColor::saperaCtrlColor(int CamNo ,LayersBase *base,CameraXtiumFx8Color *parent)
...
bool saperaCtrlColor::link(char *pConfigFilename)
{
	...
	if(fc==NULL){
		...
		//double	LineRate=20000;
		//fc->setFeatureValue(featureCtrl::EN_AcquisitionLineRate, LineRate);
		//
		//return false;
	}
...
void	saperaCtrlColor::run()
{
	...
	while(Terminated==false){
		...
		GainGreenL	=Parent->Setting.GainGreenL	;
		GainBlueL	=Parent->Setting.GainBlueL	;
		...
		GainGreenR	=Parent->Setting.GainGreenR	;
		GainBlueR	=Parent->Setting.GainBlueR	;
