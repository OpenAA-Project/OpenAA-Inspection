...
inline	bool	IsNearby(struct PickupFlexAreaStruct &s1 ,struct PickupFlexAreaStruct &s2)
{
...
bool	PickupFlexAreaPartial(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack ,int MaxAreaCount,bool Multithread)
{
...
bool	PickupFlexAreaPartial(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack 
...
bool	PickupFlexAreaA(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack ,int MaxAreaCount,bool Multithread)
{
	if(YLen<40000)
...
bool	PickupFlexAreaB(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack ,int MaxAreaCount,bool Multithread)
{
	const	int	__MaxDimCount=10000;
...
FoundBitEnd:
	...
	for(int	AreaCode=0;;AreaCode++){
		int	h=0;
		int	CurrentY,CurrentTop,CurrentBottom;
...
bool	PickupFlexAreaA(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack 
					,int AreaX1 ,int AreaY1 ,int AreaX2 ,int AreaY2
					,int MaxAreaCount,bool Multithread)
{
	if(YLen<40000)
...
bool	PickupFlexAreaB(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack 
					,int AreaX1 ,int AreaY1 ,int AreaX2 ,int AreaY2
					,int MaxAreaCount,bool Multithread)
{
	const	int	__MaxDimCount=10000;
...
bool	PickupFlexAreaWhole(BYTE **Bmp ,int XByte ,int XLen,int YLen ,PureFlexAreaListContainer &FPack ,int MaxAreaCount,bool Multithread)
{
	return PickupFlexAreaPartial(Bmp ,XByte ,XLen,YLen ,FPack ,MaxAreaCount,Multithread);
}
...
inline	bool	IsNearby(struct PickupFlexAreaStruct_s &s1 ,struct PickupFlexAreaStruct_s &s2)
{
	if((s1.LeftX+s1.Numb)<s2.LeftX){
		return false;
	}
