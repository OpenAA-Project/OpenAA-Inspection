...
/* //////////////////////////////////////////////////////////////////////////////////////////////////////////
 function : saperaCtrl(void)
  ...
  subject : constructor
////////////////////////////////////////////////////////////////////////////////////////////////////////// */
saperaCtrl::saperaCtrl(int CamNo ,LayersBase *base,CameraXtumiPx8LineTrigger *parent)
...
bool saperaCtrl::ControlCamera(void)
{
	bool	Ret;
...
int saperaCtrl::getStatus(void)
{
	...
	int		iStackedNumb=StackedNumb;
	MutexStackImage.unlock();

	if (iStackedNumb>0) return 0;
	return 1;
}
