...
bool saperaCtrl::getImageInside(ImageBuffer *Buff[],ImageBuffer *TRBuff[])
{
	...
	double	GainRedL	=Parent->Setting.GainRedL	;
	double	GainGreenL	=Parent->Setting.GainGreenL	;
	double	GainBlueL	=Parent->Setting.GainBlueL	;
	...
	double	GainRedR	=Parent->Setting.GainRedR	;
	double	GainGreenR	=Parent->Setting.GainGreenR	;
	double	GainBlueR	=Parent->Setting.GainBlueR	;
...
bool saperaCtrl::getPartialImageInsideShrink2(int Index ,ImageBuffer *Buff[],ImageBuffer *TRBuff[]
									,int StartLine , int EndLine)
{
	//int pic = _Buffers->GetBytesPerPixel();
