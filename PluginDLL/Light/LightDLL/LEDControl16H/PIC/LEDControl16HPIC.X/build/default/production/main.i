...
# 830 "./mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 842 "./mcc_generated_files/pin_manager.h"
...
unsigned char FPGA_GetData(void)
{
    ...
    d=((PORTFbits.RF0!=0)?0x01:0)
     +((PORTFbits.RF1!=0)?0x02:0)
     +((PORTFbits.RF2!=0)?0x04:0)
     +((PORTFbits.RF3!=0)?0x08:0)
     +((PORTFbits.RF4!=0)?0x10:0)
     +((PORTFbits.RF5!=0)?0x20:0)
     +((PORTFbits.RF6!=0)?0x40:0)
     +((PORTFbits.RF7!=0)?0x80:0);
...
void FPGA_SetLightMask(void)
{
    ...
    data[0]=((CurrentPatternData.LineData[0].Mask==1)?0x01:0)
           +((CurrentPatternData.LineData[1].Mask==1)?0x02:0)
           +((CurrentPatternData.LineData[2].Mask==1)?0x04:0)
           +((CurrentPatternData.LineData[3].Mask==1)?0x08:0)
           +((CurrentPatternData.LineData[4].Mask==1)?0x10:0)
           +((CurrentPatternData.LineData[5].Mask==1)?0x20:0)
           +((CurrentPatternData.LineData[6].Mask==1)?0x40:0)
           +((CurrentPatternData.LineData[7].Mask==1)?0x80:0);
    data[1]=((CurrentPatternData.LineData[8].Mask==1)?0x01:0)
           +((CurrentPatternData.LineData[9].Mask==1)?0x02:0)
           +((CurrentPatternData.LineData[10].Mask==1)?0x04:0)
           +((CurrentPatternData.LineData[11].Mask==1)?0x08:0)
           +((CurrentPatternData.LineData[12].Mask==1)?0x10:0)
           +((CurrentPatternData.LineData[13].Mask==1)?0x20:0)
           +((CurrentPatternData.LineData[14].Mask==1)?0x40:0)
           +((CurrentPatternData.LineData[15].Mask==1)?0x80:0);
...
void FPGA_SetMode(void)
{
    ...
    data =((RegTestLED==1)?0x08:0)
         +((RegPLSEnable==1)?0x04:0)
         +((RegPulseOutMode==1)?0x02:0);
    FPGA_SetBuff(2,-1,&data ,1);
}

void FPGA_LightON(_Bool ONMode)
{
    unsigned char data;
...
adc_result_t GetADFromLight(int Address,_Bool SelEN)
{
    if(Address>=0){
        if((Address&0x01)!=0)
...
# 320 "main.c"
    for(i=0;i<16;i++){
        ...
        CurrentPatternData.LineData[i].Mask =1;
    }
