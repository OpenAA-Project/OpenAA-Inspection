...
{
	CopyrightString="Copyright(c) MEGATRADE 2013.9";
	return true;
}

DEFFUNCEX	const char	*DLL_GetExplain(void)
{
	return "LightBar USB-ARM8";
}
...
{
	LightUSB8PortARMPanel	*H=new LightUSB8PortARMPanel(base ,LightParamStr);
...
{
	LightUSB8PortARMPanel	*H=(LightUSB8PortARMPanel *)handle;
	if(H!=NULL){
		H->Close();
		delete	H;
	}
