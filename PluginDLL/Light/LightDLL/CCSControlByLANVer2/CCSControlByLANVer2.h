...
#include "ccscontrolbylanver2_global.h"
#include <QIODevice>
#include <QWidget>
#include "XTypeDef.h"
...
class	CCSControlByLANVer2 : public LightDLLBaseClass
{
	QTcpSocket	Sock;
public:
	...
	CCSControlByLANVer2(LayersBase *base,const QString &LightParamStr);
	~CCSControlByLANVer2(void);
