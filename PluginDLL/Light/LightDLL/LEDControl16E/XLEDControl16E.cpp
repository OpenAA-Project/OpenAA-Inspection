...
QString	LEDControl16EPanel::DefFileName=/**/"LEDControl16EDef.dat";

void	LEDControl16EPanel::DefUnit::DefBoard::DefLine::Set(int unitNo ,int boardNo ,int lineNo)
{	
	UnitNo		=unitNo;	
	BoardNo		=boardNo;	
	LineNo		=lineNo;	
...
bool	LEDControl16EPanel::DefUnit::DefBoard::DefLine::Save(QIODevice *f)
{
	int32	Ver=1;
...
bool	LEDControl16EPanel::DefUnit::DefBoard::DefLine::Load(QIODevice *f)
{
	int32	Ver;
...
bool	LEDControl16EPanel::DefUnit::DefBoard::Save(QIODevice *f)
{
...
bool	LEDControl16EPanel::DefUnit::DefBoard::Load(QIODevice *f)
{
...
int		LEDControl16EPanel::DefUnit::DefBoard::GetLineCount(void)
{
	return CountOfLine;
}
		
bool	LEDControl16EPanel::DefUnit::Save(QIODevice *f)
{
...
bool	LEDControl16EPanel::DefUnit::Load(QIODevice *f)
{
...
int		LEDControl16EPanel::DefUnit::GetLineCount(void)
{
	int	N=0;
	for(int i=0;i<CountOfBoard && i<sizeof(DefBoardDim)/sizeof(DefBoardDim[0]);i++){
...
//----------------------------------------------------------------
bool	LEDControl16EPanel::LightPattern::LineValue::Save(QIODevice *f)
{
...
bool	LEDControl16EPanel::LightPattern::LineValue::Load(QIODevice *f,LEDControl16EPanel *panel)
{
	int32	UnitNo;
	int32	BoardNo;
	int32	LineNo;
...
bool	LEDControl16EPanel::LightPattern::Save(QIODevice *f)
{
...
bool	LEDControl16EPanel::LightPattern::Load(QIODevice *f,LEDControl16EPanel *panel)
{
	int32	N;
	if(::Load(f,N)==false)
		return false;
...
void	LEDControl16EPanel::LightPattern::Initial(LEDControl16EPanel *Panel)
{
...
bool	LEDControl16EPanel::PatternData::Save(QIODevice *f)
{
...
bool	LEDControl16EPanel::PatternData::Load(QIODevice *f,LEDControl16EPanel *Panel)
{
...
bool	LEDControl16EPanel::LoadDef(void)
{
...
bool	LEDControl16EPanel::SaveDef(void)
{
	QFile	DefFile(DefFileName);
...
LEDControl16EPanel::LEDControl16EPanel(LayersBase *base ,const QString &LightParamStr)
...
LEDControl16EPanel::~LEDControl16EPanel(void)
{
}



bool	LEDControl16EPanel::Initial(bool OutputMode)
{	
	return true;
}
bool	LEDControl16EPanel::Open(void)
{
...
bool	LEDControl16EPanel::Close(void)
{	
	return true;
}

void	LEDControl16EPanel::GetVersion(void)
{
...
void	LEDControl16EPanel::Transfer(int PatternNumber,QProgressBar *Bar)
{
	static	bool	ReEntrant=false;
...
void	LEDControl16EPanel::TransmitDirectly(GUIDirectMessage *packet)
{

}

int		LEDControl16EPanel::GetLineCount(void)
{
	int	N=0;
...
bool	LEDControl16EPanel::SaveDef(QIODevice *f)
{
	int32	Ver=1;
	if(::Save(f,Ver)==false)
		return false;
...
bool	LEDControl16EPanel::LoadDef(QIODevice *f)
{
	int32	Ver;
	if(::Load(f,Ver)==false)
		return false;
...
bool	LEDControl16EPanel::Save(QIODevice *f)
{
	int32	Ver=1;
	if(::Save(f,Ver)==false)
		return false;
...
bool	LEDControl16EPanel::Load(QIODevice *f)
{
	int32	Ver;
	if(::Load(f,Ver)==false)
		return false;
...
bool	LEDControl16EPanel::SetOnOff(bool OnMode)
{
	static	bool	ReEntrant=false;
...
/*	
bool	LEDControl16EPanel::GetPatternOnOff		(int UnitNumber ,int BoardNumber)					//Into DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16EPanel::SetPatternOnOff		(int UnitNumber ,int BoardNumber)					//From DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16EPanel::ShowSettingDialog(void)
{
	LightForm=new LEDControl16EDialog(this);
	...
	//Don't call directly
bool	LEDControl16EPanel::InitialPhysical(const QString &Param)
{
	Initial(true);
	return true;
}

bool	LEDControl16EPanel::ReflectPhysical(void)
{
	if(LightForm!=NULL){
...
bool	LEDControl16EPanel::ReflectPhysicalTurnOn(bool LightOn)
{
	SetOnOff(LightOn);
	return true;
}
...
void	LEDControl16EPanel::SlotTimeOut()
{
}
...
void    LEDControl16EPanel::SlotReadyRead()
{
   unsigned char   Cmd;
