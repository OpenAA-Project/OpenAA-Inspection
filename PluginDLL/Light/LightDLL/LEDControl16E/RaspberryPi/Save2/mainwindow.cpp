...
void MainWindow::on_pushButtonReceiveEIO_clicked()
{
    ...
    ui->lineEditInData			->setText(QString::number(EIOData.InExt,16));
    ui->lineEditTimeUpLatchA	->setText(QString::number(((double)EIOData.TimeUpLatchA)*0.25,'f',1));
    ui->lineEditResultTimeLatchA->setText(QString::number(((double)EIOData.ResultTimeLatchA)*0.25,'f',1));
    ui->lineEditTimeUpLatchB	->setText(QString::number(((double)EIOData.TimeUpLatchB)*0.25,'f',1));
    ui->lineEditResultTimeLatchB->setText(QString::number(((double)EIOData.ResultTimeLatchB)*0.25,'f',1));
    /*
...
{
	EIOData.Conveyer1Pulse		=ui->spinBoxConveyer1Pulse		->value();
...
void	MainWindow::ShowEIO(void)
{
	ui->spinBoxMulInput             ->setValue(EIOData.MulInput);
	ui->spinBoxConveyer1Pulse		->setValue(EIOData.Conveyer1Pulse);
...
void MainWindow::on_toolButtonFlapTopOK_clicked()
{
    if(ui->toolButtonFlapTopOK->isChecked()==true)
        EIOData.OutExt |= 0x08;
    else
        EIOData.OutExt &= ~0x08;
...
void MainWindow::on_toolButtonFlapTopNG_clicked()
{
    if(ui->toolButtonFlapTopNG->isChecked()==true)
        EIOData.OutExt |= 0x10;
    else
        EIOData.OutExt &= ~0x10;
...
void MainWindow::on_toolButtonFlapBottomOK_clicked()
{
    if(ui->toolButtonFlapBottomOK->isChecked()==true)
        EIOData.OutExt |= 0x20;
    else
        EIOData.OutExt &= ~0x20;
...
void MainWindow::on_toolButtonFlapBottomNG_clicked()
{
    if(ui->toolButtonFlapBottomNG->isChecked()==true)
        EIOData.OutExt |= 0x40;
    else
        EIOData.OutExt &= ~0x40;
...
void MainWindow::on_toolButtonFlapSwordOK_clicked()
{
    if(ui->toolButtonFlapSwordOK->isChecked()==true)
        EIOData.OutExt |= 0x80;
    else
        EIOData.OutExt &= ~0x80;
...
void MainWindow::on_toolButtonFlapSwordNG_clicked()
{
    if(ui->toolButtonFlapSwordNG->isChecked()==true)
        EIOData.OutExt |= 0x01;
    else
        EIOData.OutExt &= ~0x01;
