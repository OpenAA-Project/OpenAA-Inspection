#ifndef LEDCONTROL16A_H
#define LEDCONTROL16A_H

#include "ledcontrol16a_global.h"
...
class	LEDControl16APanel : public LightDLLBaseClass
{
	Q_OBJECT
...
public:
	...
	LEDControl16APanel(LayersBase *base ,const QString &LightParamStr);
	~LEDControl16APanel(void);
