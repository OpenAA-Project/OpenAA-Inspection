#ifndef LEDControl16JDIALOG_H
#define LEDControl16JDIALOG_H
...
public:
	...
	LineGroup(LEDControl16JDialog *p ,QWidget *parent);
	~LineGroup(void);
	void	Initial(int n);
...
class LEDControl16JDialog : public QDialog
{
    Q_OBJECT
...
public:
    explicit LEDControl16JDialog(LEDControl16JioPanel *p,QWidget *parent = 0);
    ~LEDControl16JDialog();
