...
class TimingChartForm : public QWidget
{
    ...
    volatile    bool    SamplingMode;
public:
    QWidget				*WidgetSignal;
	QWidget				*WidgetTitle ;
    SignalScale         *Scale;
	TimingSignalPort	*TimingSignal[50];
    LEDControl16JioPrnRasPIMain	*Panel;
	int					SignalCount;
...
public:
    explicit TimingChartForm(LEDControl16JioPrnRasPIMain *p,QWidget *parent = 0);
    ~TimingChartForm();
...
private slots:
    ...
    void on_toolButtonSampling_clicked();
