...
{
	LEDControl16P16Panel	*H=new LEDControl16P16Panel(base ,LightParamStr);
...
{
	LEDControl16P16Panel	*H=(LEDControl16P16Panel *)handle;
	if(H!=NULL){
		H->Close();
		delete	H;
	}
...
//	In one case, this fuction is called from Sequence.dat
{
	LEDControl16P16Panel	*p=static_cast<LEDControl16P16Panel *>(handle);
	if(p!=NULL){
