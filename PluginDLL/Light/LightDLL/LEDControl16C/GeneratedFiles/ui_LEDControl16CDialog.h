/********************************************************************************
** Form generated from reading UI file 'LEDControl16CDialog.ui'
**
...
#ifndef UI_LEDCONTROL16CDIALOG_H
#define UI_LEDCONTROL16CDIALOG_H
...
public:
    ...
    void setupUi(QDialog *LEDControl16CDialog)
    {
        if (LEDControl16CDialog->objectName().isEmpty())
            LEDControl16CDialog->setObjectName("LEDControl16CDialog");
        LEDControl16CDialog->resize(651, 753);
        frame_3 = new QFrame(LEDControl16CDialog);
        ...
        spinBoxBrightness->setMaximum(65535);
        ...
        pushButtonShowAD->setGeometry(QRect(10, 440, 181, 28));
        ...
        frame = new QFrame(LEDControl16CDialog);
        ...
        lineEditVersion = new QLineEdit(LEDControl16CDialog);
        lineEditVersion->setObjectName("lineEditVersion");
        lineEditVersion->setGeometry(QRect(10, 10, 631, 21));
        pushButtonOK = new QPushButton(LEDControl16CDialog);
        pushButtonOK->setObjectName("pushButtonOK");
        pushButtonOK->setGeometry(QRect(270, 700, 101, 41));
        stackedWidgetSetting = new QStackedWidget(LEDControl16CDialog);
        ...
        retranslateUi(LEDControl16CDialog);

        stackedWidgetSetting->setCurrentIndex(15);


        QMetaObject::connectSlotsByName(LEDControl16CDialog);
    } // setupUi

    void retranslateUi(QDialog *LEDControl16CDialog)
    {
        LEDControl16CDialog->setWindowTitle(QCoreApplication::translate("LEDControl16CDialog", "Dialog", nullptr));
        pushButtonTransfer->setText(QCoreApplication::translate("LEDControl16CDialog", "Transfer", nullptr));
        label_2->setText(QCoreApplication::translate("LEDControl16CDialog", "Value", nullptr));
        pushButtonSetAll->setText(QCoreApplication::translate("LEDControl16CDialog", "Set all", nullptr));
        toolButtonON->setText(QCoreApplication::translate("LEDControl16CDialog", "ON", nullptr));
        pushButtonShowIO->setText(QCoreApplication::translate("LEDControl16CDialog", "Show  I/O", nullptr));
        pushButtonDefinition->setText(QCoreApplication::translate("LEDControl16CDialog", "Set definition", nullptr));
        pushButtonShowAD->setText(QCoreApplication::translate("LEDControl16CDialog", "Show A/D", nullptr));
        pushButtonShowSpecial->setText(QCoreApplication::translate("LEDControl16CDialog", "Show Special", nullptr));
        pushButtonIODeliverer->setText(QCoreApplication::translate("LEDControl16CDialog", "Test signal for IODeliverer", nullptr));
        toolButtonRed->setText(QCoreApplication::translate("LEDControl16CDialog", "Red", nullptr));
        pushButtonOK->setText(QCoreApplication::translate("LEDControl16CDialog", "OK", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LEDControl16CDialog: public Ui_LEDControl16CDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LEDCONTROL16CDIALOG_H
