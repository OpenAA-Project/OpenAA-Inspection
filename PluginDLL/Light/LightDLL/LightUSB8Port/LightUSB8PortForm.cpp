...
#include "ui_LightUSB8PortForm.h"


LightUSB8PortForm::LightUSB8PortForm(LightControlFromUSB *iLight ,QWidget *parent) :
    QDialog(parent),
    ui(new Ui::LightUSB8PortForm)
{
    ui->setupUi(this);
...
LightUSB8PortForm::~LightUSB8PortForm()
{
    delete ui;
	//delete	BLight;
	//BLight=NULL;
}
void	LightUSB8PortForm::resizeEvent ( QResizeEvent * event )
{
	ui->frame->move(width()-ui->frame->width(),0);
}

void	LightUSB8PortForm::showEvent(QShowEvent *)
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tbTopLeft_clicked()
{
	int	CountOff=0;
	for(int i=0;i<4;i++){
		for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tbTopRight_clicked()
{
	int	CountOff=0;
	for(int i=0;i<4;i++){
		for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_1_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_2_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_3_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_4_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_5_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_6_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_7_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tb_8_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightUSB8PortForm::on_tbLeft_0_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_1_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_2_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_3_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_4_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_5_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_6_clicked()
{	
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_7_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_8_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_9_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_10_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_11_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_12_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_13_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_14_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbLeft_15_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_0_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_1_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_2_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_3_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_4_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_5_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_6_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_7_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_8_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_9_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_10_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_11_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_12_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_13_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_14_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_tbRight_15_clicked()
{
	for(int i=0;i<4;i++){
...
void LightUSB8PortForm::on_pbOK_clicked()
{
...
void LightUSB8PortForm::on_pbCancel_clicked()
{
	reject();
}

void LightUSB8PortForm::on_pbAllSelect_clicked()
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(true);
...
void LightUSB8PortForm::on_pbClearSelect_clicked()
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(false);
...
void LightUSB8PortForm::on_pbTransport_clicked()
{
...
void LightUSB8PortForm::on_tbOnOff_clicked()
{
...
void LightUSB8PortForm::on_vsBrightness_valueChanged(int value)
{
	int	n=ui->vsBrightness->value();
	ui->sbBrightness->setValue(n);
}

void LightUSB8PortForm::on_sbBrightness_valueChanged(int arg1)
{
