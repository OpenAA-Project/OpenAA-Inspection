...
#include "ui_ControlLightFForm.h"
#include <wiringPi.h>
...
SocketClient::SocketClient(ControlLightFForm *parent ,QTcpSocket *s)
{
    Parent=parent;
    Socket=s;
...
//-------------------------------------------------------------------
ControlLightFForm::ControlLightFForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ControlLightFForm),Server(NULL)
{
    ui->setupUi(this);
...
ControlLightFForm::~ControlLightFForm()
{
    delete ui;
    delete  Server;
    Server=NULL;
...
void ControlLightFForm::on_comboBoxBoard_currentIndexChanged(int index)
{
    ShowCurrentData();
}

void ControlLightFForm::on_spinBoxPattern_valueChanged(int arg1)
{
    ShowCurrentData();
}

void    ControlLightFForm::SlotNewConnection()
{
    if(Server!=NULL){
...
void    ControlLightFForm::DisconnectClient(SocketClient *s)
{
    //AccessMutex.lock();
...
void    ControlLightFForm::ReceiveData(struct  LightPacketData &data)
{
...
void ControlLightFForm::WriteEForBit(int DipSW ,int Brd)
{
    int	Data[10];
...
int ControlLightFForm::ReadEForBit(int DipSW ,int Brd)	//Return Motor counter
{
    int	Data[7];
...
void ControlLightFForm::WriteELightData(int DipSW ,int brd ,int PatternNoW)
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
void ControlLightFForm::WriteEOnOffData(int DipSW ,int brd ,int PatternNoW)    //Execute after WriteEForBit
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
bool ControlLightFForm::ReadELightData(int DipSW ,int brd ,int PatternNo)
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
int ControlLightFForm::ReadBoardID(int DipSW)
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
void ControlLightFForm::WriteRegister(int DipSW ,int Data[] ,int DataLen)
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
void ControlLightFForm::WriteRegister(int Data)
{
...
void ControlLightFForm::ReadRegister4Bit(int DipSW ,int Data[] ,int DataLen)
{
    digitalWrite(13 , ((DipSW&0x01)!=0)?1:0);
    digitalWrite(14 , ((DipSW&0x02)!=0)?1:0);
    digitalWrite(16 , ((DipSW&0x04)!=0)?1:0);
...
void ControlLightFForm::ReadRegister4Bit(int &Data)
{
    delay(1);
    digitalWrite(12, 1);
    delay(1);
...
void ControlLightFForm::DummyClock(void)
{
    delay(1);
    digitalWrite(12, 1);
    delay(1);
...
void	ControlLightFForm::AllON(bool ON)
{
    for(int Brd=0;Brd<BoardCount;Brd++){
        int	DipSW=GetDipSW_InE(Brd);
...
int ControlLightFForm::GetDipSW_InE(int boardnumber)
{
    return DipSWTable[boardnumber];
}

void ControlLightFForm::ShowCurrentData(void)
{
