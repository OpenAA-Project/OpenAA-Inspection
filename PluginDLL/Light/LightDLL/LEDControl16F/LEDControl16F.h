#ifndef LEDCONTROL16F_H
#define LEDCONTROL16F_H

#include "ledcontrol16f_global.h"
#include <QIODevice>
#include <QWidget>
#include "XTypeDef.h"
...
class	LEDControl16FPanel : public LightDLLBaseClass
{
	Q_OBJECT
...
public:
	...
	public:
		...
		public:
			...
			bool	Save(QIODevice *f);
			bool	Load(QIODevice *f,LEDControl16FPanel *panel);
		...
		void	Initial(LEDControl16FPanel *panel);
		bool	Save(QIODevice *f);
		bool	Load(QIODevice *f,LEDControl16FPanel *panel);
	};
	...
	LEDControl16FPanel(LayersBase *base ,const QString &LightParamStr);
	~LEDControl16FPanel(void);
