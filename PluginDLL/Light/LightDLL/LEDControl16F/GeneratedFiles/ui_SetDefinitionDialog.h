...
public:
    ...
    void setupUi(QDialog *SetDefinitionDialog)
    {
        ...
        pushButtonSetCount->setGeometry(QRect(270, 50, 112, 34));
        toolButtonTestLED = new QToolButton(SetDefinitionDialog);
        toolButtonTestLED->setObjectName("toolButtonTestLED");
        toolButtonTestLED->setGeometry(QRect(560, 50, 131, 31));
    ...
    void retranslateUi(QDialog *SetDefinitionDialog)
    {
        ...
        pushButtonSetCount->setText(QCoreApplication::translate("SetDefinitionDialog", "Set count", nullptr));
        toolButtonTestLED->setText(QCoreApplication::translate("SetDefinitionDialog", "Lamp on board", nullptr));
    } // retranslateUi
