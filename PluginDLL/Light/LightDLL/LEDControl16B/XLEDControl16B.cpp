...
#include "LEDControl16BDialog.h"
#include "XDataInLayer.h"
#include "XGUIFormBase.h"

QString	LEDControl16BPanel::DefFileName=/**/"LEDControl16BDef.dat";

void	LEDControl16BPanel::DefUnit::DefBoard::DefLine::Set(int unitNo ,int boardNo ,int lineNo)
{	
	UnitNo		=unitNo;	
	BoardNo		=boardNo;	
	LineNo		=lineNo;	
...
bool	LEDControl16BPanel::DefUnit::DefBoard::DefLine::Save(QIODevice *f)
{
	int32	Ver=1;
...
bool	LEDControl16BPanel::DefUnit::DefBoard::DefLine::Load(QIODevice *f)
{
	int32	Ver;
...
bool	LEDControl16BPanel::DefUnit::DefBoard::Save(QIODevice *f)
{
...
bool	LEDControl16BPanel::DefUnit::DefBoard::Load(QIODevice *f)
{
...
int		LEDControl16BPanel::DefUnit::DefBoard::GetLineCount(void)
{
	return CountOfLine;
}
		
bool	LEDControl16BPanel::DefUnit::Save(QIODevice *f)
{
...
bool	LEDControl16BPanel::DefUnit::Load(QIODevice *f)
{
...
int		LEDControl16BPanel::DefUnit::GetLineCount(void)
{
	int	N=0;
	for(int i=0;i<CountOfBoard && i<sizeof(DefBoardDim)/sizeof(DefBoardDim[0]);i++){
...
//----------------------------------------------------------------
bool	LEDControl16BPanel::LightPattern::LineValue::Save(QIODevice *f)
{
...
bool	LEDControl16BPanel::LightPattern::LineValue::Load(QIODevice *f,LEDControl16BPanel *panel)
{
	int32	UnitNo;
	int32	BoardNo;
	int32	LineNo;
...
bool	LEDControl16BPanel::LightPattern::Save(QIODevice *f)
{
...
bool	LEDControl16BPanel::LightPattern::Load(QIODevice *f,LEDControl16BPanel *panel)
{
	int32	N;
	if(::Load(f,N)==false)
		return false;
...
void	LEDControl16BPanel::LightPattern::Initial(LEDControl16BPanel *Panel)
{
...
bool	LEDControl16BPanel::PatternData::Save(QIODevice *f)
{
...
bool	LEDControl16BPanel::PatternData::Load(QIODevice *f,LEDControl16BPanel *Panel)
{
...
bool	LEDControl16BPanel::LoadDef(void)
{
...
bool	LEDControl16BPanel::SaveDef(void)
{
	QFile	DefFile(DefFileName);
...
LEDControl16BPanel::LEDControl16BPanel(LayersBase *base ,const QString &LightParamStr)
...
LEDControl16BPanel::~LEDControl16BPanel(void)
{
	delete	Commander;
	Commander=NULL;
}
...
void	LEDControl16BPanel::InitialEPRom(void)
{
...
void	LEDControl16BPanel::BuildDataFromEPRom(void)
{

}

bool	LEDControl16BPanel::Initial(bool OutputMode)
{	
	return true;
}
bool	LEDControl16BPanel::Open(void)
{
	if(Commander->OpenHid(0x1255, 0x000B,Number)==false){
		return false;
	}
	return true;
}
bool	LEDControl16BPanel::Close(void)
{	
	return true;
}

void	LEDControl16BPanel::GetVersion(void)
{
...
void	LEDControl16BPanel::Transfer(int PatternNumber,QProgressBar *Bar)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::GetRegisterData(int BoardNumber ,int datatype ,int adr ,int &RegData)
{
	static	bool	ReEntrant=false;
...
void	LEDControl16BPanel::TransmitDirectly(GUIDirectMessage *packet)
{
...
int		LEDControl16BPanel::GetLineCount(void)
{
	int	N=0;
...
bool	LEDControl16BPanel::SaveDef(QIODevice *f)
{
	int32	Ver=2;
	if(::Save(f,Ver)==false)
		return false;
...
bool	LEDControl16BPanel::LoadDef(QIODevice *f)
{
	int32	Ver;
	if(::Load(f,Ver)==false)
		return false;
...
bool	LEDControl16BPanel::Save(QIODevice *f)
{
	int32	Ver=1;
	if(::Save(f,Ver)==false)
		return false;
...
bool	LEDControl16BPanel::Load(QIODevice *f)
{
	int32	Ver;
	if(::Load(f,Ver)==false)
		return false;
...
bool	LEDControl16BPanel::SetOnOff(bool OnMode)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetTemporaryON(int32 ContinuousCount)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::LoadADData(int BoardNumber)
{
	static	bool	ReEntrant=false;

	BYTE RegData[10];
	GetADRegisterData(BoardNumber ,RegData);
	...
	if(Commander->IsOpened()==true){
		...
		for(int i=0;i<10;i++){
			...
			if(RecData[0]==0x0a){
				for(int k=0;k<16;k++){
					BoardData[BoardNumber].ADData[k]=RecData[1+2*k]+(RecData[2+2*k]<<8);
				}
				break;
			}
		}
...
bool	LEDControl16BPanel::GetADRegisterData(int BoardNumber ,BYTE RegData[10])
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::LoadAD_Register(int BoardNumber ,int adr ,int &RegData)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::LoadInputData(int BoardNumber)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetTestLED(bool ONMode)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::ReadEPRom(int BoardNumber ,int PortNumber ,struct LightUnit &Data)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::WriteEPRom(int BoardNumber ,int PortNumber ,struct LightUnit &Data)
{
	static	bool	ReEntrant=false;
...
int		LEDControl16BPanel::ReadEPRomStatus(int BoardNumber ,int PortNumber)
{
	static	bool	ReEntrant=false;
	int	Ret=0;
...
bool	LEDControl16BPanel::GetPatternComparator(int UnitNumber ,int BoardNumber,int LineNumber)	//Into DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetPatternComparator(int UnitNumber ,int BoardNumber ,int LineNumber)	//From DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::GetPatternOnOff		(int UnitNumber ,int BoardNumber)					//Into DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetPatternOnOff		(int UnitNumber ,int BoardNumber)					//From DefBuffer
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetEnableRangeOffset(int UnitNumber ,int AddedOffset)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetMotorCounter(int UnitNumber ,int BoardNumber ,int N)
{
	static	bool	ReEntrant=false;
...
int		LEDControl16BPanel::GetMotorCounter(int UnitNumber ,int BoardNumber)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetRelay(bool ON)
{
	static	bool	ReEntrant=false;
...
int		LEDControl16BPanel::GetCameraResolution(void)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::SetCameraResolution(int n)
{
	static	bool	ReEntrant=false;
...
bool	LEDControl16BPanel::ShowSettingDialog(void)
{
	LightForm=new LEDControl16BDialog(this);
	...
	//Don't call directly
bool	LEDControl16BPanel::InitialPhysical(const QString &Param)
{
	Initial(true);
	return true;
}

bool	LEDControl16BPanel::ReflectPhysical(void)
{
	if(LightForm!=NULL){
...
bool	LEDControl16BPanel::ReflectPhysicalTurnOn(bool LightOn)
{
	SetOnOff(LightOn);
	return true;
}

int		LEDControl16BPanel::ReqVolume(void)
{
	static	bool	ReEntrant=false;
...
void	LEDControl16BPanel::SetManual(bool ON)
{
	static	bool	ReEntrant=false;
...
void	LEDControl16BPanel::SlotTimeOut()
{
}
