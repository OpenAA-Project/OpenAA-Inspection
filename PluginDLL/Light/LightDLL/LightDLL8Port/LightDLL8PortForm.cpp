...
LightDLL8PortForm::LightDLL8PortForm(LightDLL1	*p,QWidget *parent)
...
void	LightDLL8PortForm::showEvent(QShowEvent *)
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
	...
	ui.le_3->setText(BLight.BarComment[2]);
	ui.le_4->setText(BLight.BarComment[3]);
	ui.le_5->setText(BLight.BarComment[4]);
	ui.le_6->setText(BLight.BarComment[5]);
	ui.le_7->setText(BLight.BarComment[6]);
	ui.le_8->setText(BLight.BarComment[7]);
}

LightDLL8PortForm::~LightDLL8PortForm()
{

}


void LightDLL8PortForm::on_tbTopLeft_clicked()
{
	int	CountOff=0;
	for(int i=0;i<4;i++){
		for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tbTopRight_clicked()
{
	int	CountOff=0;
	for(int i=0;i<4;i++){
		for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_1_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_2_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_3_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_4_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_5_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_6_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_7_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tb_8_clicked()
{
	int	CountOff=0;
	for(int j=0;j<64;j++){
...
void LightDLL8PortForm::on_tbLeft_0_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_1_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_2_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_3_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_4_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_5_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_6_clicked()
{	
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_7_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_8_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_9_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_10_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_11_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_12_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_13_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_14_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbLeft_15_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_0_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_1_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_2_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_3_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_4_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_5_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_6_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_7_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_8_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_9_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_10_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_11_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_12_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_13_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_14_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_tbRight_15_clicked()
{
	for(int i=0;i<4;i++){
...
void LightDLL8PortForm::on_vsBrightness_valueChanged(int)
{
	int	n=ui.vsBrightness->value();
	ui.sbBrightness->setValue(n);
}

void LightDLL8PortForm::on_pbTransport_clicked()
{
...
void LightDLL8PortForm::on_sbBrightness_valueChanged(int)
{
...
void LightDLL8PortForm::on_tbOnOff_clicked()
{
...
void LightDLL8PortForm::on_pbAllSelect_clicked()
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(true);
...
void LightDLL8PortForm::on_pbClearSelect_clicked()
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(false);
...
void LightDLL8PortForm::on_pbOK_clicked()
{
	for(int i=0;i<8;i++){
		for(int j=0;j<64;j++){
	...
	BLight.BarComment[2]=ui.le_3->text();
	BLight.BarComment[3]=ui.le_4->text();
	BLight.BarComment[4]=ui.le_5->text();
	BLight.BarComment[5]=ui.le_6->text();
	BLight.BarComment[6]=ui.le_7->text();
	BLight.BarComment[7]=ui.le_8->text();

	accept();
}

void LightDLL8PortForm::on_pbCancel_clicked()
{
	reject();
}
