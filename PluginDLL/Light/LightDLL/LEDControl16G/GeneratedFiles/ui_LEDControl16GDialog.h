/********************************************************************************
** Form generated from reading UI file 'LEDControl16GDialog.ui'
**
...
#ifndef UI_LEDCONTROL16GDIALOG_H
#define UI_LEDCONTROL16GDIALOG_H
...
public:
    ...
    void setupUi(QDialog *LEDControl16GDialog)
    {
        if (LEDControl16GDialog->objectName().isEmpty())
            LEDControl16GDialog->setObjectName(QString::fromUtf8("LEDControl16GDialog"));
        LEDControl16GDialog->resize(654, 756);
        stackedWidgetSetting = new QStackedWidget(LEDControl16GDialog);
        ...
        pushButtonOK = new QPushButton(LEDControl16GDialog);
        pushButtonOK->setObjectName(QString::fromUtf8("pushButtonOK"));
        pushButtonOK->setGeometry(QRect(270, 700, 101, 41));
        frame = new QFrame(LEDControl16GDialog);
        ...
        retranslateUi(LEDControl16GDialog);

        stackedWidgetSetting->setCurrentIndex(15);


        QMetaObject::connectSlotsByName(LEDControl16GDialog);
    } // setupUi

    void retranslateUi(QDialog *LEDControl16GDialog)
    {
        LEDControl16GDialog->setWindowTitle(QCoreApplication::translate("LEDControl16GDialog", "Dialog", nullptr));
        pushButtonTransfer->setText(QCoreApplication::translate("LEDControl16GDialog", "Transfer", nullptr));
        label_2->setText(QCoreApplication::translate("LEDControl16GDialog", "Value", nullptr));
        pushButtonSetAll->setText(QCoreApplication::translate("LEDControl16GDialog", "Set all", nullptr));
        toolButtonON->setText(QCoreApplication::translate("LEDControl16GDialog", "ON", nullptr));
        pushButtonShowIO->setText(QCoreApplication::translate("LEDControl16GDialog", "Show  I/O", nullptr));
        pushButtonDefinition->setText(QCoreApplication::translate("LEDControl16GDialog", "Set definition", nullptr));
        pushButtonSetTestLED->setText(QCoreApplication::translate("LEDControl16GDialog", "TestLED", nullptr));
        pushButtonOK->setText(QCoreApplication::translate("LEDControl16GDialog", "OK", nullptr));
        toolButtonRed->setText(QCoreApplication::translate("LEDControl16GDialog", "Red", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LEDControl16GDialog: public Ui_LEDControl16GDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LEDCONTROL16GDIALOG_H
