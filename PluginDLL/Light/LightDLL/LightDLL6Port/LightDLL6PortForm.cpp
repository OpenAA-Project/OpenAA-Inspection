...
LightDLL6PortForm::LightDLL6PortForm(LightDLL1	*p,QWidget *parent)
...
void	LightDLL6PortForm::showEvent(QShowEvent *)
{
	for(int i=0;i<6;i++){
		for(int j=0;j<64;j++){
...
LightDLL6PortForm::~LightDLL6PortForm()
{

}


void LightDLL6PortForm::on_tbTopLeft_clicked()
{
	for(int i=0;i<3;i++){
		for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tbTopRight_clicked()
{
	for(int i=0;i<3;i++){
		for(int j=0;j<64;j++){
			ChkList[i+3][j]	->setChecked(true);
		}
	}
}

void LightDLL6PortForm::on_tb_1_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tb_2_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tb_3_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tb_4_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tb_5_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tb_6_clicked()
{
	for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_tbLeft_0_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_1_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_2_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_3_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_4_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_5_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_6_clicked()
{	
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_7_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_8_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_9_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_10_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_11_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_12_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_13_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_14_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbLeft_15_clicked()
{
	for(int i=0;i<3;i++){
...
void LightDLL6PortForm::on_tbRight_0_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][0+0*16]	->setChecked(true);
		ChkList[3+i][0+1*16]	->setChecked(true);
		ChkList[3+i][0+2*16]	->setChecked(true);
		ChkList[3+i][0+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_1_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][1+0*16]	->setChecked(true);
		ChkList[3+i][1+1*16]	->setChecked(true);
		ChkList[3+i][1+2*16]	->setChecked(true);
		ChkList[3+i][1+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_2_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][2+0*16]	->setChecked(true);
		ChkList[3+i][2+1*16]	->setChecked(true);
		ChkList[3+i][2+2*16]	->setChecked(true);
		ChkList[3+i][2+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_3_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][3+0*16]	->setChecked(true);
		ChkList[3+i][3+1*16]	->setChecked(true);
		ChkList[3+i][3+2*16]	->setChecked(true);
		ChkList[3+i][3+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_4_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][4+0*16]	->setChecked(true);
		ChkList[3+i][4+1*16]	->setChecked(true);
		ChkList[3+i][4+2*16]	->setChecked(true);
		ChkList[3+i][4+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_5_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][5+0*16]	->setChecked(true);
		ChkList[3+i][5+1*16]	->setChecked(true);
		ChkList[3+i][5+2*16]	->setChecked(true);
		ChkList[3+i][5+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_6_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][6+0*16]	->setChecked(true);
		ChkList[3+i][6+1*16]	->setChecked(true);
		ChkList[3+i][6+2*16]	->setChecked(true);
		ChkList[3+i][6+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_7_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][7+0*16]	->setChecked(true);
		ChkList[3+i][7+1*16]	->setChecked(true);
		ChkList[3+i][7+2*16]	->setChecked(true);
		ChkList[3+i][7+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_8_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][8+0*16]	->setChecked(true);
		ChkList[3+i][8+1*16]	->setChecked(true);
		ChkList[3+i][8+2*16]	->setChecked(true);
		ChkList[3+i][8+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_9_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][9+0*16]	->setChecked(true);
		ChkList[3+i][9+1*16]	->setChecked(true);
		ChkList[3+i][9+2*16]	->setChecked(true);
		ChkList[3+i][9+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_10_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][10+0*16]	->setChecked(true);
		ChkList[3+i][10+1*16]	->setChecked(true);
		ChkList[3+i][10+2*16]	->setChecked(true);
		ChkList[3+i][10+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_11_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][11+0*16]	->setChecked(true);
		ChkList[3+i][11+1*16]	->setChecked(true);
		ChkList[3+i][11+2*16]	->setChecked(true);
		ChkList[3+i][11+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_12_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][12+0*16]	->setChecked(true);
		ChkList[3+i][12+1*16]	->setChecked(true);
		ChkList[3+i][12+2*16]	->setChecked(true);
		ChkList[3+i][12+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_13_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][13+0*16]	->setChecked(true);
		ChkList[3+i][13+1*16]	->setChecked(true);
		ChkList[3+i][13+2*16]	->setChecked(true);
		ChkList[3+i][13+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_14_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][14+0*16]	->setChecked(true);
		ChkList[3+i][14+1*16]	->setChecked(true);
		ChkList[3+i][14+2*16]	->setChecked(true);
		ChkList[3+i][14+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_tbRight_15_clicked()
{
	for(int i=0;i<3;i++){
		ChkList[3+i][15+0*16]	->setChecked(true);
		ChkList[3+i][15+1*16]	->setChecked(true);
		ChkList[3+i][15+2*16]	->setChecked(true);
		ChkList[3+i][15+3*16]	->setChecked(true);
	}
}

void LightDLL6PortForm::on_vsBrightness_valueChanged(int)
{
	int	n=ui.vsBrightness->value();
	ui.sbBrightness->setValue(n);
}

void LightDLL6PortForm::on_pbTransport_clicked()
{
...
void LightDLL6PortForm::on_sbBrightness_valueChanged(int)
{
...
void LightDLL6PortForm::on_tbOnOff_clicked()
{
...
void LightDLL6PortForm::on_pbAllSelect_clicked()
{
	for(int i=0;i<6;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(true);
...
void LightDLL6PortForm::on_pbClearSelect_clicked()
{
	for(int i=0;i<6;i++){
		for(int j=0;j<64;j++){
			ChkList[i][j]	->setChecked(false);
...
void LightDLL6PortForm::on_pbOK_clicked()
{
	for(int i=0;i<6;i++){
		for(int j=0;j<64;j++){
...
void LightDLL6PortForm::on_pbCancel_clicked()
{
	reject();
}