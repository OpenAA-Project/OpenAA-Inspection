#ifndef LEDControl16DDIALOG_H
#define LEDControl16DDIALOG_H
...
public:
	...
	{
	public:
		LEDControl16DPanel::DefUnit::DefBoard::DefLine	*PointerForDefLine;
		QLabel		*Label;
		QSpinBox	*EditValue;
	...
	LineGroup(LEDControl16DDialog *p ,QWidget *parent);
	~LineGroup(void);
	void	Initial(int n);
	void	AddLine(LEDControl16DPanel::DefUnit::DefBoard::DefLine	*L ,QWidget *parent);
...
class LEDControl16DDialog : public QDialog
{
    Q_OBJECT
...
public:
    explicit LEDControl16DDialog(LEDControl16DPanel *p,QWidget *parent = 0);
    ~LEDControl16DDialog();
