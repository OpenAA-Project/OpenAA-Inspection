...
public:
    ...
    QLabel *labelCameraResolution_6;
    QSpinBox *spinBoxAddedStartOffset;
    ...
    void setupUi(QDialog *TestStencilDialog)
    {
        ...
        TestStencilDialog->resize(709, 776);
        ...
        frame->setGeometry(QRect(10, 80, 681, 631));
        ...
        tableWidgetEnableComparator->setGeometry(QRect(10, 180, 571, 431));
        labelCameraResolution_4 = new QLabel(frame);
        labelCameraResolution_4->setObjectName("labelCameraResolution_4");
        labelCameraResolution_4->setGeometry(QRect(10, 150, 571, 28));
        ...
        pushButtonSetEnableComparator->setGeometry(QRect(589, 330, 81, 34));
        ...
        pushButtonReqEnableComparator->setGeometry(QRect(589, 260, 81, 34));
        ...
        spinBoxCalcB->setGeometry(QRect(589, 460, 61, 24));
        ...
        pushButtonOK->setGeometry(QRect(540, 720, 151, 41));
        ...
        labelCameraResolution_6 = new QLabel(TestStencilDialog);
        labelCameraResolution_6->setObjectName("labelCameraResolution_6");
        labelCameraResolution_6->setGeometry(QRect(250, 730, 191, 31));
        labelCameraResolution_6->setFrameShape(QFrame::Panel);
        labelCameraResolution_6->setFrameShadow(QFrame::Sunken);
        spinBoxAddedStartOffset = new QSpinBox(TestStencilDialog);
        spinBoxAddedStartOffset->setObjectName("spinBoxAddedStartOffset");
        spinBoxAddedStartOffset->setGeometry(QRect(450, 730, 81, 31));
        spinBoxAddedStartOffset->setMinimum(-99999999);
        spinBoxAddedStartOffset->setMaximum(99999999);
    ...
    void retranslateUi(QDialog *TestStencilDialog)
    {
        ...
        labelCameraResolution_6->setText(QCoreApplication::translate("TestStencilDialog", "Offset", nullptr));
    } // retranslateUi
