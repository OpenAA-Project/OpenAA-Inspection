/********************************************************************************
** Form generated from reading UI file 'LEDControl16DDialog.ui'
**
...
#ifndef UI_LEDCONTROL16DDIALOG_H
#define UI_LEDCONTROL16DDIALOG_H
...
public:
    ...
    void setupUi(QDialog *LEDControl16DDialog)
    {
        if (LEDControl16DDialog->objectName().isEmpty())
            LEDControl16DDialog->setObjectName("LEDControl16DDialog");
        LEDControl16DDialog->resize(651, 753);
        frame_3 = new QFrame(LEDControl16DDialog);
        ...
        frame = new QFrame(LEDControl16DDialog);
        ...
        lineEditVersion = new QLineEdit(LEDControl16DDialog);
        lineEditVersion->setObjectName("lineEditVersion");
        lineEditVersion->setGeometry(QRect(10, 10, 631, 21));
        pushButtonOK = new QPushButton(LEDControl16DDialog);
        pushButtonOK->setObjectName("pushButtonOK");
        pushButtonOK->setGeometry(QRect(270, 700, 101, 41));
        stackedWidgetSetting = new QStackedWidget(LEDControl16DDialog);
        ...
        retranslateUi(LEDControl16DDialog);

        stackedWidgetSetting->setCurrentIndex(15);


        QMetaObject::connectSlotsByName(LEDControl16DDialog);
    } // setupUi

    void retranslateUi(QDialog *LEDControl16DDialog)
    {
        LEDControl16DDialog->setWindowTitle(QCoreApplication::translate("LEDControl16DDialog", "Dialog", nullptr));
        pushButtonTransfer->setText(QCoreApplication::translate("LEDControl16DDialog", "Transfer", nullptr));
        label_2->setText(QCoreApplication::translate("LEDControl16DDialog", "Value", nullptr));
        pushButtonSetAll->setText(QCoreApplication::translate("LEDControl16DDialog", "Set all", nullptr));
        toolButtonON->setText(QCoreApplication::translate("LEDControl16DDialog", "ON", nullptr));
        pushButtonShowIO->setText(QCoreApplication::translate("LEDControl16DDialog", "Show  I/O", nullptr));
        pushButtonDefinition->setText(QCoreApplication::translate("LEDControl16DDialog", "Set definition", nullptr));
        pushButtonShowSpecial->setText(QCoreApplication::translate("LEDControl16DDialog", "Show Special", nullptr));
        pushButtonIODeliverer->setText(QCoreApplication::translate("LEDControl16DDialog", "Test signal for IODeliverer", nullptr));
        toolButtonRed->setText(QCoreApplication::translate("LEDControl16DDialog", "Red", nullptr));
        pushButtonOK->setText(QCoreApplication::translate("LEDControl16DDialog", "OK", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LEDControl16DDialog: public Ui_LEDControl16DDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LEDCONTROL16DDIALOG_H
