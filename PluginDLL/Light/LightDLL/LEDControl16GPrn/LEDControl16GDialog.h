#ifndef LEDControl16GDIALOG_H
#define LEDControl16GDIALOG_H
...
public:
	...
	LineGroup(LEDControl16GDialog *p ,QWidget *parent);
	~LineGroup(void);
	void	Initial(int n);
...
class LEDControl16GDialog : public QDialog
{
    Q_OBJECT
...
public:
    explicit LEDControl16GDialog(LEDControl16GPanel *p,QWidget *parent = 0);
    ~LEDControl16GDialog();
