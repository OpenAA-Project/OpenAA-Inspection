...
QString	GioPortDefinition::GetTypeName(int PortType,int BitNo)
{
	switch(PortType){
...
QString	GioPortDefinition::GetString(int PortType ,int BitNo)
{
	switch(PortType){
...
void	GioPortDefinition::SetString(int PortType ,int BitNo ,const QString &s)
{
	switch(PortType){
...
bool	GioPortDefinition::GetSignal(int PortType ,int BitNo ,struct  TimingData &d)
{
	switch(PortType){
	case DefPortPIOAIN	:
...
bool    GioPortDefinition::Save(QIODevice *f)
{
	int32	Ver=1;
    if(::Save(f,Ver)==false)
        return false;
...
bool    GioPortDefinition::Load(QIODevice *f)
{
	int32	Ver;
    if(::Load(f,Ver)==false)
        return false;
