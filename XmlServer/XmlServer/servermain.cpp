...
:uii(ui)
{
	...
	bool ret1=(connect(socket, SIGNAL(readyRead()), this, SLOT(Server_Get())))?true:false;//�N���C�A���������̃f�[�^�̎��M��������
	bool ret2=(connect(socket, SIGNAL(disconnected()),this, SLOT(TimerWatch())))?true:false;//���C�A���g���炢���Ȃ��؂��ꂽ���p
	bool ret3=(connect(socket, SIGNAL(disconnected()),this, SLOT(deleteLater())))?true:false;//���C�A���g���炢���Ȃ��؂��ꂽ���p
...
void ServerMain::Server_Get() //�N���C�A���g�����f�[�^�������Ă���
{
	QByteArray Test;
	OutList.clear();
	...
	in >> InList;	//�N���C�A���g�����̃f�[�^��QList<QByteArray>�Ɏ擾
...
//		{
		...
		{
			SaveWidgetShow(DB, DBNum); // ����(��)
			WidgetShow(DB, Client, DBNum); // ����(��)
			StartClient(Client); // �A�N�Z�X���ԕ\��
			OutList.append("Success");
			OutList.append(QByteArray::number(Client)); // �N���C�A���g�ԍ�
		}
	}
...
//					delete [] xmlqsort[uLi].data; // xmlqsort[uLi].data�͂��łɏ���Selectsyori�֐�����delete�����Ă���
...
void ServerMain::Server_Send() 
{
	...
	out << (quint16)0; //0���g�p
    out <<OutList;//���ۑ��镶��
    out.device()->seek(0);//0���u��������
	out << (quint16)(block.size() - sizeof(quint16));//����0���������ۂ̃T�C�Y
	socket->readAll();	
	socket->write(block);//����
}
...
{//�����ʂ̍X�V
	...
	bool DataBase=false;
	QStringList List;
//�N���C�A���g�ԍ�/DataBase�ԍ�/DataBase����/�A�N�Z�X����
	int iRow=uii.tableWidget->rowCount();
	QString DBNum;
