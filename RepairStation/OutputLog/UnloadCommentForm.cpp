...
UnloadCommentForm::UnloadCommentForm(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
	...
	//画面の設定
	palette[0].setColor(QPalette::Window,QColor(Qt::green));
...
UnloadCommentForm::~UnloadCommentForm()
{
	delete timer;
}

void UnloadCommentForm::SetShowPickupEnable(QString &KibanNo)
{
	//メッセージラベルの表示設定
...
void UnloadCommentForm::SetShowMaxOverEnable(QString &KibanNo)
{
	//メッセージラベルの表示設定
	ui.lbMessage1_1->move(50,40);
	ui.lbMessage1_2->move(30,110);
