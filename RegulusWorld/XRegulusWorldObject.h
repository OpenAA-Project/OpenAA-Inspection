...
public:
	...
	Vector3D	operator-(const Vector3D &src)	const;
	Vector3D	operator*(const Vector3D &src)	const;	//Cross product�@�O��
	...
	Vector3D	&operator*=(const Vector3D &src);	//Cross product�@�O��
...
public:
	...
	int			ViewYLen;
	/*
	* Point=0	Radian=0�̂Ƃ��A(x,y,z)=(Length,0,0)�̈ʒu�Ɏl�p�`�𗧂ĂĒu��
	* Radian�́A�e���̎����ɉ��]�����p�x���\��
	*/
...
public:
	...
	float	Diffusion	;		//�g�U��	0-1.0
	float	Transparent	;		//���ߗ�	0-1.0
	float	Refraction	;		//���ܗ�
	QColor	Color;
