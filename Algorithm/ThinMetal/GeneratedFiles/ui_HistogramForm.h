...
public:
    ...
    QWidget *page;
    QPushButton *ButtonRelrectOnlyThinMetal;
    QWidget *page_3;
    ...
    QLabel *label_8;
    QPushButton *ButtonReflectAllThinMetals;
    ...
    void setupUi(QWidget *HistogramForm)
    {
        ...
        pushButtonChangeLib->setGeometry(QRect(170, 510, 31, 23));
        ...
        groupBox->setGeometry(QRect(10, 540, 181, 27));
        ...
        label_4->setGeometry(QRect(10, 490, 62, 20));
        ...
        stackedWidgetParts->setGeometry(QRect(20, 620, 181, 41));
        page = new QWidget();
        page->setObjectName("page");
        ButtonRelrectOnlyThinMetal = new QPushButton(page);
        ButtonRelrectOnlyThinMetal->setObjectName("ButtonRelrectOnlyThinMetal");
        ButtonRelrectOnlyThinMetal->setGeometry(QRect(0, 0, 171, 41));
        ButtonRelrectOnlyThinMetal->setAcceptDrops(true);
        ...
        label_39->setGeometry(QRect(10, 590, 101, 21));
        ...
        EditCenterBrightTarget->setGeometry(QRect(120, 590, 61, 21));
        QPalette palette;
        ...
        ButtonReflectAllThinMetals = new QPushButton(HistogramForm);
        ButtonReflectAllThinMetals->setObjectName("ButtonReflectAllThinMetals");
        ButtonReflectAllThinMetals->setGeometry(QRect(200, 620, 171, 41));
        ButtonReflectAllThinMetals->setAcceptDrops(true);
        listWidgetHistList = new QListWidget(HistogramForm);
        listWidgetHistList->setObjectName("listWidgetHistList");
        listWidgetHistList->setGeometry(QRect(570, 610, 181, 101));
        ButtonSaveToLibrary = new QPushButton(HistogramForm);
        ButtonSaveToLibrary->setObjectName("ButtonSaveToLibrary");
        ButtonSaveToLibrary->setGeometry(QRect(20, 670, 171, 41));
        ButtonSaveToLibrary->setAcceptDrops(true);
        label_38 = new QLabel(HistogramForm);
        label_38->setObjectName("label_38");
        label_38->setGeometry(QRect(10, 570, 101, 21));
        ...
        toolButtonSimShowArea = new QToolButton(HistogramForm);
        toolButtonSimShowArea->setObjectName("toolButtonSimShowArea");
        toolButtonSimShowArea->setGeometry(QRect(760, 20, 141, 41));
        ...
        ButtonClose->setGeometry(QRect(380, 620, 171, 41));
        ...
        EditLibName->setGeometry(QRect(70, 510, 101, 21));
        ...
        label_5->setGeometry(QRect(70, 490, 101, 20));
        ...
        EditItemName = new QLineEdit(HistogramForm);
        EditItemName->setObjectName("EditItemName");
        EditItemName->setGeometry(QRect(10, 460, 141, 21));
        EditItemName->setReadOnly(false);
        pushButtonTransmitItemNameAll = new QPushButton(HistogramForm);
        pushButtonTransmitItemNameAll->setObjectName("pushButtonTransmitItemNameAll");
        pushButtonTransmitItemNameAll->setGeometry(QRect(150, 460, 51, 23));
        label_9 = new QLabel(HistogramForm);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(10, 440, 191, 20));
    ...
    {
        HistogramForm->setWindowTitle(QCoreApplication::translate("HistogramForm", "Threshold ThinMetal", nullptr));
        ...
        ButtonRelrectOnlyThinMetal->setText(QCoreApplication::translate("HistogramForm", "\343\201\223\343\201\256\343\203\226\343\203\255\343\203\203\343\202\257\343\201\240\343\201\221\343\201\253\345\217\215\346\230\240", nullptr));
        ...
        ButtonReflectAllThinMetals->setText(QCoreApplication::translate("HistogramForm", "\345\220\214\344\270\200\347\250\256\351\241\236\343\201\256\343\203\226\343\203\255\343\203\203\343\202\257\343\201\253\345\217\215\346\230\240", nullptr));
        ...
        toolButtonSimShowArea->setText(QCoreApplication::translate("HistogramForm", "Block", nullptr));
        ...
        EditItemName->setText(QCoreApplication::translate("HistogramForm", "XXX", nullptr));
        pushButtonTransmitItemNameAll->setText(QCoreApplication::translate("HistogramForm", "To all", nullptr));
        label_9->setText(QCoreApplication::translate("HistogramForm", "Item name", nullptr));
    } // retranslateUi
