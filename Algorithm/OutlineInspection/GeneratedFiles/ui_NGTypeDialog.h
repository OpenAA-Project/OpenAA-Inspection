...
public:
    ...
    void setupUi(QDialog *NGTypeDialog)
    {
        ...
        NGTypeDialog->resize(482, 529);
        pushButtonOK = new QPushButton(NGTypeDialog);
        pushButtonOK->setObjectName("pushButtonOK");
        pushButtonOK->setGeometry(QRect(70, 470, 101, 41));
        QIcon icon;
        ...
        spinBoxMinSize->setGeometry(QRect(30, 380, 81, 22));
        ...
        spinBoxMaxSize->setGeometry(QRect(120, 380, 81, 22));
        spinBoxMaxSize->setMaximum(999999);
        label_3 = new QLabel(NGTypeDialog);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(120, 410, 81, 21));
        ...
        spinBoxMinRoundRate->setGeometry(QRect(30, 430, 81, 22));
        spinBoxMinRoundRate->setMaximum(9999);
        label = new QLabel(NGTypeDialog);
        label->setObjectName("label");
        label->setGeometry(QRect(30, 360, 81, 21));
