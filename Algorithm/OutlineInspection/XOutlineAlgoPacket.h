#if	!defined(XOUTLINEALGOPACKET_H)
#define	XOUTLINEALGOPACKET_H
...
class	SlaveCommReqLibraryInMaskOfOutline : public DirectCommPacketBase
{
public:
	IntList	UsedLibraries;

	SlaveCommReqLibraryInMaskOfOutline(LayersBase  *base 
...
class	SlaveCommAckLibraryInMaskOfOutline : public DirectCommPacketBase
{
public:
	LibraryEfectivityContainer	UsedLibraries;

	SlaveCommAckLibraryInMaskOfOutline(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
