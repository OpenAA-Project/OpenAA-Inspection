...
public:
	FlexArea	***DotMatrix;
	int			MaxXCount;		//�Z���v�Z�̂��тɍČv�Z������
	int			MaxYCount;		//�Z���v�Z�̂��тɍČv�Z������
	double		CenterPointForSlideX;	//�ŏ��ɐݒ肳����
	double		CenterPointForSlideY;	//�ŏ��ɐݒ肳����
