...
//================================================================================
SlaveCommReqLibraryInMaskOfLECerL1::SlaveCommReqLibraryInMaskOfLECerL1(LayersBase *base 
...
bool	SlaveCommReqLibraryInMaskOfLECerL1::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommReqLibraryInMaskOfLECerL1::Save(QIODevice *f)
{
...
void	SlaveCommReqLibraryInMaskOfLECerL1::Receive(int32 localPage, int32 cmd ,QString &EmitterRoot,QString &EmitterName)
{
	SlaveCommAckLibraryInMaskOfLECerL1	*S
	=(SlaveCommAckLibraryInMaskOfLECerL1 *)((GetSendBackPacket()==NULL)?new SlaveCommAckLibraryInMaskOfLECerL1(GetLayersBase(),EmitterRoot,EmitterName) : GetSendBackPacket())->SetLocalPage(localPage);
...
SlaveCommAckLibraryInMaskOfLECerL1::SlaveCommAckLibraryInMaskOfLECerL1(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage)
:DirectCommPacketBase(base,globalPage,EmitterRoot,EmitterName ,typeid(this).name())
{
}

bool	SlaveCommAckLibraryInMaskOfLECerL1::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommAckLibraryInMaskOfLECerL1::Save(QIODevice *f)
{
	if(UsedLibraries.Save(f)==false)
		return false;
	return true;
...
void	SlaveCommAckLibraryInMaskOfLECerL1::Receive(int32 localPage, int32 cmd ,QString &EmitterRoot,QString &EmitterName)
{
	TestDbg++;
}
