#if	!defined(XTRUECOLORBLOCKALGOPACKET_H)
#define	XTRUECOLORBLOCKALGOPACKET_H
...
class	SlaveCommReqLibraryInMaskOfTrueColorBlock : public DirectCommPacketBase
{
public:
	IntList	UsedLibraries;

	SlaveCommReqLibraryInMaskOfTrueColorBlock(LayersBase  *base 
...
class	SlaveCommAckLibraryInMaskOfTrueColorBlock : public DirectCommPacketBase
{
public:
	LibraryEfectivityContainer	UsedLibraries;

	SlaveCommAckLibraryInMaskOfTrueColorBlock(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
