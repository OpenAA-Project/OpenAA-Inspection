...
//================================================================================
SlaveCommReqLibraryInMaskOfTrueColorBlock::SlaveCommReqLibraryInMaskOfTrueColorBlock(LayersBase *base 
...
bool	SlaveCommReqLibraryInMaskOfTrueColorBlock::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommReqLibraryInMaskOfTrueColorBlock::Save(QIODevice *f)
{
...
void	SlaveCommReqLibraryInMaskOfTrueColorBlock::Receive(int32 localPage, int32 cmd ,QString &EmitterRoot,QString &EmitterName)
{
	SlaveCommAckLibraryInMaskOfTrueColorBlock	*S
	=(SlaveCommAckLibraryInMaskOfTrueColorBlock *)((GetSendBackPacket()==NULL)?new SlaveCommAckLibraryInMaskOfTrueColorBlock(GetLayersBase(),EmitterRoot,EmitterName) : GetSendBackPacket())->SetLocalPage(localPage);
...
SlaveCommAckLibraryInMaskOfTrueColorBlock::SlaveCommAckLibraryInMaskOfTrueColorBlock(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage)
:DirectCommPacketBase(base,globalPage,EmitterRoot,EmitterName ,typeid(this).name())
{
}

bool	SlaveCommAckLibraryInMaskOfTrueColorBlock::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommAckLibraryInMaskOfTrueColorBlock::Save(QIODevice *f)
{
	if(UsedLibraries.Save(f)==false)
		return false;
	return true;
