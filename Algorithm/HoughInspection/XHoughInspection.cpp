...
bool	HoughThreshold::IsEqual(const AlgorithmThreshold &src)	const 
{
	const HoughThreshold	*s=dynamic_cast<const HoughThreshold *>(&src);
...
:AlgorithmBase(Base)
{
	...
	SetParam(&FillRate			, /**/"Setting" ,/**/"FillRate"			,LangSolver.GetString(XHoughInspection_LS,LID_8)/*"Minimum rate to fill line.  Pixels/Length"*/);
	SetParam(&DefaultDivCount	, /**/"Setting" ,/**/"DefaultDivCount"	,LangSolver.GetString(XHoughInspection_LS,LID_9)/*"Default Divided Count for partial check"*/);
	SetParam(&RangeToFillWidth	, /**/"Setting" ,/**/"RangeToFillWidth"	,LangSolver.GetString(XHoughInspection_LS,LID_10)/*"Rate to fill width range for partial check(0-1.0)"*/);
	SetParam(&ModeThread		, /**/"Setting" ,/**/"ModeThread"		,LangSolver.GetString(XHoughInspection_LS,LID_11)/*"Use multi core to accelerate"*/);
}
...
{
	return LangSolver.GetString(XHoughInspection_LS,LID_12)/*"直線検査"*/;
}
//======================================================================
