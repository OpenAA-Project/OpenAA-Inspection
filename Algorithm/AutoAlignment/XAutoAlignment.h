...
public:
	...
	int			NoiseShrink;
	int			ExpandForPickup;
	int			MinDot;			//�e�̈��̍ŏ��h�b�g��
	int			FringeWidth;	//�J�ڃr�b�g�ɂ������ӕ�
...
class	AutoAlignmentInPico : public NPList<AutoAlignmentInPico>,public AlignmentPacket2D
{
	...
	int			Xn,Yn;
	int			CenterX,CenterY;
	AutoAlignmentInPico	*BasePointer;	//�D���x�̍ł����������ӏ���PICO�ւ̃|�C���^
	...
	FlexArea	OtherArea;	//�D���x���Q�Ԗڈȍ~�̂Ƃ��ɐ����������B
							//���g��PICO�T���h�b�g�{���o�̈��𑼂̍ő���PICO�T���͈͕��c�������A���g�̗̈������������G���A
...
class	ClusteredPicoDim : public NPList<ClusteredPicoDim>
{
	...
	//	�}�X�N�ŗ̈扻���ꂽ�P�G���A���̂o�h�b�n�̈��Q���\��
public:
	AutoAlignmentInPico	***PicoDim;	//�ʎQ��
	int	PicoDimXNumb;
	int	PicoDimYNumb;
	int	XByte;
	AutoAlignmentSheet	*Parent;
...
class	AutoAlignmentSheet : public AlgorithmItemPI
{
	...
	FlexArea RetFlexArea;	//GetArea(int UniqueAreaType_Code)��return�p
...
public:
	...
	char	**ResultPerPixXFromTarget;		//���Όn�ł̈ʒu������
	char	**ResultPerPixYFromTarget;		//���Όn�ł̈ʒu������
	char	**ResultPerPixXFromMaster;		//���Όn�ł̈ʒu������
	char	**ResultPerPixYFromMaster;		//���Όn�ł̈ʒu������
	char	**ResultRelativeXFromTarget;	//�x�[�X�ʒu�����ɑ΂��鑊�ΓI�Ȉʒu������
	char	**ResultRelativeYFromTarget;	//�x�[�X�ʒu�����ɑ΂��鑊�ΓI�Ȉʒu������
	char	**ResultRelativeXFromMaster;	//�x�[�X�ʒu�����ɑ΂��鑊�ΓI�Ȉʒu������
	char	**ResultRelativeYFromMaster;	//�x�[�X�ʒu�����ɑ΂��鑊�ΓI�Ȉʒu������

#if	defined(NeedFringeBit)
	BYTE	**ResultBitTransFromMaster;		//�Q�Ԗڈȍ~�̎����̎��A�P
	BYTE	**ResultBitTransFromTarget;		//�Q�Ԗڈȍ~�̎����̎��A�P
	BYTE	**ResultBitFirstTransFromMaster;		//�P�Ԗڂ̎����̎��A�P
	BYTE	**ResultBitFirstTransFromTarget;		//�P�Ԗڂ̎����̎��A�P
#endif

	BYTE	**ResultBitPickupFromMaster;		//�Q�Ԗڈȍ~�̒��o�̈��̎��A�P
	BYTE	**ResultBitPickupFromTarget;		//�Q�Ԗڈȍ~�̒��o�̈��̎��A�P
	BYTE	**ResultBitFirstPickupFromMaster;		//�P�Ԗڂ̒��o�̈��̎��A�P
	BYTE	**ResultBitFirstPickupFromTarget;		//�P�Ԗڂ̒��o�̈��̎��A�P
