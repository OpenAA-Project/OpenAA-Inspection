...
*/
	...
	for(PureFlexAreaList *f=MaskFPackSorted.GetFirst();f!=NULL;f=f->GetNext()){
		//Mask�̗̈悪����PICO�̈��Ɋ��S�ɓ�������Ƃ��A����Mask�̈悩��ClusteredPicoDim���쐬���Ȃ�
		//�傫���̈悩�珇�Ԃɐ�������ClusteredPicoDim�ŗ̈����؂������Ă����A�c�����̈悪�P�O�h�b�g
		//	�ȉ��ł����ΐ������Ȃ�
		FlexArea	TestArea=*f;
