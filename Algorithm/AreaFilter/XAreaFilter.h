...
{
public:
	double	brightnessvariance;	//�P�x�̕��U
	double	brightnessvariance2;	//�P�x�̕��U
	double	DifVar;					//�S�����̈��̕��U�̍�
	int		lightsidengdotcount;	//���e�͈͊O�̖��邢���̃h�b�g��
	unsigned int xn;				//�ԍ�
	unsigned int yn;
	unsigned int X1;				//BlockSize�̍������W
	unsigned int Y1;
	unsigned int X2;				//BlockSize�̍������W
	unsigned int Y2;
	bool	Effective;
	bool	isinsidemasking;
	int		EffectivePixels;	//�L���ȃs�N�Z����
