...
public:
	//����
    bool	DetailSettingNarrow;		//�����L���`�F�b�N
    int		SearchDotMasterNarrow;		//�}�X�^�[�f�[�^�쐬���̎��͕�h�b�g
    int		SearchDotTargetNarrow;		//�������̒T���h�b�g
    ...
    int		NGSizeNarrow;				//NG�T�C�Y

	//�L��
    bool	DetailSettingBroad;			//�����L���`�F�b�N
    int		SearchDotMasterBroad;		//�}�X�^�[�f�[�^�쐬���̎��͕�h�b�g
    int		SearchDotTargetBroad;		//�������̒T���h�b�g
    double	RelativeNGThresholdBroad;	//-1<=RelativeNGThresholdBroad<=1
    int		AbsoluteNGThresholdBroad;	// 0<=AbsoluteNGThresholdBroad<=255
    int		NGSizeBroad;				//NG�T�C�Y

	DetailType ThrType;
	bool	IsCalcPixelInterPoration;	//�s�N�Z�����ԋ@�\���L���ɂ���
...
{
public:
	PixelSampleContainer	SampleLists;	//�����o�[�W�����̖��c
...
//	BYTE	**ThresholdDifferencemap;
	...
	VCutInspectionInPage		*pVCutPage;			//V�J�b�g�|�C���^�iVCutInspectionInPage *�j
...
//	list<point> point_list;
	...
	FlexArea	*AreaArrayList;			//�Ώ�AlgorithmItem��Area���X�g���ێ�
	int			AreaArrayCnt;
	int			UniqueID;
	AlgorithmInPagePI	*DCAlgorithmInPagePIPointer;
	FlexArea	*TargetAreaArrayList;	//Target��AlgorithmItem��Area���X�g���ێ�
...
class   PixelInspectionInPage : public AlgorithmInPagePI
{
	...
	QStringList	PLibSettingStringList;	//PixelLibrarySetting.dat�̕�����
	...
	bool	LoadedFlag;						//�}�X�^�[�f�[�^��Load���ꂽ�̂��ǂ���
	bool	InitialMultiAlgorithmSupport;	//MultiAlgorithmSupport��initial����
...
////////
	int32	MasterLoadVer;	//�}�X�^�[�f�[�^�̃o�[�W�����ႢLoad�Ή�
...
//	BYTE	AverageBrightness[3];			//���ω摜�̋P�x
...
//	BYTE	*TargetBrightness[3];			//�����摜�̋P�x
	ImageBuffer *TargetImageList[3];		//�����摜�̋P�x
	...
	bool	CheckPadIns		,CheckSilkIns	,CheckResistIns	,CheckHoleIns;		//�������s�����ǂ����̃t���O
