...
//////////////////////////////////////////////////////
	...
	//?u?I?I?��?��?��?l?A?I???�C//
	if((InspectResult&0x01)!=0){		//?u?I?I?��?��?��?l?A?E?iNG
		...
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_67)/*"?y?u?I?I?��?��?��?l?z?E?i?m?f?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x02)!=0){	//?u?I?I?��?��?��?l?A?E?iOK
		ui.lbPixelInfo				->setVisible(true);
		ui.lbPlusPixelInfo			->setVisible(false);
		...
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_69)/*"?y?u?I?I?��?��?��?l?z?�P?e?_?I?��?��?��?l?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x04)!=0){	//?u?I?I?��?��?��?l?A?u?e?I?��?��?��?l?AOK
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_71)/*"?y?u?I?I?��?��?��?l?z?u?e?I?��?��?��?l?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x08)!=0){	//?u?I?I?��?��?��?l?A?��?��?��?l???��OK
		ui.lbPixelInfo				->setVisible(false);
		ui.lbPlusPixelInfo			->setVisible(true);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_72)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_73)/*"?y?u?I?I?��?��?��?l?z?��?��?��?l???��?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x10)!=0){	//?u?I?I?��?��?��?l?ANG?X???b?V???z?[???h?AOK
		ui.lbPixelInfo				->setVisible(true);
		ui.lbPlusPixelInfo			->setVisible(false);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_74)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_75)/*"?y?u?I?I?��?��?��?l?zNG?X???b?V???z?[???h?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundThreshold->setPalette(lbAroundInsPalette);

	//?u?I?I???�C?a???A?I???�C//
	if((InspectResult&0x0100)!=0){		//?u?I?I???�C?a???A?E?iNG
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_76)/*"NG"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_77)/*"?y?u?I?I???�C?a???z?E?i?m?f?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0200)!=0){	//?u?I?I???�C?a???A?E?iOK
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_78)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_79)/*"?y?u?I?I???�C?a???z?�P?e?_?I???�C?a???A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0400)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_81)/*"?y?u?I?I???�C?a???z?u?e?I???�C?a???A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0800)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_2	->setVisible(false);
		ui.lbPlusPixelInfo_2->setVisible(true);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_82)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_83)/*"?y?u?I?I???�C?a???z?u?e?I???�C?a?????��?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x1000)!=0){	//?u?I?I???�C?a???A?��?��?��?lOK
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_84)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_85)/*"?y?u?I?I???�C?a???zNG?X???b?V???z?[???h?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	...
	//?u?I?I?��?��?��?l?A?I???�C//
	if((InspectResult&0x010000)!=0){		//?u?I?I?��?��?��?l?A?E?iNG
		ui.lbPixelInfo				->setVisible(true);
		ui.lbPlusPixelInfo			->setVisible(false);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_86)/*"NG"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_87)/*"?y?u?I?I?��?��?��?l?z?E?i?m?f?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x020000)!=0){	//?u?I?I?��?��?��?l?A?E?iOK
		ui.lbPixelInfo				->setVisible(true);
		ui.lbPlusPixelInfo			->setVisible(false);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_88)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_89)/*"?y?u?I?I?��?��?��?l?z?�P?e?_?I?��?��?��?l?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x040000)!=0){	//?u?I?I?��?��?��?l?A?u?e?I?��?��?��?l?AOK
		ui.lbPixelInfo				->setVisible(false);
		ui.lbPlusPixelInfo			->setVisible(true);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_90)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_91)/*"?y?u?I?I?��?��?��?l?z?u?e?I?��?��?��?l?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x080000)!=0){	//?u?I?I?��?��?��?l?A?��?��?��?l???��OK
		ui.lbPixelInfo				->setVisible(false);
		ui.lbPlusPixelInfo			->setVisible(true);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_92)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_93)/*"?y?u?I?I?��?��?��?l?z?��?��?��?l???��?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x100000)!=0){	//?u?I?I?��?��?��?l?ANG?X???b?V???z?[???h?AOK
		ui.lbPixelInfo				->setVisible(true);
		ui.lbPlusPixelInfo			->setVisible(false);
		ui.lbAroundThreshold		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_94)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_95)/*"?y?u?I?I?��?��?��?l?zNG?X???b?V???z?[???h?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundThreshold->setPalette(lbAroundInsPalette);

	//?u?I?I???�C?a???A?I???�C//
	if((InspectResult&0x01000000)!=0){		//?u?I?I???�C?a???A?E?iNG
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_96)/*"NG"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_97)/*"?y?u?I?I???�C?a???z?E?i?m?f?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x02000000)!=0){	//?u?I?I???�C?a???A?E?iOK
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_98)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_99)/*"?y?u?I?I???�C?a???z?�P?e?_?I???�C?a???A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x04000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_2	->setVisible(false);
		ui.lbPlusPixelInfo_2->setVisible(true);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_100)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_101)/*"?y?u?I?I???�C?a???z?u?e?I???�C?a???A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x08000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_2	->setVisible(false);
		ui.lbPlusPixelInfo_2->setVisible(true);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_102)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_103)/*"?y?u?I?I???�C?a???z?u?e?I???�C?a?????��?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x10000000)!=0){	//?u?I?I???�C?a???A?��?��?��?lOK
		ui.lbPixelInfo_2	->setVisible(true);
		ui.lbPlusPixelInfo_2->setVisible(false);
		ui.lbAroundIns		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_104)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_105)/*"?y?u?I?I???�C?a???zNG?X???b?V???z?[???h?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundIns->setPalette(lbAroundInsPalette);
...
//////////////////////////////////////////////////////
	//Master?a???c?cTarget?a???O?I?I?�E?A?I???�C
	//?u?I?I?��?��?��?l?A?I???�C//
	if((InspectResult&0x0100000000)!=0){		//?u?I?I?��?��?��?l?A?E?iNG
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_107)/*"???W?X?g?y?u?I?I?��?��?��?l?z?E?i?m?f?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0200000000)!=0){	//?u?I?I?��?��?��?l?A?E?iOK
		ui.lbPixelInfo_3			->setVisible(true);
		ui.lbPlusPixelInfo_3		->setVisible(false);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_108)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_109)/*"???W?X?g?y?u?I?I?��?��?��?l?z?�P?e?_?I?��?��?��?l?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0400000000)!=0){	//?u?I?I?��?��?��?l?A?u?e?I?��?��?��?l?AOK
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_111)/*"???W?X?g?y?u?I?I?��?��?��?l?z?u?e?I?��?��?��?l?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0800000000)!=0){	//?u?I?I?��?��?��?l?A?��?��?��?l???��OK
		ui.lbPixelInfo_3			->setVisible(false);
		ui.lbPlusPixelInfo_3		->setVisible(true);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_112)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_113)/*"???W?X?g?y?u?I?I?��?��?��?l?z?��?��?��?l???��?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x1000000000)!=0){	//?u?I?I?��?��?��?l?ANG?X???b?V???z?[???h?AOK
		ui.lbPixelInfo_3			->setVisible(true);
		ui.lbPlusPixelInfo_3		->setVisible(false);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_114)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_115)/*"???W?X?g?y?u?I?I?��?��?��?l?zNG?X???b?V???z?[???h?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundThreshold_2->setPalette(lbAroundInsPalette);

	//?u?I?I???�C?a???A?I???�C//
	if((InspectResult&0x010000000000)!=0){		//?u?I?I???�C?a???A?E?iNG
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_117)/*"???W?X?g?y?u?I?I???�C?a???z?E?i?m?f?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x020000000000)!=0){	//?u?I?I???�C?a???A?E?iOK
		ui.lbPixelInfo_4	->setVisible(true);
		ui.lbPlusPixelInfo_4->setVisible(false);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_118)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_119)/*"???W?X?g?y?u?I?I???�C?a???z?�P?e?_?I???�C?a???A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x040000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		...
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_121)/*"???W?X?g?y?u?I?I???�C?a???z?u?e?I???�C?a???A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x080000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_4	->setVisible(false);
		ui.lbPlusPixelInfo_4->setVisible(true);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_122)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_123)/*"???W?X?g?y?u?I?I???�C?a???z?u?e?I???�C?a?????��?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x100000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?lOK
		ui.lbPixelInfo_4	->setVisible(true);
		ui.lbPlusPixelInfo_4->setVisible(false);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_124)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_125)/*"???W?X?g?y?u?I?I???�C?a???zNG?X???b?V???z?[???h?A?n?j?i?}?X?^?[?a???c?c?I?I?�E?j"*/;
	}
	...
	//Target?a???c?cMaster?a???O?I?I?�E?A?I???�C
	//?u?I?I?��?��?��?l?A?I???�C//
	if((InspectResult&0x01000000000000)!=0){		//?u?I?I?��?��?��?l?A?E?iNG
		ui.lbPixelInfo_3			->setVisible(true);
		ui.lbPlusPixelInfo_3		->setVisible(false);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_126)/*"NG"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_127)/*"???W?X?g?y?u?I?I?��?��?��?l?z?E?i?m?f?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x02000000000000)!=0){	//?u?I?I?��?��?��?l?A?E?iOK
		ui.lbPixelInfo_3			->setVisible(true);
		ui.lbPlusPixelInfo_3		->setVisible(false);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_128)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_129)/*"???W?X?g?y?u?I?I?��?��?��?l?z?�P?e?_?I?��?��?��?l?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x04000000000000)!=0){	//?u?I?I?��?��?��?l?A?u?e?I?��?��?��?l?AOK
		ui.lbPixelInfo_3			->setVisible(false);
		ui.lbPlusPixelInfo_3		->setVisible(true);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_130)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_131)/*"???W?X?g?y?u?I?I?��?��?��?l?z?u?e?I?��?��?��?l?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x08000000000000)!=0){	//?u?I?I?��?��?��?l?A?��?��?��?l???��OK
		ui.lbPixelInfo_3			->setVisible(false);
		ui.lbPlusPixelInfo_3		->setVisible(true);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_132)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_133)/*"???W?X?g?y?u?I?I?��?��?��?l?z?��?��?��?l???��?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x10000000000000)!=0){	//?u?I?I?��?��?��?l?ANG?X???b?V???z?[???h?AOK
		ui.lbPixelInfo_3			->setVisible(true);
		ui.lbPlusPixelInfo_3		->setVisible(false);
		ui.lbAroundThreshold_2		->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_134)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_135)/*"???W?X?g?y?u?I?I?��?��?��?l?zNG?X???b?V???z?[???h?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundThreshold_2->setPalette(lbAroundInsPalette);

	//?u?I?I???�C?a???A?I???�C//
	if((InspectResult&0x0100000000000000)!=0){		//?u?I?I???�C?a???A?E?iNG
		ui.lbPixelInfo_4	->setVisible(true);
		ui.lbPlusPixelInfo_4->setVisible(false);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_136)/*"NG"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::red));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_137)/*"???W?X?g?y?u?I?I???�C?a???z?E?i?m?f?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0200000000000000)!=0){	//?u?I?I???�C?a???A?E?iOK
		ui.lbPixelInfo_4	->setVisible(true);
		ui.lbPlusPixelInfo_4->setVisible(false);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_138)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_139)/*"???W?X?g?y?u?I?I???�C?a???z?�P?e?_?I???�C?a???A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0400000000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_4	->setVisible(false);
		ui.lbPlusPixelInfo_4->setVisible(true);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_140)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_141)/*"???W?X?g?y?u?I?I???�C?a???z?u?e?I???�C?a???A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x0800000000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?l???��OK
		ui.lbPixelInfo_4	->setVisible(false);
		ui.lbPlusPixelInfo_4->setVisible(true);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_142)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_143)/*"???W?X?g?y?u?I?I???�C?a???z?u?e?I???�C?a?????��?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	else if((InspectResult&0x1000000000000000)!=0){	//?u?I?I???�C?a???A?��?��?��?lOK
		ui.lbPixelInfo_4	->setVisible(true);
		ui.lbPlusPixelInfo_4->setVisible(false);
		ui.lbAroundIns_2	->setText(LangSolver.GetString(PixelHistogramForm_LS,LID_144)/*"OK"*/);
		lbAroundInsPalette.setColor(QPalette::WindowText,QColor(Qt::green));
		ResultMsg+=LangSolver.GetString(PixelHistogramForm_LS,LID_145)/*"???W?X?g?y?u?I?I???�C?a???zNG?X???b?V???z?[???h?A?n?j?i???�C?a???c?c?I?I?�E?j"*/;
	}
	ui.lbAroundIns_2->setPalette(lbAroundInsPalette);
...
//	ui.leRGBDifference->setText(QString::number(ThresholdDifferencemap[localY][localX]));
	...
	//???W?X?g
	if((InspectResult&0x0100000000)!=0			/*?u?I?I?��?��?��?l?A?E?iNG?iMaster?a???c?cTarget?a???O?I?I?�E?j*/
	|| (InspectResult&0x010000000000)!=0		/*?u?I?I???�C?a???A?E?iNG?iMaster?a???c?cTarget?a???O?I?I?�E?j*/
	|| (InspectResult&0x01000000000000)!=0		/*?u?I?I?��?��?��?l?A?E?iNG?iTarget?a???c?cMaster?a???O?I?I?�E?j*/
	|| (InspectResult&0x0100000000000000)!=0){	/*?u?I?I???�C?a???A?E?iNG?iTarget?a???c?cMaster?a???O?I?I?�E?j*/
