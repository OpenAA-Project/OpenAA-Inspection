...
//    NPListPack<QPoint			Result[3];
    double          CalcedParam[6];		//���_�v�Z�ł̃A�t�B���ϊ��p�����[�^�[
...
class   AlignmentInLayer : public AlgorithmInLayerPLI
{
  public:
	...
	double ResultShiftX,ResultShiftY;	//���s�ړ���
	double ResultAngle;					//���]�ʁi���W�A���j
	double ResultExtend;				//�g�嗦
