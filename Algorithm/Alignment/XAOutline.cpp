...
{
	Code=0;			/*	�֊s�f�[�^�ւ̃C���f�b�N�X	���ӂ̒l*/
	LibName="";		/*	���C�u������			*/
	OutlineJanle=-1;	/*	�\��	*/

	GenColorBlack=0;		/*	������	���o�P�x�̈Ñ�		*/
	GenColorWhite=255;		/*	������	���o�P�x�̖���		*/
	GenSizeMin=0;			/*	������	���o�T�C�Y�̍ŏ�	*/
	GenSizeMax=1000000;		/*	������	���o�T�C�Y�̍ő�	*/
	GenGap=2;				/*	������	�����Ԋu		*/
	GenFat=true;			/*	������	���������ւ̒��o	*/

	InsVNumb=4;				/*	�������@�m�f�x�N�g������	*/
	InsSizeBlack	=25;	/*	�������@���׍ŏ��T�C�Y�Ñ�	0.1�P��*/
	InsSizeWhite	=25;	/*	�������@���׍ŏ��T�C�Y����	0.1�P��*/
	InsCornerBlack	=40;	/*	�������@�p�����̍ŏ��T�C�Y�Ñ�	0.1�P��*/
	InsCornerWhite	=40;	/*	�������@�p�����̍ŏ��T�C�Y����	0.1�P��*/
	InsOKWidthBlack	=100;	/*	�������@����	*/
	InsOKWidthWhite	=100;	/*	�������@����	*/
	SelfSearch		=3;
}
...
AlgorithmLibrary &OutlineInspectLibrary::operator=(const AlgorithmLibrary &src)
{
	...
	Code			=s->Code;				/*	�֊s�f�[�^�ւ̃C���f�b�N�X	���ӂ̒l*/
	LibName			=s->LibName;			/*	���C�u������			*/
	OutlineJanle	=s->OutlineJanle;		/*	�\��	*/

	GenColorBlack	=s->GenColorBlack;		/*	������	���o�P�x�̈Ñ�		*/
	GenColorWhite	=s->GenColorWhite;		/*	������	���o�P�x�̖���		*/
	GenSizeMin		=s->GenSizeMin;		/*	������	���o�T�C�Y�̍ŏ�	*/
	GenSizeMax		=s->GenSizeMax;		/*	������	���o�T�C�Y�̍ő�	*/
	GenGap			=s->GenGap;			/*	������	�����Ԋu		*/
	GenFat			=s->GenFat;			/*	������	���������ւ̒��o	*/

	InsVNumb		=s->InsVNumb;			/*	�������@�m�f�x�N�g������	*/
	InsSizeBlack	=s->InsSizeBlack;		/*	�������@���׍ŏ��T�C�Y�Ñ�	*/
	InsSizeWhite	=s->InsSizeWhite;		/*	�������@���׍ŏ��T�C�Y����	*/
	InsCornerBlack	=s->InsCornerBlack;	/*	�������@�p�����̍ŏ��T�C�Y�Ñ�	*/
	InsCornerWhite	=s->InsCornerWhite;	/*	�������@�p�����̍ŏ��T�C�Y����	*/
	InsOKWidthBlack	=s->InsOKWidthBlack;	/*	�������@����	*/
	InsOKWidthWhite	=s->InsOKWidthWhite;	/*	�������@����	*/
                                                    ...
                                                    ,double &ix ,double &iy)
{
    ...
    BYTE    NowCCol=(NowPCol+NowMCol)/2;    //���E�P�x
...
OutlineItem	&OutlineItem::operator=(const AlgorithmItemRoot &src)
{
	...
	LibID			=((OutlineItem *)&src)->LibID;			//���C�u����ID
...
void    OutlineInLayer::AddBlock(ImageBuffer &Buff ,NPListPack<XYClass> &B ,OutlineInspectLibrary &Lib)
{
    ...
    //�����x�N�g�����U�V�D�T�x�ȏ��قȂ��Ƃ��A�ʂ̃x�N�g���ɂ���
    ...
    for(OutlineItem *blk=static_cast<OutlineItem *>(tData.GetFirst());blk!=NULL;blk=static_cast<OutlineItem *>(blk->GetNext())){
        blk->SetLibID(Lib.Code);				//���C�u����ID
		blk->GetThresholdW()->InsVNumb		=Lib.InsVNumb;			/*	�������@�m�f�x�N�g������	*/
		blk->GetThresholdW()->InsSizeBlack	=Lib.InsSizeBlack;		/*	�������@���׍ŏ��T�C�Y�Ñ�	*/
		blk->GetThresholdW()->InsSizeWhite	=Lib.InsSizeWhite;		/*	�������@���׍ŏ��T�C�Y����	*/
		blk->GetThresholdW()->InsCornerBlack	=Lib.InsCornerBlack;	/*	�������@�p�����̍ŏ��T�C�Y�Ñ�	*/
		blk->GetThresholdW()->InsCornerWhite	=Lib.InsCornerWhite;	/*	�������@�p�����̍ŏ��T�C�Y����	*/
		blk->GetThresholdW()->InsOKWidthBlack=Lib.InsOKWidthBlack;	/*	�������@����	*/
		blk->GetThresholdW()->InsOKWidthWhite=Lib.InsOKWidthWhite;	/*	�������@����	*/
