...
**
** This file is C:\Regulus64v5\Algorithm\NickInspection\NickInspection.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/


#include "XAlgorithmDLL.h"
#include "NickInspection.h"
#include "XNickInspection.h"
#include "ShowOperationalPanel.h"

const	char	*sRoot=/**/"Basic";
const	char	*sName=/**/"NickInspection";
...
{
	NickInspectionBase	*base=new NickInspectionBase(Base);
	base->Initial(Base);
...
{
	return new NickInspectionLibraryContainer(Base);
}
...
{
	return ((NickInspectionItem *)item)->Save(f);
}
DEFFUNCEX	bool	DLL_LoadItem(QIODevice *f,AlgorithmItemRoot *item,LayersBase *LBase)
{
	return ((NickInspectionItem *)item)->Load(f,LBase);
}
