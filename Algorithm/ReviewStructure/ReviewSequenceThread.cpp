...
void ReviewSequenceThread::append(const ReviewSequenceRequire &reqItem)
{
	...
	ReviewSequenceRequire remainItem;// �c�������s�R�}���h�̃o�b�t�@
	...
	//ReqItem = compressRequire(m_ReqList);// ���k���Ĉ��̎��s�R�}���h�ɂ���
	ReqItem = compressRequire(m_ReqList);

	m_ReqList.clear();// �v���A�C�e�����N���A
	...
	if(ok==false){// �c�肪����
		QMutexLocker locker(&m_mutex);
		m_ReqList.push_front(remainItem);// �ŗD���ʒu�ɒǉ�
...
// ���[�^�[���������s����
// �V�[�P���X���̐ݒ��ɂ����ē����s�\���ԂɂȂ��ꍇ�������̂ŁA���̏ꍇ��remainRequire�ɕۑ�������
