...
public:
	...
	qint16 getVersion(qint32 verRaw) const {// 4�o�C�g�̃o�[�W�����l(��������LittleEndian��NG�摜������2�o�C�g)
		qint16 ret;
		if((verRaw & 0x80000000)!=0){// �o�[�W����3�ȍ~
			qint16 tmp = (verRaw & 0x7fffffff);
			ret = tmp;
		}else{
			ret = 2;// �o�[�W����2�n�C�u���b�hNG�摜�t�H�[�}�b�g(PNG or JPG)
		}
		if(ret<0){
			return -1;
		}
...
private:
	int checkVer(const QString &filename) const;// �ŏ���2�o�C�g���擾���ăo�[�W�������F��
...
//		//}
//
//		//// �X���b�h�̐��������s�������A�ǂݍ��ݎ��s���Ă����Ƃ����[�J���X���b�h�Ŏ擾
//		//{
//		//	QMutexLocker locker( &m_mutex );
//		//	isNull = m_image.isNull();
//		//}
//
//		// �ǂݍ��ݎ��s�̂Ƃ��̓��C���X���b�h�œǂݍ���
//		if(isNull==true){
//			localLoad();
//		}
//
...
// NG�摜���ǂݍ��ރX���b�h
// �t�@�C���ɂ�����1��1�̃X���b�h�𐶐�����
// �I�������Ȃǂ� isFinished() ���A���s�����ǂ����� isRunnning() �ŔF������
// mutex�͎g�p�����A���L�֐��ŕێ炷��
// �t�@�C�������w�肵�Ă����ꍇ�A�����܂œ��B���邱�ƂɕK�v��page�͌����ɕK�v�ȏ��񂩂��ȗ�
