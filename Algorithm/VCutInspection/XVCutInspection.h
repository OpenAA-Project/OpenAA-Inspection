...
class	VCutBand
{
	...
	int		Px,Py;
	double	Ux,Uy;	//V�J�b�g�𐂒��ɉ��؂������̒P�ʃx�N�g��
	double	Vx,Vy;	//V�J�b�g�����̒P�ʃx�N�g��
	int		WLen;		//V�J�b�g�𐂒��ɉ��؂������̃o���h�̒���
	int		StackedLen;	//V�J�b�g�����̒���

	double	*BList;

	MapBuffer	ResultBitImage;		//���ʃG���A
	int			ResImageX1,ResImageY1,ResImageX2,ResImageY2;
	int			MidAvr;
public:
	int		ResultU1,ResultU2;
	double	ResultDifference;		//���茋�ʂ̒l
	AlignmentPacket2D	*AVector;	//�A���C�������g
	int		ResMx,ResMy;			//�����������ʁA�ړ���
	FlexArea	Area;
	FlexArea	MaskArea;
...
class	VCutInspectionItem : public AlgorithmItemPI
{
	...
	AlignmentPacket2D	*AVector;	//�A���C�������g
public:
	FlexArea	BandZone;	//ExecuteIntialAfterEdit�Ŏ�������
