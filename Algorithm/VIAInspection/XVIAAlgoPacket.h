#if	!defined(XVIAALGOPACKET_H)
#define	XVIAALGOPACKET_H
...
class	SlaveCommReqLibraryInMaskOfVIA : public DirectCommPacketBase
{
public:
	IntList	UsedLibraries;

	SlaveCommReqLibraryInMaskOfVIA(LayersBase  *base 
...
class	SlaveCommAckLibraryInMaskOfVIA : public DirectCommPacketBase
{
public:
	LibraryEfectivityContainer	UsedLibraries;

	SlaveCommAckLibraryInMaskOfVIA(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
