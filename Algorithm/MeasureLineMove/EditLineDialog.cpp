...
void	EditLineDialog::GetDataFromWindow(void)
{
	for(AlgorithmItemIndependent *D=IData->Items.GetFirst();D!=NULL;D=D->GetNext()){
		...
		Thr->BrightnessIdealRightRange	=ui->doubleSpinBoxBrightnessIdealRightRange	->value();
		Thr->BrightnessIdealLeftRange	=ui->doubleSpinBoxBrightnessIdealLeftRange	->value();
...
void EditLineDialog::ShowThreshold(void)
{
	for(AlgorithmItemIndependent	*D=IData->Items.GetFirst();D!=NULL;D=D->GetNext()){
		...
		ui->doubleSpinBoxBrightnessIdealRightRange	->setValue(Thr->BrightnessIdealRightRange);
		ui->doubleSpinBoxBrightnessIdealLeftRange	->setValue(Thr->BrightnessIdealLeftRange	);
...
void EditLineDialog::on_pushButtonChangeItemID_clicked()
{
	for(AlgorithmItemIndependent	*D=IData->Items.GetFirst();D!=NULL;D=D->GetNext()){
		AlgorithmItemRoot	*DA=D->Data;
		if(DA==NULL)
