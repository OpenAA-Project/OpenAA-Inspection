...
{
	int32	Cx1,Cy1;			//�P���[���̒��S���W
	int32	Sx1,Sy1;
	int32	Cx2,Cy2;			//�Q���[���̒��S���W
	int32	Sx2,Sy2;
...
public:
	...
	int			AMx,AMy;
public:
	QImage	TResultImage;		//�����̕����摜
	QImage	LResultImage;		//�����̐��摜
...
class	MeasureLineMoveCornerRItem : public MeasureLineMoveItemBase
{
	...
	double	Vx1,Vy1;		//�P�ʖ@���x�N�g��
	double	Vx2,Vy2;		//�P�ʖ@���x�N�g��
	double	Vx3,Vy3;		//�P�ʖ@���x�N�g��
	double	Cx1,Cy1;
	double	Cx2,Cy2;
	double	Cx3,Cy3;
