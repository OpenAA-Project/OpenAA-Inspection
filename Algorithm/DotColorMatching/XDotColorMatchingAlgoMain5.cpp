								...
								if(BrAHL_Y!=NULL && BrBHL_Y!=NULL){
									for(ex=-Len;ex<=Len;ex++,h++){
										...
										if(0<=(UX+h) && (UX+h)<R->XLen){
											if((BrightWidthRL+AMPLR)<=kRL && kRH<=(BrightWidthRH+AMPHR) && (BrightWidthGL+AMPLG)<=kGL && kGH<=(BrightWidthGH+AMPHG) && (BrightWidthBL+AMPLB)<=kBL && kBH<=(BrightWidthBH+AMPHB)) return true;
											if((BrightWidthRL+BMPLR)<=kRL && kRH<=(BrightWidthRH+BMPHR) && (BrightWidthGL+BMPLG)<=kGL && kGH<=(BrightWidthGH+BMPHG) && (BrightWidthBL+BMPLB)<=kBL && kBH<=(BrightWidthBH+BMPHB)) return true;
										}
									}
								}
