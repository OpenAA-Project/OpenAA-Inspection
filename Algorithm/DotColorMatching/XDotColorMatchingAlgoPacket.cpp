...
//================================================================================
SlaveCommReqLibraryInMaskOfDotColorMatching::SlaveCommReqLibraryInMaskOfDotColorMatching(LayersBase *base 
...
bool	SlaveCommReqLibraryInMaskOfDotColorMatching::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommReqLibraryInMaskOfDotColorMatching::Save(QIODevice *f)
{
...
void	SlaveCommReqLibraryInMaskOfDotColorMatching::Receive(int32 localPage, int32 cmd ,QString &EmitterRoot,QString &EmitterName)
{
	SlaveCommAckLibraryInMaskOfDotColorMatching	*S
	=(SlaveCommAckLibraryInMaskOfDotColorMatching *)((GetSendBackPacket()==NULL)?new SlaveCommAckLibraryInMaskOfDotColorMatching(GetLayersBase(),EmitterRoot,EmitterName) : GetSendBackPacket())->SetLocalPage(localPage);
...
SlaveCommAckLibraryInMaskOfDotColorMatching::SlaveCommAckLibraryInMaskOfDotColorMatching(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage)
:DirectCommPacketBase(base,globalPage,EmitterRoot,EmitterName ,typeid(this).name())
{
}

bool	SlaveCommAckLibraryInMaskOfDotColorMatching::Load(QIODevice *f)
{
	if(UsedLibraries.Load(f)==false)
		return false;
	return true;
}
bool	SlaveCommAckLibraryInMaskOfDotColorMatching::Save(QIODevice *f)
{
	if(UsedLibraries.Save(f)==false)
		return false;
	return true;
...
void	SlaveCommAckLibraryInMaskOfDotColorMatching::Receive(int32 localPage, int32 cmd ,QString &EmitterRoot,QString &EmitterName)
{
	TestDbg++;
}
