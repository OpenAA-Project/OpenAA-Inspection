...
{
	BrightWidthRL	=0;		//�Ñ��P�x��
	BrightWidthRH	=0;		//�����P�x��
	BrightWidthGL	=0;		//�Ñ��P�x��
	BrightWidthGH	=0;		//�����P�x��
	BrightWidthBL	=0;		//�Ñ��P�x��
	BrightWidthBH	=0;		//�����P�x��
...
:ServiceForLayers(Base)
{
	...
	UseMaster2		=false;
	ExpandToSubBlock=20;
	MaxAreaSearch	=99;		//�ő��̈��T���h�b�g��
    MaxSelfSearch	=99;		//�ő厩�ȒT���h�b�g��
	...
	VariationMode		=false;
	VariationRL=0;	VariationRH=255;	//R-OK�o���c�L�΍��l
	VariationGL=0;	VariationGH=255;	//G-OK�o���c�L�΍��l
	VariationBL=0;	VariationBH=255;	//B-OK�o���c�L�΍��l
