#if	!defined(XDotColorMatchingALGOPACKET_H)
#define	XDotColorMatchingALGOPACKET_H
...
class	SlaveCommReqLibraryInMaskOfDotColorMatching : public DirectCommPacketBase
{
public:
	IntList	UsedLibraries;

	SlaveCommReqLibraryInMaskOfDotColorMatching(LayersBase  *base 
...
class	SlaveCommAckLibraryInMaskOfDotColorMatching : public DirectCommPacketBase
{
public:
	LibraryEfectivityContainer	UsedLibraries;

	SlaveCommAckLibraryInMaskOfDotColorMatching(LayersBase *base 
					,  const QString &EmitterRoot,const QString &EmitterName ,int globalPage=-1);
