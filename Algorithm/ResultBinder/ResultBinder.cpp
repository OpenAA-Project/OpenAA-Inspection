...
{
	ResultBinderBase	*base=new ResultBinderBase(Base);
	base->Initial(Base);
	return base;
}
...
{
	return ((ResultBinderItem *)item)->Save(f);
}
DEFFUNCEX	bool	DLL_LoadItem(QIODevice *f,AlgorithmItemRoot *item,LayersBase *LBase)
{
	return ((ResultBinderItem *)item)->Load(f,LBase);
}
