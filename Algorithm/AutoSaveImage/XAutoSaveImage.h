...
public:
	QString	FileName;
	QString	FolderName;	//�e�t�H���_�̉��ɍ����t�H���_��('/'�ŋ��؂����邱�Ƃ�����)
	QString RootPath;
	int InspectionID;
	int ClusterID;
	int LocalPageNo;
...
public:
	QString FolderNameFormat;	//QDateTime��toString()�ł����t�H�[�}�b�gyyyy-mm-dd/hh�Ȃǁ@���؂�/��OK
...
{
public:
	int32	PartialDot;		//�Ԉ����ĕۑ������ۂ̊Ԉ����h�b�g��
	QString	SavedFolder1;	//8�����̂͊O�t��USB���f�B�A�𔲂��������Ȃ����ۑ����邩���炵��
