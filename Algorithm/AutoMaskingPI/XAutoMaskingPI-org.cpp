...
*/
	...
	//MinSlitDot�ȏ��̂Ԃ��������X���b�g���񕜂�����
	MatrixBuffCopy(TmpMap	 ,XByte, YLen
                 , (const BYTE **)MaskBitmap,XByte, YLen);

		//����NotAnd�ŃX���b�g�A���ȂǁA�Ԃ�������Bitmap�𐶐�
...
//		MatrixBuffXor(MaskBitmap,TmpMap2 ,XByte, YLen);
		...
		//�p�b�h�����w�i�i�X���b�g�j�ƌ��F�����Ȃ��悤�ɁA�p�b�h���o�F�Ɣ��r����
...
//�������w�i�i�X���b�g�j�ƌ��F�����Ȃ��悤�ɁA�����o�F�Ɣ��r����
