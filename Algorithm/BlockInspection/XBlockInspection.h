...
public:
	...
	WORD	NOKLengthL;		//�����̖����ŁA���̒����ȉ��̎��n�j
	...
	WORD	SpaceToOutline;	//ModeMatchPosition==true�̂Ƃ������g���Ȃ�
    WORD	AdjustBlack;    //�P�x�␳�̉�����
    WORD	AdjustWhite;    //�P�x�␳�̏�����
    WORD	SelfSearch;     //���ȒT���h�b�g��
	WORD	OmitVectorIndex;//�T����?����	0xFFFF�̂Ƃ��A��?�Ȃ�
...
{
	 ID_NBrightWidthL	//�����̈Ñ��P�x��
	,ID_NBrightWidthH	//�����̖����P�x��
	,ID_NOKDotL			//�����̈Ñ��n�j�h�b�g��
	,ID_NOKDotH			//�����̖����n�j�h�b�g��
	,ID_NMaxNGDotL		//�����̈Ñ��ő��m�f�h�b�g��
	,ID_NMaxNGDotH		//�����̖����ő��m�f�h�b�g��
	,ID_NOKLengthL		//�����̖����ŁA���̒����ȉ��̎��n�j
	,ID_NOKLengthH		//�����̖����ŁA���̒����ȉ��̎��n�j
	,ID_BBrightWidthL	//�L���̈Ñ��P�x��
	,ID_BBrightWidthH	//�L���̖����P�x��
	,ID_BOKDotL			//�L���̈Ñ��n�j�h�b�g��
	,ID_BOKDotH			//�L���̖����n�j�h�b�g��
	,ID_BMaxNGDotL		//�L���̈Ñ��ő��m�f�h�b�g��
	,ID_BMaxNGDotH		//�L���̖����ő��m�f�h�b�g��
	,ID_BOKLengthL		//�L���̖����ŁA���̒����ȉ��̎��n�j
	,ID_BOKLengthH		//�L���̖����ŁA���̒����ȉ��̎��n�j
	,ID_DiffBrightWidthL
	,ID_DiffBrightWidthH
	,ID_RegularCenterBright

	,ID_NMinNGCountL	//�����̈Ñ��ł��̌��ȏ��̂m�f���������΂m�f�ɂ���
	,ID_NMinNGCountH	//�����̈Ñ��ł��̌��ȏ��̂m�f���������΂m�f�ɂ���
	,ID_BMinNGCountL	//�L���̈Ñ��ł��̌��ȏ��̂m�f���������΂m�f�ɂ���
	,ID_BMinNGCountH	//�L���̈Ñ��ł��̌��ȏ��̂m�f���������΂m�f�ɂ���
	,ID_NConnectLen		//�����̂m�f�ڑ�����
	,ID_BConnectLen		//�L���̂m�f�ڑ�����
	...
	,ID_SpaceToOutline		//ModeMatchPosition==true�̂Ƃ������g���Ȃ�
    ,ID_AdjustBlack			//�P�x�␳�̉�����
    ,ID_AdjustWhite			//�P�x�␳�̏�����
    ,ID_SelfSearch			//���ȒT���h�b�g��
	,ID_OmitVectorIndex		//�T����?����	0xFFFF�̂Ƃ��A��?�Ȃ�
...
public:
	...
	WORD	CenterBright;
	WORD	CenterTargetBright;
	short	NBrightWidthL;		//�����̈Ñ��P�x��
	short	NBrightWidthH;		//�����̖����P�x��
	short	BBrightWidthL;		//�L���̈Ñ��P�x��
	short	BBrightWidthH;		//�L���̖����P�x��

	short	AbsNBrightWidthL;	//�����̈Ñ��P�x��
	short	AbsNBrightWidthH;	//�����̖����P�x��
	short	AbsBBrightWidthL;	//�L���̈Ñ��P�x��
	short	AbsBBrightWidthH;	//�L���̖����P�x��
