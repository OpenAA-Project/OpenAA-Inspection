...
**
** This file is C:\Regulus64v5\Algorithm\RepeatControl\RepeatControlResult.cpp
** Author : YYYYYYYYYY
****************************************************************************-**/
...
void	RepeatControlThreshold::MakeReportedTopics(ReportedTopicContainer &RetContainer)	const
{
