...
bool WholeImageForReview::eventFilter(QObject *target, QEvent *event)
{
	...
	if(targetFlg==true){
		if(event->type()==QEvent::MouseButtonPress ||// �}�E�X�{�^������
			event->type()==QEvent::MouseMove ||// �}�E�X�J�[�\���ړ�
			event->type()==QEvent::MouseButtonRelease ||// �}�E�X�{�^������
			event->type()==QEvent::MouseButtonDblClick){// �}�E�X�{�^���_�u���N���b�N
			return true;
		}
	}
...
bool WholeImageForReview::loadImage(Review::SideType side)
{
	...
	//if(side==Review::Front){
	//	//if(FrontMasterCode==ReqMInfoCmd.FrontMasterDataInfo.MasterCode)return true;// �����}�X�^�[�f�[�^�Ȃ珈�����I��
	...
	//}else{
	//	//if(BackMasterCode==ReqMInfoCmd.BackMasterDataInfo.MasterCode)return true;// �����}�X�^�[�f�[�^�Ȃ珈�����I��
...
void WholeImageForReview::SlotSetDragRectImage(Review::SideType side, int phase, QRect rect)
{
	...
	QRect viewRawRect = display->getCurrentViewRect();// ���ݕ\�����̉摜�����`�f�[�^(1�{�\����(0,0,-1,-1):isEmpty()==true)
	QSize canvasSize = QSize(display->GetCanvasWidth(), display->GetCanvasHeight());// �L�����o�X�T�C�Y
	QSize stSize;// �\�������Ă����摜�̐��T�C�Y
	
	if(viewRawRect.isEmpty()==true){
		stSize = display->getWholeImageOrgSize();// 1�{�͂��ׂ�
	}else{
		stSize = viewRawRect.size();// ���ݕ\�����Ă��鐶�T�C�Y
		return;// ���݈����̂�; This will be able to few continue.
	}
