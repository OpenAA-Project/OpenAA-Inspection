...
private:
	...
	HistoryItem		m_History;// �����f�[�^
	QList<QPoint>	m_OutlineOffset;// �A�E�g���C������
	int				m_NGNailSelectIndex;// ���ݑI�������Ă���NGNail�C���f�b�N�X
	QColor			m_NGSingDefaultColor;// NG�\���̃f�t�H���g�J���[
	QColor			m_NGSingCurrentColor;// �I��NG�\���̃J���[
	QImage			m_WholeImage;// �S�̉摜
	QImage			m_WholeImageView;// �S�̉摜�̕\������
	QSize			m_NGImageSize;// NG�摜�̃T�C�Y
	int				m_currentIndex;// ���ݑI�𒆂�NG�̃C���f�b�N�X
	bool			m_currentNGRectVisible;// ���ݑI�𒆂�NG�̋��`�`���t���O
	bool			m_currentNGCrossView;// ���ݑI�𒆂�NG�𒆐S�Ƃ����\�����\�������t���O
	bool			m_NGPointView;// NG���_�ŕ\�������t���O
	bool			m_currentNGRectOnlyView;// ���ݑI�𒆂�NG�̂݋��`�`���t���O
	QSize			m_WholeImageOrgSize;// ���摜�̑S�̃T�C�Y
	int				m_phase;// �t�F�C�Y�ԍ�
	Review::SideType m_side;// �T�C�h
	QRect			m_currentViewRect;// �S�̃T�C�Y�̂����A���ݕ\�����Ă����T�C�Y
	PCEList			m_PCEList;
	double			m_PCENameViewThreshold;
	int				m_Rotate;// �摜�̕`�����]�x(deg)
};
