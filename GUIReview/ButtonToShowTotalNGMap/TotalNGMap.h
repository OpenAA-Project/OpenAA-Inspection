...
public:
	void setNGPoints(const OrganizedHistoryListPtr OrgHistoryListPtr);// �����������󂯎����āANGPosList���X�V����.
	void setWholeImage(QList<QImage> &FrontPix, QList<QImage> &BackPix);// �S�̉摜�̍X�V
...
protected:
	virtual	void paintEvent ( QPaintEvent * event )	override;// �摜�̕`���C�x���g�B�P�F�S�̉摜�̕\���@�Q�FNG�ʒu�̕\��
...
private:
	Ui::TotalNGMapClass ui;// ���̒���QFrame�̃C���X�^���XMainCanvas�ɉ���QPixmap�𒣂��t���ĉ摜���\�����A�ێ����Ă���NGPosList������NG���W���`�������ŕ\������
	
	QList<QImage> m_FrontImageList;	// �\�̑S�̉摜
	QList<QImage> m_BackImageList;	// ���̑S�̉摜

	//QList<StretchImageWidget *> m_FrontImageWidgetList;
	//QList<StretchImageWidget *> m_BackImageWidgetList;

	QList<QList<QPoint> > m_FrontNGPosList;// NG�̈ʒu�̃��X�g(���Ԃ͖��֌W)
	...
	int m_splitX;	// X������
	int m_splitY;	// Y������
	QColor m_NGDrawColor;		// �\������NG�̐F
	NGDrawShapeType m_NGDrawShape;	// NG�̕\���`��
	int m_NGDrawSize;
