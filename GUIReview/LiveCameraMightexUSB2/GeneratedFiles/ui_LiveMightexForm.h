...
public:
    ...
    void setupUi(GUIFormBase *LiveMightexForm)
    {
        ...
        pushButtonCapture = new QPushButton(LiveMightexForm);
        pushButtonCapture->setObjectName(QString::fromUtf8("pushButtonCapture"));
        pushButtonCapture->setGeometry(QRect(160, 0, 81, 21));
    ...
    void retranslateUi(GUIFormBase *LiveMightexForm)
    {
        ...
        pushButtonCapture->setText(QCoreApplication::translate("LiveMightexForm", "Capture", nullptr));
    } // retranslateUi
