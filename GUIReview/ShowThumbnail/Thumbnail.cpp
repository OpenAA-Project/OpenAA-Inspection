...
void Thumbnail::paintEvent(QPaintEvent *event)
{
	...
	//	if(pix.isNull()==false){
	//		double zoomRate = pix.width() / (double)m_NGItem.NGImage.width();// �g�嗦
