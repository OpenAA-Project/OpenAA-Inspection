...
public:
    ...
    void setupUi(QDialog *SelectMachineDialog)
    {
        if (SelectMachineDialog->objectName().isEmpty())
            SelectMachineDialog->setObjectName(QString::fromUtf8("SelectMachineDialog"));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/Qtres/flash_64.PNG"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/Qtres/flash_swf_64.PNG"), QSize(), QIcon::Normal, QIcon::Off);
