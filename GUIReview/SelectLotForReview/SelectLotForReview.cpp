	...
	:GUIFormBase(Base, parent),m_FrontMasterCode(-1),m_FrontMachineID(-1),m_BackMasterCode(-1),m_BackMachineID(-1)
{
	...
	ui.twFrontLot->horizontalHeader()->setSectionResizeMode(QHeaderView::ResizeToContents);	// ���w�b�_�[�����ϓ��̕��ŐL�k�\��������
	ui.twBackLot->horizontalHeader()->setSectionResizeMode(QHeaderView::ResizeToContents);	// ���w�b�_�[�����ϓ��̕��ŐL�k�\��������
...
void SelectLotForReview::doubleClicked(int row, int /*column*/)
{
	...
	QString tagLot;
	QString rtagLot;
	if(ui.tabWidget->currentIndex()==0){// �\���e�[�u���̃_�u���N���b�N��
	...
	CmdServerSetLot Send(GetLayersBase());// ���b�g�ǂݍ��݃R�}���h�p�P�b�g
	CmdClearSideLot ClearCmd(GetLayersBase());// ���b�g�폜�R�}���h�p�P�b�g

	if(MasterCode!=-1 && MachineID!=-1 && tagLot.isEmpty()==false){// ����
		// �\���ǂݍ���
	...
	if(rMasterCode!=-1 && rMachineID!=-1 && rtagLot.isEmpty()==false){// ����
		// �����ǂݍ���
	...
	//			//InspectIDList.append(ReqOrgCmd.listPtr->at(i).getInspectID());// ID�̕ۑ�
	//			if(ReqOrgCmd.listPtr->at(i).hasFront()==false){// �\���������`�F�b�N
	//				FrontNoExistError.append(ReqOrgCmd.listPtr->at(i).getInspectID());// ���������Ȃ�
	//			}else{
	//				if(FrontMultiIDError.contains(ReqOrgCmd.listPtr->at(i).getInspectID())==true){// ����ID���������݂��Ă���
	//					FrontMultiIDError[ReqOrgCmd.listPtr->at(i).getInspectID()] = false;
	//				}else{
	//					FrontMultiIDError.insert(ReqOrgCmd.listPtr->at(i).getInspectID(), true);// �ʏ���ID���Ƃɂ����Ɉ��x��������
	//				}
	//				if(ReqOrgCmd.listPtr->at(i).getFront()->isOK()){// OK��NG���ŕ����A���Z
	//					FrontOKCount++;
	//				}else{
	//					FrontNGCount++;
	//				}
	//			}
	//			if(ReqOrgCmd.listPtr->at(i).hasBack()==false){// �����������`�F�b�N
	//				BackNoExistError.append(ReqOrgCmd.listPtr->at(i).getInspectID());// ���������Ȃ�
	//			}else{
	//				if(BackMultiIDError.contains(ReqOrgCmd.listPtr->at(i).getInspectID())==true){// ����ID���������݂��Ă���
	//					BackMultiIDError[ReqOrgCmd.listPtr->at(i).getInspectID()] = BackMultiIDError[ReqOrgCmd.listPtr->at(i).getInspectID()] + 1;
	//				}else{
	//					BackMultiIDError.insert(ReqOrgCmd.listPtr->at(i).getInspectID(), 1);// �ʏ���ID���Ƃɂ����Ɉ��x��������
	//				}
	//				if(ReqOrgCmd.listPtr->at(i).getBack()->isOK()){// OK��NG���ŕ����A���Z
	//					BackOKCount++;
	//				}else{
	//					BackNGCount++;
	//				}
	...
	//		{
	//		// �G���[�����Ȃ����̂����菜��
	//		QList<int> keys = FrontMultiIDError.keys(true);// �G���[�����Ȃ�
	...
	//		//// ����ID�̔��сA�d�����`�F�b�N
	//		//QList<int> MultiErrorInspectIDList;//	ID���d�����Ă����ꍇ
	//		//QList<int> NoExistErrorInspectIDList;//	ID���Ȃ��ꍇ
	//		//for(int i=0; i<maxID; i++){
	//		//	int cnt = InspectIDList.count(i);// i�Ԃ̌���ID�̐�(�ʏ��P��)
	//		//	if(cnt>1){// �����G���[�̏ꍇ
	//		//		MultiErrorInspectIDList.append(i);
	//		//	}else if(cnt==0){// ID�����G���[�̏ꍇ
	...
	//				resultUi->twFrontError->setRowCount(FrontMultiIDError.count() + FrontNoExistError.count());// �s���̒���
	...
	//				resultUi->twBackError->setRowCount(BackMultiIDError.count() + BackNoExistError.count());// �s���̒���
